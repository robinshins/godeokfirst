        ...
        <div className="flex flex-col gap-10">
          ...
          <div className="flex flex-col gap-3 text-center">
            <h2 className="text-[32px] font-bold leading-[1.35] tracking-[-0.02em] text-black">
              Удаление зубов мудрости всё<br />
               Расскажем всё в видео
            </h2>
            <p className="text-base font-semibold leading-[1.4] tracking-[-0.02em] text-[#727582]">
              Удаление зубов мудрости , методы, рекомендации<br />
              все информация лет объяснение  предоставляем
            </p>
          </div>
          ...
          <div className="flex justify-center">
            <div className="relative w-full aspect-video rounded-[20px] overflow-hidden shadow-lg bg-gradient-to-br from-[#008095]/10 to-[#008095]/20 flex items-center justify-center">
              <div className="flex flex-col items-center gap-3 p-6 text-center">
                ...
                <p className="font-bold text-[#008095] text-[15px]">Видео готовится</p>
                <p className="text-[13px] text-[#008095]/70">Godeok First Dental Удаление зубов мудрости Видео скоро будет загружено</p>
              </div>
            </div>
          </div>
        </div>
