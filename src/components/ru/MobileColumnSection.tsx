...
const columnData: Record<string, Column[]> = {
  implant: [
    {
      title: 'множество Имплант реставрация принцип',
      url: 'https://blog.naver.com/gdfst111/224181674200',
      description: 'Принципы, которые необходимо соблюдать при множественной имплантации и важные моменты — личное объяснение врача.',
    },
    {
      title: 'О показателях выживаемости имплантов',
      url: 'https://blog.naver.com/gdfst111/224184908972',
      description: 'Факторы, влияющие на выживаемость имплантов, и долгосрочный успех Ключевые условия для имплантов.',
    },
    {
      title: 'Прикус импланта — почему это важно?',
      url: 'https://blog.naver.com/gdfst111/224184928593',
      description: 'Имплант лечение прикус(Баланс жевательной силы) Почему это важно и какие проблемы вызывает неправильный прикус.',
    },
  ],
  home: [],
};
    ...
    <div className="bg-white w-full flex justify-center">
      <div className="px-4 py-[60px] w-full max-w-[430px]">
        ...
        <div className="mt-6 text-center">
          ...
          >
            Читать полностью в блоге Godeok First Dental →
          </Link>
        </div>
      </div>
    </div>
