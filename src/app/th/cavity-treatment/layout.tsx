...
export const metadata: Metadata = {
  title: '고덕동충치치료 평택충치치료 | Godeok First Dental',
  description: '고덕동충치치료 평택충치치료 전문. 통합치의학과 전문의, 정밀 진단, 자연치아 보존 치료. 발치 대신 살리는 치료.',
  keywords: ['고덕동충치치료', '평택충치치료', 'Godeok First Dental충치', '고덕동신경치료', '평택신경치료'],
  alternates: {
      ...
      mainEntity: [
        {
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text: '네, 가능성이 높습니다. Godeok First Dental는 통합치의학과 전문의가 정밀 진단합니다. 일반 치과에서 보이지 않던 살릴 방법을 찾을 수 있으며, 자연치아를 살리는 것을 최우선으로 합니다.',
          },
        },
        {
          '@type': 'Question',
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text: '최신 통증 완화 마취 시스템으로 통증을 최소화합니다. 불안하신 분은 의식하진정요법(수면마취)으로 편안하게 시술받으실 수 있습니다.',
          },
        },
        {
          '@type': 'Question',
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text: '초기 충치는 레진 치료로 빠르게 완료되며, 넓은 충치는 인레이 시스템으로 24시간 내 치료가 가능합니다. 신경치료가 필요한 경우 2-3회 내원이 필요하지만, 정밀 치료로 치료 횟수를 최소화합니다.',
          },
        },
        {
          '@type': 'Question',
