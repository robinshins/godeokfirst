      ...
      <div className="max-w-[430px] mx-auto px-4 py-[60px]">
        ...
        <div className="text-center mb-[60px]">
          ...
          <h2 className="text-4xl font-bold text-[#292a2f] leading-[1.35] mb-8">
            Сделайте первый шаг
            <br />
            к здоровым зубам и счастливой улыбке
          </h2>
          ...
          <div className="flex-none w-[320px] aspect-[4/3] rounded-xl overflow-hidden relative shadow-md">
            ...
            <div className="flex-none w-[320px] aspect-[4/3] rounded-xl overflow-hidden relative shadow-md">
              <Image
                ...
                alt="Зал ожидания стоматологии Медис"
                fill
                className="object-cover"
              />
            </div>
            <div className="flex-none w-[320px] aspect-[4/3] rounded-xl overflow-hidden relative shadow-md">
              <Image
                ...
                alt="Кабинет консультаций стоматологии Медис"
                fill
                className="object-cover"
              />
            </div>
            <div className="flex-none w-[320px] aspect-[4/3] rounded-xl overflow-hidden relative shadow-md">
              <Image
                ...
                alt="Кабинет лечения стоматологии Медис"
                fill
                className="object-cover"
              />
            </div>
            <div className="flex-none w-[320px] aspect-[4/3] rounded-xl overflow-hidden relative shadow-md">
              <Image
                ...
                alt="Индивидуальный кабинет лечения стоматологии Медис"
                fill
                className="object-cover"
              />
            </div>
            <div className="flex-none w-[320px] aspect-[4/3] rounded-xl overflow-hidden relative shadow-md">
              <Image
                ...
                alt="Стерилизационная комната стоматологии Медис"
                fill
                className="object-cover"
              />
            </div>
        ...
        <div className="space-y-6">
          ...
          <div className="relative border-[5px] border-white rounded-2xl overflow-hidden h-[480px]">
            <Image
              ...
              alt="Расположение стоматологии Кёнсон Медис"
              fill
              className="object-cover"
            />
            ...
            <div className="absolute bottom-4 left-4 right-4 space-y-3">
              <div className="text-black font-semibold text-[15px] leading-[1.6]">
                <p className="mb-0">45 Yongso-ro, Nam-gu, Пусан</p>
                <p>5 мин пешком от выхода 3 станции Кёнсон</p>
              </div>
              <Link
          ...
          <div className="space-y-10">
            ...
            <div className="bg-white rounded-2xl p-5 shadow-sm space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h4 className="text-lg font-bold text-black">Удобная парковка</h4>
                  <p className="text-sm text-[#727582]">Просторная и комфортная парковка</p>
                </div>
              </div>
              ...
              <div className="relative w-full h-[200px] rounded-xl overflow-hidden">
                <Image
                  ...
                  alt="Подземная парковка стоматологии Медис"
                  fill
                  className="object-cover"
                />
              </div>
              ...
              <p className="text-[15px] text-[#727582] leading-[1.6]">
                Стоматология Медис ставит ваше удобство на первое место.<br />
                От комфортной парковки до приятных лечебных кабинетов,<br />
                мы создаем <span className="font-semibold text-[#006aff]">клинику, ориентированную на пациента</span>.
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="text-[15px] font-semibold text-black leading-[1.8] space-y-1">
                <div className="flex">
                  <span className="min-w-[140px]">Пн / Ср (вечер) :</span>
                  <span className="whitespace-nowrap">10:00 – 20:00</span>
                </div>
                <div className="flex">
                  <span className="min-w-[140px]">Вт / Чт / Пт :</span>
                ...
                <div className="flex">
                  ...
                  <span className="text-[13px] text-[#727582]">(Без перерыва на обед)</span>
                </div>
                <div className="flex">
                ...
                <div className="flex">
                  <span className="min-w-[140px]">Выходные :</span>
                  <span>Воскресенье и праздники</span>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="space-y-3">
                <p className="text-base font-semibold text-[#727582]">Записаться на прием</p>
                <p className="text-[15px] text-[#727582] leading-[1.6]">
                  Используйте кнопки ниже для AI-консультации, звонка или записи через Naver.
                </p>
              </div>
              ...
              <div className="space-y-3">
                ...
                >
                  <span className="text-2xl">🤖</span>
                  <span className="text-lg font-bold text-white">AI-консультация</span>
                </Link>
                ...
                >
                  ...
                  <div className="flex flex-col items-center">
                    <span className="text-lg font-bold text-[#006aff]">Позвонить</span>
                ...
                >
                  ...
                  <span className="text-lg font-bold text-white">Запись через Naver</span>
                </Link>
              </div>
            </div>
          </div>
