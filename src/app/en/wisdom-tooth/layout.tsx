...
export const metadata: Metadata = {
  title: '고덕동사랑니 평택wisdom tooth extraction | Godeok First Dental',
  description: '고덕동사랑니 평택wisdom tooth extraction 전문. 3D CT precise diagnosis, 대학병원급 난이도 발치 가능. 통증 완화 마취 시스템.',
  keywords: ['고덕동사랑니', '평택wisdom tooth extraction', 'Godeok First Dental사랑니', '평택사랑니', 'wisdom tooth extraction'],
  alternates: {
    canonical: 'https://gdfirstdent.com/wisdom-tooth',
  },
  openGraph: {
    title: '고덕동사랑니 평택wisdom tooth extraction | Godeok First Dental',
    description: '고덕동사랑니 평택wisdom tooth extraction 전문. 3D CT precise diagnosis, 대학병원급 난이도 발치 가능.',
  ...
  '@graph': [
    {
      ...
      name: '고덕동사랑니 평택wisdom tooth extraction',
      description: '고덕동사랑니 평택wisdom tooth extraction 전문. 3D CT precise diagnosis으로 신경 손상없이 안전하게 발치. 대학병원급 난이도 발치.',
    ...
    },
    {
      ...
      mainEntity: [
        ...
        },
        {
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text: '네, 가능합니다. Godeok First Dental는 대학병원급 난이도 발치가 가능한 시스템을 갖추고 있습니다. 수평매복, 완전매복 등 일반 치과에서 큰 병원을 권유하는 어려운 케이스도 안전하게 발치합니다.',
          },
        },
        {
          '@type': 'Question',
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text: '최신 통증 완화 마취 시스템으로 시술 중 통증을 거의 느끼지 못합니다. Sedation available for anxious patients.',
          },
        },
        {
          '@type': 'Question',
