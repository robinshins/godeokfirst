...
const articleData: RegionArticleData = {
  ...
  title: '안중 충치치료 치과, 자연치아 보존이 우선입니다',
  subtitle:
    '안중읍 가족들이 알아야 할 충치 치료의 모든 것. 자연치아 보존을 최우선으로 하는 고덕퍼스트치과의 보존치료를 소개합니다.',
  sections: [
    {
      title: '안중읍 가족들의 충치 고민',
      content: [
        '안중읍은 평택 서부권의 중심 생활권으로, 가족 단위 거주민과 직장인이 많은 지역입니다. 바쁜 일상 속에서 정기 검진을 미루다 충치가 진행되는 경우가 흔합니다.',
    ...
    },
    {
      ...
      content: [
        '안중읍에는 어린 자녀를 둔 가정이 많습니다. 유치는 어차피 빠지니까 충치를 방치해도 된다고 생각하시는 분이 있지만, 이는 잘못된 상식입니다. 유치 충치는 영구치의 발육과 배열에 직접적인 영향을 미칩니다.',
    ...
    {
      title: '안중읍에서 고덕퍼스트치과 방문하기',
      content: [
        '안중읍에서 고덕퍼스트치과까지는 자가용으로 약 25분이 소요됩니다. 평택시 고덕로 250 에듀스카이 건물 4층에 위치해 있으며, 건물 내 무료 주차장을 이용하실 수 있습니다.',
        '충치 치료는 대부분 당일 완료가 가능하며, 인레이나 크라운 등 보철이 필요한 경우에도 2~3회 방문으로 마무리됩니다. 안중읍에서 오시는 만큼 효율적인 치료 계획을 세워드립니다.',
  ...
  conclusion:
    '안중읍에서 가족 모두의 충치 치료와 예방을 위해 고덕퍼스트치과를 추천드립니다. 통합치의학전문의 이동현 원장이 자연치아 보존을 최우선으로, 성인부터 소아까지 체계적인 충치 치료를 제공합니다. 상담 예약은 031-611-3222로 문의해주세요.',
  faqs: [
    {
    ...
    {
      question: '안중읍에서 방문 시 충치 치료가 하루에 끝나나요?',
      answer:
...
export const metadata: Metadata = {
  title: '안중 충치치료 치과 | 자연치아 보존 - 고덕퍼스트치과',
  description:
    '안중읍 가족을 위한 충치 치료. 통합치의학전문의의 자연치아 보존 원칙, 최소 삭제 치료, 소아 충치 전문 진료. 안중읍에서 차로 25분.',
  keywords: [
    '안중 충치치료',
    '안중 충치치료 치과',
    '안중읍 충치',
  ...
  alternates: {
    canonical: 'https://gdfirstdent.co.kr/anjung/cavity-treatment',
  },
  openGraph: {
    title: '안중 충치치료 치과 | 고덕퍼스트치과',
    description: '안중읍에서 차로 25분. 자연치아 보존 중심 충치 치료, 통합치의학전문의 직접 진료.',
    url: 'https://gdfirstdent.co.kr/anjung/cavity-treatment',
    siteName: '고덕퍼스트치과',
    type: 'article',
    images: [
      {
...
export default function AnjungCavityTreatmentPage() {
  const faqJsonLd = {
  ...
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: '안중읍', item: 'https://gdfirstdent.co.kr/anjung' },
      { '@type': 'ListItem', position: 3, name: '충치 치료', item: 'https://gdfirstdent.co.kr/anjung/cavity-treatment' },
    ],
  };
