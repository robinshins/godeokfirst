  ...
  const steps = [
    {
      ...
      label: '1-р түр',
      title: 'Шууд сэргээлт',
      description: 'Хагалгааны дараа шууд зүүж\nөдөр тутмын амьдралаа шууд эхлүүлэх боломжтой'
    },
    {
      icon: '/icons/crown.svg',
      label: '2-р хазаалт тогтворжуулалт',
      title: 'Нарийн хазаалт тохируулга',
      description: '2 долоо хоногийн дараа хүн бүрт тохирсон\nхазаалтын байдлыг нарийн тохируулна'
    },
    {
      icon: '/icons/implant-group.svg',
      label: '3-р эцсийн түр',
      title: 'Төгс хазаалт шалгалт',
      description: 'Эцсийн протез хийхээс өмнө\nтөгс хазаалтыг дахин нэг удаа шалгана'
    },
    {
      icon: '/icons/tooth-shine.svg',
      label: 'Эцсийн протез',
      title: 'Насан туршийн миний шүд',
      description: 'Бүх тохируулга дууссаны дараа төгс хувийн\nэцсийн протезыг зүүнэ'
    }
  ];
      ...
      <div className="flex flex-col gap-4 items-center justify-center relative shrink-0 w-full z-10">
        ...
        <div className="flex flex-col gap-3 items-center justify-center leading-[0] not-italic relative shrink-0 text-center w-full">
          ...
          <p className="font-semibold leading-[1.4] text-[#727582] text-base tracking-[-0.32px] w-full" style={{ fontFamily: 'Pretendard, sans-serif' }}>
            Зөвхөн нэг удаагийн түр шүдээр дуусгахгүй<br />
            3 шатлалаар нарийн тохируулга хийж<br />
            өөрийн шүд шиг тав тухтай болгоно
          </p>
        </div>
      </div>
