  ...
  const reasons = [
    {
      ...
      title: 'Nationwide Dentists',
      subtitle: 'Academic Lectures'
    },
    {
      image: '/images/implant-reason-seminar-2.png',
      title: 'MegaGen Implant',
      subtitle: 'Key Advisor'
    },
    {
    ...
    <section className="bg-white px-4 py-16">
      <div className="flex flex-col gap-10">
        ...
        <h2 className="text-[28px] font-extrabold text-center leading-[1.4] tracking-[-0.03em]">
          Why Godeok provides <span className="text-[#008095]">top-level</span><br />
          implant treatment
        </h2>
