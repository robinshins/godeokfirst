    ...
    >
      <div className="max-w-[430px] mx-auto px-4 py-3">
        <Link href="/ru/consultation" className="block w-full">
          <button className="w-full bg-[#006aff] text-white text-lg font-bold py-4 rounded-[18px] hover:bg-[#0050c0] transition-colors shadow-lg" style={{ fontFamily: "'Noto Sans', sans-serif" }}>
