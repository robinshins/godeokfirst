...
export default function SymptomsSection() {
  const symptoms = [
    { icon: '/icons/tooth.svg', title: 'Хэвтсэн хүзүү шүд', description: 'Хажуу тийш ургаж\nхажуугийн шүдийг дарна' },
    { icon: '/icons/tooth-loosen.svg', title: 'Үрэвсэл', description: 'Орхигдсон хүзүү шүднээс\nбуйл хавдаж үрэвсэж болно' }
  ];
        ...
        <div className="flex flex-col gap-[60px] items-start w-full">
          <div className="flex flex-col gap-4 items-center justify-center w-full">
            <div className="flex flex-col gap-3 items-center justify-center text-center w-full">
              ...
              <h2 className="font-bold text-[32px] leading-[1.35] tracking-[-0.64px] text-[#292a2f]">Хүзүү шүднээс<br /><span className="text-[#008095]">үүсэж болох шинж тэмдэг</span></h2>
              <p className="font-semibold text-base leading-[1.4] tracking-[-0.32px] text-[#727582]">Хүзүү шүдний ургах хэлбэр, байрлалаас<br />хамааран янз бүрийн шинж тэмдэг илэрч болно</p>
            </div>
          </div>
