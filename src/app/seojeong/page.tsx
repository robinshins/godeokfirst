...
export const metadata: Metadata = {
  ...
  description: '서정역에서 차량 5분 거리의 고덕퍼스트치과. 조선대학교 치과병원 외래교수 역임 통합치의학과 전문의 이동현 원장이 임플란트, 충치·신경치료, 사랑니 발치, 잇몸치료까지 상담부터 사후관리까지 직접 책임 진료합니다. 통증완화 마취, 야간·토요일 진료. 031-611-3222',
  keywords: '서정동 치과, 서정동 임플란트, 서정동 충치치료, 서정동 사랑니, 평택 치과, 고덕퍼스트치과, 서정역 치과',
  alternates: {
    canonical: 'https://gdfirstdent.co.kr/seojeong',
  },
  openGraph: {
    title: '서정동 치과 | 고덕퍼스트치과',
    description: '서정동 주민을 위한 통합치의학 전문 진료. 임플란트, 충치치료, 사랑니 발치. 전문의 직접 진료.',
    url: 'https://gdfirstdent.co.kr/seojeong',
    siteName: '고덕퍼스트치과',
    locale: 'ko_KR',
    type: 'website',
    images: [
  ...
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 2,
        name: '서정동 치과',
        item: 'https://gdfirstdent.co.kr/seojeong',
      },
    ],
  };
