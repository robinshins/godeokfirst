    ...
    <section className="bg-white px-4 py-16">
      <div className="flex flex-col gap-8 items-center">
        ...
        <h2 className="text-[28px] font-extrabold text-center leading-[1.4] tracking-[-0.03em]">
          术后立即安装<span className="text-[#008095]">临时牙</span><br />
          下午手术，晚上用餐
        </h2>
        ...
        <p className="text-base text-[#475569] text-center leading-[1.6] tracking-[-0.01em]">
          术后立即为您安装<span className="font-bold text-[#0b1727]">临时牙</span>。<br />
          可以用餐，外观上<span className="font-bold text-[#0b1727]">完全看不出来</span>。
        </p>
      </div>
    </section>
  );
