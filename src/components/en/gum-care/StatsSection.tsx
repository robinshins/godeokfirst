...
export default function StatsSection() {
  const stats = [
    { number: '80', unit: '%', label: 'Adult gum disease prevalence', source: 'Korean Academy of Periodontology 2024' },
    { number: '14', unit: '% reduction', label: 'Cardiovascular disease reduction with scaling', source: 'Seoul National University Bundang Hospital 2024' },
    { number: '6', unit: 'x', label: 'Blood sugar control failure with periodontitis', source: 'Catholic University Medical School 2023' },
  ];
