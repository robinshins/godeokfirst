...
export default function WhyNowSection() {
  const problems = [
    { title: '급성 염증', description: '심한 통증과 얼굴 부종' },
    { title: '인접 치아 충치', description: '옆 치아까지 손상' },
    { title: '턱관절 장애', description: '만성 두통과 턱 통증' },
    { title: '치열 불균형', description: '교정 치료 필요' }
  ];

  const benefits = [
    { title: '빠른 회복', description: '젊을수록 회복 속도가 빠름' },
    { title: '합병증 예방', description: '염증 없을 땐 안전' },
    { title: '비용 절감', description: '문제 발생 전 처치' },
    { title: '편안한 시술', description: '염증 없어 마취가 잘 됨' }
  ];
        ...
        <div className="flex flex-col gap-10 items-start w-full">
          ...
          <div className="flex flex-col gap-3 items-center justify-center w-full">
            ...
            <h2 className="font-bold text-[32px] leading-[1.35] tracking-[-0.64px] text-[#292a2f] text-center">
              왜 <span className="text-[#008095]">지금</span> 발치해야 할까요?
            </h2>
          </div>
