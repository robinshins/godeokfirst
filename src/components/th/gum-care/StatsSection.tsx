...
export default function StatsSection() {
  const stats = [
    { number: '80', unit: '%', label: 'ผู้ใหญ่ เหงือก โรค อัตราการมี', source: 'สมาคมปริทันต์เกาหลี 2024' },
    { number: '14', unit: '% ลดลง', label: 'เมื่อขูดหินปูน หัวใจหลอดเลือดโรค ลดลง', source: 'รพ.บุนดังโซล 2024' },
    { number: '6', unit: 'เท่า', label: 'เมื่อเป็นปริทันต์อักเสบ น้ำตาลในเลือด ควบคุม ล้มเหลว', source: 'คณะแพทยศาสตร์ ม.คาทอลิก 2023' },
  ];
