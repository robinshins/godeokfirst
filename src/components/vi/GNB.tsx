...
export default function GNB() {
  ...
  useEffect(() => {
    // Chỉ sử dụng onAuthStateChange (tiết kiệm egress bằng cách loại bỏ getUser)
    // Sự kiện INITIAL_SESSION cung cấp trạng thái phiên hiện tại
  ...
  const languages = [
    { code: 'kr', name: 'Tiếng Hàn', flag: '/icons/flags-kr.svg', href: getCurrentPage() === '/' ? '/' : getCurrentPage() },
  ...
  const menuItems = [
    { name: 'Trang chủ', href: '/' },
    { name: 'Implant', href: '/implant' },
    { name: 'Hàm giả · Implant toàn hàm', href: '/denture' },
    { name: 'sâu răng · Điều trị tủy', href: '/cavity-treatment' },
    { name: 'Nhổ răng khôn', href: '/wisdom-tooth' },
    { name: 'Điều trị nướu · Cạo vôi răng', href: '/gum-care' },
    { name: 'Điều trị khớp thái dương hàm', href: '/tmj' },
    { name: 'Tẩy trắng răng', href: '/whitening' },
  ];
  ...
  return (
    ...
    >
      ...
      >
        {/* Logo */}
        <Link href="/vi" className="flex items-center" style={{ height: '60px' }}>
          <Image
            ...
            <div className="max-w-[430px] mx-auto">
              ...
              <div className="px-5 pb-3 border-b border-[#e9ebf1]">
                {user ? (
                  ...
                  <Link href="/vi/login" onClick={() => setIsMenuOpen(false)}>
