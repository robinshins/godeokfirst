...
const articleData: RegionArticleData = {
  ...
  subtitle: '이충동 주민을 위한 정밀 충치치료. 철저한 정밀 진단과 통합치의학과 전문의의 최소 삭제 치료로 치아를 오래 보존합니다.',
  sections: [
    {
      ...
      content: [
        ...
        '이충동에서 차량 10분 거리의 고덕퍼스트치과에서는 정밀 진단과 통합치의학과 전문의의 보존 중심 치료로 자연치아를 최대한 살려드립니다.',
      ],
    },
    {
      title: '정밀 진단으로 숨은 충치까지 발견',
      content: [
        '고덕퍼스트치과에서는 정밀 진단 장비를 활용하여 기존 X-ray만으로 발견하기 어려운 치아 사이 충치, 미세 균열, 초기 법랑질 충치까지 정확하게 진단합니다.',
    ...
    },
    {
      ...
      content: [
        ...
        '충치가 신경(치수)까지 진행된 경우에는 정밀 근관치료를 시행합니다. 이동현 대표원장은 통합치의학과 전문의로서 발치보다 자연치아 보존을 최우선으로 판단하며, 정확한 진단을 바탕으로 최적의 치료법을 제안합니다.',
  ...
  conclusion: '이충동에서 충치치료를 고려하고 계시다면, 자연치아 보존을 최우선으로 하는 고덕퍼스트치과를 방문해 주세요. 정밀 진단과 통합치의학과 전문의의 최소 삭제 치료로 건강한 치아를 오래 지켜드립니다. 전화 031-611-3222로 예약하세요.',
  faqs: [
    {
    ...
    },
    {
      ...
      answer: '충치가 신경까지 도달하지 않은 경우에는 레진이나 인레이 수복만으로 치료가 가능합니다. 이동현 원장은 정밀 진단으로 충치 깊이를 정확히 파악하여, 신경치료 없이 해결할 수 있는 경우를 최대한 살려드립니다.',
    },
    {
      question: '이충동에서 검진만 받으러 가도 되나요?',
      answer: '물론입니다. 정기 검진만 받으러 오셔도 됩니다. 파노라마 촬영과 정밀 검진을 통해 충치 유무를 확인하고, 필요한 경우에만 치료를 권해드립니다. 전화 031-611-3222로 검진 예약이 가능합니다.',
    },
  ],
};
...
export const metadata: Metadata = {
  ...
  description: '이충동에서 가까운 충치치료 치과. 통합치의학과 전문의 이동현 원장 직접 치료. 정밀 진단, 보존 중심 치료. 이충동에서 차량 10분. 031-611-3222',
  keywords: '이충동 충치치료, 이충동 치과, 평택 충치치료, 고덕퍼스트치과, 이충동 신경치료',
  alternates: {
    canonical: 'https://gdfirstdent.co.kr/ichung/cavity-treatment',
  },
  openGraph: {
    title: '이충동 충치치료 | 고덕퍼스트치과',
    description: '이충동 주민을 위한 자연치아 보존 충치치료. 통합치의학과 전문의 직접 진료.',
    url: 'https://gdfirstdent.co.kr/ichung/cavity-treatment',
    siteName: '고덕퍼스트치과',
    locale: 'ko_KR',
    type: 'article',
    images: [
  ...
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 3,
        name: '이충동 충치치료',
        item: 'https://gdfirstdent.co.kr/ichung/cavity-treatment',
      },
    ],
  };
