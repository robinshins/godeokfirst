...
export default function GNB() {
  ...
  const menuItems = [
    ...
    { name: 'Implant', href: '/vi/implant' },
    { name: 'Tẩy trắng · Veneer', href: '/vi/whitening' },
    { name: 'Nhổ răng khôn', href: '/vi/wisdom-tooth' },
    { name: 'Sâu răng · Chữa tủy', href: '/vi/cavity-treatment' },
    { name: 'Nướu · Lấy cao răng', href: '/vi/gum-care' }
  ];
