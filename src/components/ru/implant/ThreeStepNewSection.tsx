  ...
  const steps = [
    {
      ...
      label: '1-й этап',
      title: 'Немедленное восстановление',
      description: 'Установка сразу после операции\nдля немедленного возвращения к обычной жизни'
    },
    {
      icon: '/icons/crown.svg',
      label: '2-й этап стабилизации',
      title: 'Точная настройка прикуса',
      description: 'Через 2 недели индивидуальная\nточная настройка прикуса'
    },
    {
      icon: '/icons/implant-group.svg',
      label: '3-й этап финал',
      title: 'Проверка идеального прикуса',
      description: 'Перед изготовлением финального протеза\nеще раз проверяем идеальный прикус'
    },
    {
      icon: '/icons/tooth-shine.svg',
      label: 'Финальный протез',
      title: 'Зубы на всю жизнь',
      description: 'После всех настроек устанавливаем\nполностью персонализированный финальный протез'
    }
  ];
      ...
      <div className="flex flex-col gap-4 items-center justify-center relative shrink-0 w-full z-10">
        ...
        <div className="flex flex-col gap-3 items-center justify-center leading-[0] not-italic relative shrink-0 text-center w-full">
          <h2 className="font-bold leading-[1.35] text-[32px] text-black tracking-[-0.64px] w-full" style={{ fontFamily: 'Pretendard, sans-serif' }}>
            Уникальная 3-этапная<br />
            система временных зубов Medis
          </h2>
          <p className="font-semibold leading-[1.4] text-[#727582] text-base tracking-[-0.32px] w-full" style={{ fontFamily: 'Pretendard, sans-serif' }}>
            Не одноэтапные временные зубы,<br />
            а 3-этапная точная настройка<br />
