  ...
  const moments = [
    {
      ...
      label: 'Цэргийн алба',
      description: 'Цэргийн албанд\nгэнэт өвдвөл хэцүү'
    },
    {
      icon: '/images/exam.png',
      label: 'Шалгалтын үе',
      description: 'Чухал шалгалтын өмнө\nгэнэтийн өвдөлт'
    },
    {
      icon: '/images/wedding.png',
      label: 'Хурим · Ярилцлага',
      description: 'Амьдралын чухал өдөр\nнүүр хавдсан...'
    },
    {
      icon: '/images/travel.png',
      label: 'Аялал · Томилолт',
      description: 'Гадаадын яаралтай тусламж\nүнэтэй эмчилгээ'
    }
  ];
          ...
          <div className="flex flex-col gap-3 items-center justify-center w-full">
            <div className="flex flex-col gap-3 items-center justify-center text-center text-white w-full">
              ...
              <h2 className="font-bold text-[32px] leading-[1.35] tracking-[-0.64px] whitespace-pre-line">
                {'Урьдчилан мэдэгдэлгүй ирлээ\nагшин зуурын шүдний өвдөлт...'}
              </h2>
            </div>
            <p className="font-semibold text-[14px] leading-[1.4] tracking-[-0.32px] text-[#d2d6e1] text-center w-full">
              Тайван үед урьдчилж шийдвэрлэвэл чухал мөчөө хамгаалж чадна
            </p>
          </div>
