...
export default function ImportantMomentsSection() {
  const moments = [
    { icon: '/images/military.png', label: 'Nghĩa vụ quân sự', description: 'Đau đột ngột trong\nquân ngũ rất khó xử lý' },
    { icon: '/images/exam.png', label: 'Mùa thi', description: 'Đau đột ngột trước\nngày thi quan trọng' },
    { icon: '/images/wedding.png', label: 'Đám cưới · Phỏng vấn', description: 'Ngày quan trọng nhất\nmà mặt sưng...' },
    { icon: '/images/travel.png', label: 'Du lịch · Công tác', description: 'Phòng cấp cứu nước ngoài\nchi phí điều trị đắt đỏ' }
  ];
        ...
        <div className="flex flex-col gap-[26px] items-center justify-center w-full">
          <div className="flex flex-col gap-3 items-center justify-center w-full">
            <div className="flex flex-col gap-3 items-center justify-center text-center w-full">
              ...
              <h2 className="font-bold text-[32px] leading-[1.35] tracking-[-0.64px] text-[#292a2f]">Đến không báo trước<br /><span className="text-[#008095]">Cơn đau răng khôn...</span></h2>
            </div>
            <p className="font-semibold text-[14px] leading-[1.4] tracking-[-0.32px] text-[#727582] text-center w-full">Giải quyết sớm khi bình yên để bảo vệ những khoảnh khắc quan trọng</p>
          </div>
