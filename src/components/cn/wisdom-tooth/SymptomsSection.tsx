...
export default function SymptomsSection() {
  const symptoms = [
    { icon: '/icons/tooth.svg', title: '横躺智齿', description: '横向生长\n可能压迫邻牙' },
    { icon: '/icons/tooth-loosen.svg', title: '炎症发生', description: '放任不管的智齿\n可能导致牙龈肿胀和炎症' }
  ];
        ...
        <div className="flex flex-col gap-[60px] items-start w-full">
          <div className="flex flex-col gap-4 items-center justify-center w-full">
            <div className="flex flex-col gap-3 items-center justify-center text-center w-full">
              ...
              <h2 className="font-bold text-[32px] leading-[1.35] tracking-[-0.64px] text-[#292a2f]">智齿可能<br /><span className="text-[#008095]">引发的症状</span></h2>
              <p className="font-semibold text-base leading-[1.4] tracking-[-0.32px] text-[#727582]">根据智齿的生长形态和位置<br />可能出现多种症状</p>
            </div>
          </div>
