  ...
  const symptoms = [
    {
      ...
      description: 'Mọc nằm ngang và có thể\ngây áp lực lên răng bên cạnh'
    },
    {
      icon: '/icons/tooth-loosen.svg',
      title: 'Phát sinh viêm nhiễm',
      description: 'Răng khôn không được xử lý có thể\nkhiến nướu bị sưng và gây viêm nhiễm'
    }
  ];
          ...
          <div className="flex flex-col gap-4 items-center justify-center w-full">
            <div className="flex flex-col gap-3 items-center justify-center text-center w-full">
              ...
              <p className="font-semibold text-base leading-[1.4] tracking-[-0.32px] text-[#e9ebf1] whitespace-pre-line">
                {'Nhiều triệu chứng có thể xuất hiện tùy thuộc vào\nhình dạng mọc của răng khôn hoặc các thiết bị nha khoa'}
              </p>
            </div>
          </div>
