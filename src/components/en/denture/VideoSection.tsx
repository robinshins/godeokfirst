...
export default function VideoSection() {
  const videos = [
    {
      id: 'P54GsqWvnkw',
      title: 'Everything About Dentures',
      description: 'We answer all your questions about dentures',
    },
    {
      id: 'zmvu-xPe0ik',
      title: 'Full-Arch Implant Explained',
      description: 'Featured on "Biondi", a medical channel with 2M subscribers',
      badge: '2M Subscriber Channel',
    },
    {
      id: 'r7aeNpeP5vY',
      title: 'What is Full-Arch Implant?',
      description: 'What is full-arch implant? Aren\'t dentures cheaper and better? We\'ll explain everything clearly.',
    },
    {
      id: 'rRVF8hLE82E',
      title: 'Life Extension with Full-Arch Implant??',
      description: 'This is how important bite alignment is!!',
    },
  ];
                ...
                <div className="relative w-full aspect-video rounded-[20px] overflow-hidden shadow-lg bg-gradient-to-br from-[#008095]/10 to-[#008095]/20 flex items-center justify-center">
                  <div className="flex flex-col items-center gap-3 p-6 text-center">
                    ...
                    <p className="text-[13px] text-[#008095]/70" style={{ fontFamily: '"NanumSquare", sans-serif' }}>
                      Godeok First Dental videos will be uploaded soon
                    </p>
                  </div>
                </div>
