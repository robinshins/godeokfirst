...
export default function StatsSection() {
  const stats = [
    { number: '80', unit: '%', label: 'Взрослых с заболеваниями десен', source: 'Корейская ассоциация пародонтологии 2024' },
    { number: '14', unit: '% снижение', label: 'Риска сердечно-сосудистых заболеваний при чистке', source: 'Больница Бундан 2024' },
    { number: '6', unit: 'раз', label: 'Чаще неудача контроля сахара при пародонтите', source: 'Католический университет 2023' }
  ];
