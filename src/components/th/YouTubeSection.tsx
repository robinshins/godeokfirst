...
const LONG_FORM_VIDEOS = [
  {
    id: '9kP02X04THc',
    title: 'ขั้นตอนการรักษารากเทียม',
  },
  {
    id: 'GyzFVUfRqmk',
    title: 'รีวิวจากผู้ป่วย',
  },
  {
    id: '4hJI8OteG3Q',
    title: 'อธิบายการรักษา',
  },
];
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4">
            ดูคำอธิบายการรักษาต่างๆ<br />
            ผ่านวิดีโอ
          </h2>
          <p className="text-gray-600 text-lg">
            กรณีการรักษาจริงและรีวิวจากผู้ป่วยโดยผู้อำนวยการคิม ดงซอก
          </p>
        </div>
