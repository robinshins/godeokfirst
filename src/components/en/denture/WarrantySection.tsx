        ...
        <div className="flex flex-col gap-4 items-center justify-center relative shrink-0 w-full">
          ...
          <div className="flex flex-col gap-3 items-center justify-center w-full">
            ...
            <p className="font-semibold leading-[1.4] text-white text-base text-center tracking-[-0.32px] w-full" style={{ fontFamily: 'Pretendard, sans-serif' }}>
              Godeok First Dental promises responsible care.<br aria-hidden="true" />
              Use your implants with peace of mind through our systematic warranty system.
            </p>
          </div>
        </div>
