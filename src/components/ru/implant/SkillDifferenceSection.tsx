...
export default function SkillDifferenceSection() {
  const generalClinic = [
    {
      title: 'Нет своей лаборатории',
      description: 'Заказ во внешней лаборатории увеличивает\nстоимость и сроки, детальная работа затруднена'
    },
    {
      title: '1 этап временных зубов',
      description: 'Сразу финальный протез без корректировки прикуса'
    },
    {
      title: 'Частая смена врачей',
      description: 'При смене врача неясно кто несет ответственность,\nпоследовательный уход затруднен'
    }
  ];

  const medisClinic = [
    {
      title: 'Совершенное мастерство',
      description: 'Стоматологи приезжают учиться,\nглавный врач обучает других специалистов'
    },
    {
      title: '3-этапная система временных зубов',
      description: 'Поэтапная точная настройка для идеального прикуса'
    },
    {
      title: '10 лет ответственного лечения',
      description: 'Главный врач лично консультирует, оперирует и ведет послеоперационный уход'
    }
  ];
      ...
      <div className="box-border flex flex-col gap-[50px] items-start px-4 py-[60px] relative w-full max-w-[430px]">
        ...
        <div className="flex flex-col gap-3 items-start relative shrink-0 w-full">
          ...
          <div className="font-semibold leading-[1.4] not-italic text-[#727582] text-base text-center tracking-[-0.32px] w-full" style={{ fontFamily: 'Pretendard, sans-serif' }}>
            Правильно с первого раза — самый разумный выбор<br />
            10 лет на одном месте — доказательство настоящего мастерства
          </div>
        </div>
                ...
                <div className="flex flex-col gap-[14px] items-start relative shrink-0 w-full">
                  <div className="flex flex-col gap-4 items-start not-italic relative shrink-0 text-center w-full">
                    ...
                    <p className="font-semibold leading-[1.4] text-[#727582] text-base tracking-[-0.32px] w-full" style={{ fontFamily: 'Pretendard, sans-serif' }}>
                      Беспокойство остается даже после процедуры
                    </p>
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-[14px] items-start relative shrink-0 w-full">
                  <div className="flex flex-col gap-4 items-start not-italic relative shrink-0 text-center text-white w-full">
                    <p className="font-bold leading-[1.35] text-2xl tracking-[-0.48px] w-full" style={{ fontFamily: 'Pretendard, sans-serif' }}>
                      Стоматология Medis Kyungsung
                    </p>
                    <p className="font-semibold leading-[1.4] text-base tracking-[-0.32px] w-full" style={{ fontFamily: 'Pretendard, sans-serif' }}>
                      Стоматология Medis Kyungsung с непревзойденным<br />
                      мастерством гарантирует одну операцию на всю жизнь
                    </p>
                  </div>
                </div>
