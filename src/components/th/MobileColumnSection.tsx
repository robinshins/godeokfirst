...
const columnData: Record<string, Column[]> = {
  implant: [
    {
      title: 'หลักการบูรณะรากฟันเทียมหลายซี่',
      url: 'https://blog.naver.com/gdfst111/224181674200',
      description: 'หลักการและข้อควรพิจารณาที่ต้องปฏิบัติเมื่อฝังรากฟันเทียมหลายซี่ อธิบายโดยแพทย์โดยตรง.',
    },
    {
      title: 'เรื่องของอัตราความสำเร็จของรากฟันเทียม',
      url: 'https://blog.naver.com/gdfst111/224184908972',
      description: 'ปัจจัยที่มีผลต่ออัตราการอยู่รอดของรากฟันเทียมและเงื่อนไขสำคัญสำหรับรากฟันเทียมที่ประสบความสำเร็จในระยะยาว.',
    },
    {
      title: 'การสบฟันของรากฟันเทียม ทำไมสำคัญ?',
      url: 'https://blog.naver.com/gdfst111/224184928593',
      description: 'ทำไมการสบฟัน (สมดุลแรงเคี้ยว) จึงสำคัญในการรักษารากฟันเทียม และการสบฟันที่ไม่ถูกต้องก่อให้เกิดปัญหาอะไร.',
    },
  ],
  home: [],
};
    ...
    <div className="bg-white w-full flex justify-center">
      <div className="px-4 py-[60px] w-full max-w-[430px]">
        ...
        <div className="mt-6 text-center">
          ...
          >
            Godeok First Dental ดูบล็อกทั้งหมด →
          </Link>
        </div>
      </div>
    </div>
