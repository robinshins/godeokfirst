...
export default function GNB() {
  ...
  const menuItems = [
    { name: 'ホーム', href: '/jp' },
    { name: 'インプラント', href: '/jp/implant' },
    { name: 'ホワイトニング・ラミネート', href: '/jp/whitening' },
    { name: '親知らず抜歯', href: '/jp/wisdom-tooth' },
    { name: '虫歯・根管治療', href: '/jp/cavity-treatment' },
    { name: '歯周病治療・スケーリング', href: '/jp/gum-care' }
  ];

  const [selectedLang] = useState(languages[2]); // Japanese is selected
