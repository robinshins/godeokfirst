...
export default function GNB() {
  ...
  const menuItems = [
    { name: '首页', href: '/cn' },
    { name: '种植牙', href: '/cn/implant' },
    { name: '美白 · 贴面', href: '/cn/whitening' },
    { name: '智齿拔除', href: '/cn/wisdom-tooth' },
    { name: '蛀牙 · 根管治疗', href: '/cn/cavity-treatment' },
    { name: '牙周护理 · 洗牙', href: '/cn/gum-care' }
  ];

  const [selectedLang] = useState(languages[3]); // Chinese is selected
