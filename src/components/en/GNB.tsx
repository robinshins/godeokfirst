...
export default function GNB() {
  ...
  const menuItems = [
    { name: 'Home', href: '/en' },
    { name: 'Implants', href: '/en/implant' },
    { name: 'Dentures · Full-Arch Implants', href: '/en/denture' },
    { name: 'Cavity · Root Canal', href: '/en/cavity-treatment' },
    { name: 'Wisdom Tooth Extraction', href: '/en/wisdom-tooth' },
    { name: 'Gum Care · Scaling', href: '/en/gum-care' },
    { name: 'TMJ Treatment', href: '/en/tmj' },
    { name: 'Teeth Whitening', href: '/en/whitening' },
  ];
  ...
  return (
    ...
    >
      ...
      >
        {/* Logo */}
        <Link href="/en" className="flex items-center" style={{ height: '60px' }}>
          <Image
            ...
            <div className="max-w-[430px] mx-auto">
              ...
              <div className="px-5 pb-3 border-b border-[#e9ebf1]">
                {user ? (
                  ...
                  <Link href="/en/login" onClick={() => setIsMenuOpen(false)}>
