...
export default function StatsSection() {
  const stats = [
    { number: '80', unit: '%', label: 'อัตราโรคเหงือกในผู้ใหญ่', source: 'สมาคมปริทันตวิทยาเกาหลี 2024' },
    { number: '14', unit: '% ลดลง', label: 'โรคหลอดเลือดหัวใจลดเมื่อขูดหินปูน', source: 'โรงพยาบาลมหาวิทยาลัยโซลบุนดัง 2024' },
    { number: '6', unit: 'เท่า', label: 'ควบคุมน้ำตาลล้มเหลวเมื่อมีโรคเหงือก', source: 'คณะแพทย์ม.คาทอลิก 2023' }
  ];
