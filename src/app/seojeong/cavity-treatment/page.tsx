...
const articleData: RegionArticleData = {
  ...
  sections: [
    ...
    {
      title: '정밀 진단으로 초기 충치까지 발견',
      content: [
        '고덕퍼스트치과에서는 정밀 진단 장비를 활용하여 육안으로 확인하기 어려운 초기 충치까지 정확하게 진단합니다.',
        '기존 X-ray만으로는 발견하기 어려운 인접면 충치나 미세 충치도 정밀 진단을 통해 조기에 발견할 수 있어, 불필요한 치아 삭제를 줄이고 보존적 치료가 가능합니다.',
    ...
    },
    {
      ...
      content: [
        ...
        '충치가 신경까지 진행된 경우에는 정밀 신경치료를 시행합니다. 통합치의학과 전문의의 정확한 판단으로 발치 대신 자연치아를 살리는 치료를 우선합니다.',
  ...
  conclusion: '서정동에서 충치치료를 고려하고 계시다면, 자연치아 보존을 최우선으로 하는 고덕퍼스트치과를 방문해 주세요. 정밀 진단과 통합치의학과 전문의의 맞춤 치료로 건강한 치아를 지켜드립니다. 전화 031-611-3222로 예약하세요.',
  faqs: [
    {
...
export const metadata: Metadata = {
  ...
  description: '서정동에서 가까운 충치치료 치과. 통합치의학과 전문의 이동현 원장 직접 치료. 정밀 진단, 보존 중심 치료. 서정역에서 차량 5분. 031-611-3222',
  keywords: '서정동 충치치료, 서정동 치과, 평택 충치치료, 고덕퍼스트치과, 서정동 신경치료',
  alternates: { canonical: 'https://gdfirstdent.co.kr/seojeong/cavity-treatment' },
  openGraph: {
    title: '서정동 충치치료 | 고덕퍼스트치과',
    description: '서정동 주민을 위한 자연치아 보존 충치치료. 통합치의학과 전문의 직접 진료.',
    url: 'https://gdfirstdent.co.kr/seojeong/cavity-treatment',
    siteName: '고덕퍼스트치과',
    locale: 'ko_KR',
    type: 'article',
    images: [
...
export default function SeojeongCavityTreatmentPage() {
  ...
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: '서정동 치과', item: 'https://gdfirstdent.co.kr/seojeong' },
      { '@type': 'ListItem', position: 3, name: '서정동 충치치료', item: 'https://gdfirstdent.co.kr/seojeong/cavity-treatment' },
    ],
  };
