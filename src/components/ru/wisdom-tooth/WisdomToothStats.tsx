...
export default function WisdomToothStats() {
  const stats = [
    { number: '2,700+', unit: 'случаев', label: 'Накопленных удалений зубов мудрости' },
    { number: '0', unit: 'случаев', label: 'Повторных лечений из-за осложнений', subtitle: '0 повторных лечений с момента открытия в Годок Эду Таун' },
    { number: '0', unit: '%', label: 'Направлений в вышестоящие больницы', subtitle: 'Наоборот, другие клиники направляют сложные случаи к нам' },
  ];
      ...
      <FadeInSection className="flex flex-col gap-4 items-center justify-center relative shrink-0 w-full z-10">
        <div className="flex flex-col gap-3 items-center justify-center relative shrink-0 w-full">
          ...
          <h2 className="font-bold leading-[1.35] not-italic text-[31px] text-center text-white tracking-[-0.64px] w-full" style={{ fontFamily: '"NanumSquare", sans-serif' }}>
            Любой тип зуба мудрости —<br />мы справлялись со всеми
          </h2>
          <p className="font-semibold leading-[1.4] not-italic text-[#e9ebf1] text-base text-center tracking-[-0.32px] w-full" style={{ fontFamily: '"NanumSquare", sans-serif' }}>
            Бывший профессор университетской больницы<br />безопасно удаляет даже самые сложные случаи
          </p>
        </div>
      </FadeInSection>
