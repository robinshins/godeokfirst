...
export default function SkillDifferenceSection() {
  const generalClinic = [
    {
      title: 'No In-house Dental Lab',
      description: 'Outsourcing to external labs increases cost and time,\ndetailed work is not possible'
    },
    {
      title: '1-Step Temporary Teeth',
      description: 'Straight to final prosthetics without bite adjustment'
    },
    {
      title: 'Risk of Re-surgery',
      description: 'Without specialized equipment and proper aftercare,\nre-surgery risk exists'
    }
  ];
  ...
  const medisClinic = [
    {
      ...
      description: 'A specialist that other dentists come to learn from,\nour doctor trains fellow dentists'
    },
    {
      title: '3-Step Temporary Teeth System',
      description: 'Step-by-step precision adjustment for perfect bite alignment'
    },
    {
      title: 'Record of 0 Re-surgeries',
      description: 'Overwhelming skill for perfection in a single procedure'
    }
  ];
      ...
      <div className="box-border flex flex-col gap-[50px] items-start px-4 py-[60px] relative w-full max-w-[430px]">
        ...
        <div className="flex flex-col gap-3 items-start relative shrink-0 w-full">
          ...
          <div className="font-semibold leading-[1.4] not-italic text-[#727582] text-base text-center tracking-[-0.32px] w-full" style={{ fontFamily: 'Pretendard, sans-serif' }}>
            Getting it right from the start is the wisest choice.<br />
            A perfect procedure with zero re-surgery — that is true skill.
          </div>
        </div>
                ...
                <div className="flex flex-col gap-[14px] items-start relative shrink-0 w-full">
                  <div className="flex flex-col gap-4 items-start not-italic relative shrink-0 text-center text-white w-full">
                    ...
                    <p className="font-semibold leading-[1.4] text-base tracking-[-0.32px] w-full" style={{ fontFamily: 'Pretendard, sans-serif' }}>
                      With overwhelming expertise,<br />
                      we promise a one-time procedure for a lifetime
                    </p>
                  </div>
                </div>
