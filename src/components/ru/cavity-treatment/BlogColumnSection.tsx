...
const columns = [
  {
    id: 1,
    num: '01',
    tag: 'керамика вкладка',
 title:'кариес, керамика вкладка лечение',
 desc:'хорошо стоматология кариес. натуральный зуб цвет и тоже повторный один керамика реставрация случай.',
    href: BLOG_URL,
  },
  {
    id: 2,
    num: '02',
    tag: 'композит',
    title: 'жевательные зубы начальный кариес композит лечение',
 desc:'начальный кариес минимальный удаление ключевой. натуральный зуб о сохранение эстетический вонодин композит лечение случай.',
    href: BLOG_URL,
  },
  {
    id: 3,
    num: '03',
    tag: 'вкладка повторныйлечение',
 title:'2разница вкладка лечение',
 desc:'долго возникновениеодин повторныйкариес. существующий доматериал удаление после Цифровое сканирование Trios5 точный повторныйизготовлениеодин случай.',
    href: BLOG_URL,
  },
  {
    id: 4,
    num: '04',
    tag: 'вкладка',
 title:'доматериал вкладка лечение',
 desc:'протезматериал после проведение 2разница проверка, разница нет вкладка реставрация процесс.',
    href: BLOG_URL,
  },
  {
    id: 5,
    num: '05',
    tag: 'керамика вкладка',
 title:'зуб керамика вкладка лечение',
 desc:'зуб повреждение и тип. этап точный диагностика через оригинальный зуб вонодин клинический.',
    href: BLOG_URL,
  },
];
      ...
      <div className="max-w-[430px] mx-auto flex flex-col gap-12">
        ...
        <div className="flex flex-col gap-4 text-center w-full">
          ...
          <h2 className="font-bold text-[32px] leading-[1.3] tracking-[-0.04em] text-white" style={{ fontFamily: 'Pretendard, sans-serif' }}>
            врач лично записьодин<br />кариес лечение история
          </h2>
          <p className="font-medium text-white/70 text-[16px] leading-[1.6] tracking-[-0.02em]" style={{ fontFamily: 'Pretendard, sans-serif' }}>
 самый хороший лечение точный диагностика начало.<br />реальный случай через лечение процесс.
          </p>
        </div>
