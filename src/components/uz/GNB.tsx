...
export default function GNB() {
  ...
  useEffect(() => {
    // onAuthStateChange faqat ishlatiladi (getUser chaqiruvini olib tashlash orqali egress tejash)
    // INITIAL_SESSION hodisasi joriy seans holatini taqdim etadi
  ...
  const languages = [
    { code: 'kr', name: 'Koreys', flag: '/icons/flags-kr.svg', href: getCurrentPage() === '/' ? '/' : getCurrentPage() },
  ...
  const menuItems = [
    ...
    { name: 'Protez · Toʼliq implant', href: '/denture' },
    { name: 'Kariyes · Kanal davolash', href: '/cavity-treatment' },
    { name: 'Aql tishi olish', href: '/wisdom-tooth' },
    { name: 'Milk davolash · Tozalash', href: '/gum-care' },
    { name: 'Jagʼ boʼgʼimi davolash', href: '/tmj' },
    { name: 'Tish oqartirish', href: '/whitening' },
  ];
            ...
            <div className="max-w-[430px] mx-auto">
              ...
              <div className="px-5 pb-3 border-b border-[#e9ebf1]">
                {user ? (
                  ...
                  <Link href="/uz/login" onClick={() => setIsMenuOpen(false)}>
