...
export default function VideoSection() {
  const videos = [
    {
      id: 'P54GsqWvnkw',
      title: 'ทุกเรื่องเกี่ยวกับฟันปลอม',
      description: 'ไขข้อสงสัยทุกอย่างเกี่ยวกับฟันปลอม',
    },
    {
      id: 'zmvu-xPe0ik',
      title: 'รากฟันเทียมทั้งปาก อธิบายละเอียด',
      description: 'ออกรายการช่องแพทย์ 2 ล้านผู้ติดตาม',
      badge: 'ช่อง 2 ล้านผู้ติดตาม',
    },
    {
      id: 'r7aeNpeP5vY',
      title: 'รากฟันเทียมทั้งปากคืออะไร?',
      description: 'ฟันปลอมถูกและดีไม่ใช่เหรอ? เราจะอธิบายให้ชัดเจน',
    },
    {
      id: 'rRVF8hLE82E',
      title: 'รากฟันเทียมทั้งปากยืดอายุ??',
      description: 'การสบฟันสำคัญขนาดนี้!!',
    },
  ];
