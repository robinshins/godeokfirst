...
export default function GNB() {
  ...
  const menuItems = [
    { name: '首页', href: '/' },
    { name: '种植牙', href: '/implant' },
    { name: '假牙 · 全口种植', href: '/denture' },
    { name: '龋齿 · 根管治疗', href: '/cavity-treatment' },
    { name: '智齿拔除', href: '/wisdom-tooth' },
    { name: '牙周治疗 · 洁牙', href: '/gum-care' },
    { name: '颞下颌关节治疗', href: '/tmj' },
    { name: '牙齿美白', href: '/whitening' },
  ];
  ...
  return (
    ...
    >
      ...
      >
        {/* Logo */}
        <Link href="/cn" className="flex items-center" style={{ height: '60px' }}>
          <Image
            ...
            <div className="max-w-[430px] mx-auto">
              ...
              <div className="px-5 pb-3 border-b border-[#e9ebf1]">
                {user ? (
                  ...
                  <Link href="/cn/login" onClick={() => setIsMenuOpen(false)}>
