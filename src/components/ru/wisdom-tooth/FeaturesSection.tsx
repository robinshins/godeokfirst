  ...
  const features = [
    {
      ...
      title: 'Богатый клинический опыт',
      description: 'Безопасное и точное удаление\nот специалиста по интегративной стоматологии'
    },
    {
      icon: '/images/clinic.png',
      title: 'Система «всё за один визит»',
      description: 'Диагностика, удаление\nи послеоперационный уход — в один день'
    },
    {
      icon: '/images/otoscope.png',
      title: 'Система обезболивания',
      description: 'Современное оборудование\nдля безболезненной процедуры'
    }
  ];
    ...
    <div className="bg-white w-full py-[60px] px-4">
      <div className="max-w-[375px] mx-auto">
        <div className="flex flex-col gap-10 items-start w-full">
          ...
          <div className="flex flex-col gap-4 items-center justify-center w-full">
            <div className="flex flex-col gap-3 items-center justify-center text-center w-full">
              <h2 className="font-bold text-[32px] leading-[1.35] tracking-[-0.64px] text-black whitespace-pre-line">
                {'Особенности нашей\nклиники в удалении зубов мудрости'}
              </h2>
              <p className="font-semibold text-base leading-[1.4] tracking-[-0.32px] text-[#727582] whitespace-pre-line">
                {'Более 2 700 случаев удаления\nи системный подход обеспечивают качество'}
              </p>
            </div>
          </div>
          ...
          {/* Сложные случаи - отдельная секция */}
          <div className="rounded-[24px] border-2 border-[#006aff] bg-white p-6 flex flex-col gap-5 items-center w-full">
            ...
            <div className="bg-[#f3f6fb] rounded-[16px] p-5 flex flex-col gap-3 w-full">
              <div className="flex items-start gap-2">
                ...
                <p className="font-semibold text-[14px] leading-[1.5] tracking-[-0.28px] text-[#37373e]">
                  <span className="font-bold text-[#006aff]">Глубокий ретинированный зуб</span> — даже если глубоко в десне
                </p>
              </div>
              <div className="flex items-start gap-2">
                <span className="text-[#006aff] text-lg shrink-0">✓</span>
                <p className="font-semibold text-[14px] leading-[1.5] tracking-[-0.28px] text-[#37373e]">
                  <span className="font-bold text-[#006aff]">Близость к нерву</span> — безопасное удаление без повреждения нерва
                </p>
              </div>
              <div className="flex items-start gap-2">
                <span className="text-[#006aff] text-lg shrink-0">✓</span>
                <p className="font-semibold text-[14px] leading-[1.5] tracking-[-0.28px] text-[#37373e]">
                  <span className="font-bold text-[#006aff]">Горизонтальное положение</span> — справляемся со сложными случаями
                </p>
              </div>
            </div>
            <div className="bg-gradient-to-br from-[#006aff] to-[#0052cc] rounded-[16px] p-4 w-full">
              <p className="font-bold text-[15px] leading-[1.5] tracking-[-0.3px] text-white text-center">
                Более 2 700 удалений — справляемся<br />
                со сложностью уровня стационара
              </p>
            </div>
          </div>
        </div>
