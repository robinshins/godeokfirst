    ...
    },
    {
      ...
      mainEntity: [
        ...
        },
        {
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text: '高德First牙科는 오스템 뷰티스 시스템을 사용하며, 지각과민 방지제가 함유되어 있어 시림 증상이 최소화됩니다. 시술 전 치아 상태를 정밀 진단하고, 시술 후에도 관리 방법을 상세히 안내해 드려 불편함 없이 밝은 치아를 유지하실 수 있습니다.',
          },
        },
        {
          '@type': 'Question',
