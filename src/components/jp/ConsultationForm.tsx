...
const consultationSchema = z.object({
  ...
  age: z.number().min(1, '年齢を入力してください').max(120, '有効な年齢を入力してください'),
  consultationContent: z.string().min(1, '相談内容を選択してください')
});
...
const presetOptions = [
  ...
  { main: '神経治療', sub: '' },
  { main: '補綴治療', sub: 'クラウン' },
  { main: '審美治療', sub: 'ホワイトニング、ラミネート' },
  { main: '親知らず抜歯', sub: '' },
  { main: '歯肉ケア', sub: '' },
  { main: '虫歯治療', sub: 'レジン、インレー' },
  { main: '顎関節治療', sub: '' }
];
          ...
          <div className="flex flex-col gap-[30px]">
            ...
            <div className="flex flex-col gap-[6px]">
              <label className="font-['Pretendard_JP'] font-semibold text-[13px] text-[#727582] tracking-[-0.26px] leading-[1.4]">
                名前<span className="text-[#ff1616]">*</span>
              </label>
              <input
                {...register('name')}
                type="text"
            ...
            <div className="flex flex-col gap-[6px]">
              <label className="font-['Pretendard_JP'] font-semibold text-[13px] text-[#727582] tracking-[-0.26px] leading-[1.4]">
                連絡方法<span className="text-[#ff1616]">*</span>
              </label>
              <div className="flex gap-2">
                <button
                  type="button"
                  onClick={() => handleContactTypeChange('phone')}
                  className={`flex-1 py-3 rounded-[12px] font-['Pretendard_JP'] font-semibold text-[14px] tracking-[-0.28px] transition-colors ${
                    contactType === 'phone'
            ...
            <div className="flex flex-col gap-[6px]">
              ...
              {contactType === 'phone' ? (
                <div className={`flex items-center w-full bg-white border ${errors.contact ? 'border-red-400' : 'border-[#e9ebf1]'} rounded-[16px] px-4 focus-within:border-[#006aff]`}>
                  <span className="font-['Pretendard_JP'] font-semibold text-[16px] tracking-[-0.32px] leading-[1.4] text-black pr-2">
                    +82
                  </span>
                  <input
                    {...register('contact')}
                    ...
                    className="flex-1 bg-transparent py-[17px] font-['Pretendard_JP'] font-semibold text-[16px] tracking-[-0.32px] leading-[1.4] placeholder:text-[#aab2c1] focus:outline-none"
                  />
                </div>
              ) : (
                <input
                  ...
                  type="text"
                  placeholder={getContactPlaceholder()}
                  className={`w-full bg-white border ${errors.contact ? 'border-red-400' : 'border-[#e9ebf1]'} rounded-[16px] px-4 py-[17px] font-['Pretendard_JP'] font-semibold text-[16px] tracking-[-0.32px] leading-[1.4] placeholder:text-[#aab2c1] focus:outline-none focus:border-[#006aff]`}
                />
              )}
              {errors.contact && (
            ...
            <div className="flex flex-col gap-[6px]">
              <label className="font-['Pretendard_JP'] font-semibold text-[13px] text-[#727582] tracking-[-0.26px] leading-[1.4]">
                年齢<span className="text-[#ff1616]">*</span>
              </label>
              <input
            ...
            <div className="flex flex-col gap-[6px]">
              ...
              />
              <label className="font-['Pretendard_JP'] font-semibold text-[13px] text-[#727582] tracking-[-0.26px] leading-[1.4]">
                相談内容<span className="text-[#ff1616]">*</span>
              </label>
              <div className="flex flex-col gap-[6px]">
                {/* Row 1 */}
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-[24px] p-6 max-w-[340px] w-full">
            <div className="text-center">
              ...
              <h3 className="font-['Pretendard_JP'] font-bold text-[20px] text-black tracking-[-0.4px] mb-2">
                DMをお送りください！
              </h3>
              <p className="font-['Pretendard_JP'] font-medium text-[14px] text-[#5d5f6d] tracking-[-0.28px] leading-[1.6] mb-4">
                返信が埋もれないよう、以下のアカウントにDMをお送りください：
              </p>
              <a
                href="https://www.instagram.com/dr_kimplant/"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-block bg-gradient-to-br from-purple-600 via-pink-600 to-orange-500 text-white font-['Pretendard_JP'] font-bold text-[16px] tracking-[-0.32px] px-6 py-3 rounded-[12px] mb-4 hover:opacity-90 transition-opacity"
              >
                @dr_kimplant
              </a>
              <p className="font-['Pretendard_JP'] font-normal text-[12px] text-[#727582] tracking-[-0.24px]">
                AI相談に移動中...
              </p>
            </div>
          </div>
