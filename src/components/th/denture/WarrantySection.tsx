          ...
          <div className="flex flex-col gap-3 items-center justify-center w-full">
            <div className="relative w-full h-[92px]">
              <Image
                ...
                alt="ระบบรับประกันรากฟันเทียมตลอดชีวิตด้วยใจ"
                fill
                className="object-contain"
              />
            </div>
            ...
            <p className="font-semibold leading-[1.4] text-white text-base text-center tracking-[-0.32px] w-full" style={{ fontFamily: 'Pretendard, sans-serif' }}>
              Godeok First Dental สัญญาว่าจะเป็นคลินิกทันตกรรมที่รับผิดชอบ.<br aria-hidden="true" />
              ใช้ได้อย่างสบายใจตลอดชีวิตด้วยระบบรับประกันที่เป็นระบบ.
            </p>
          </div>
        </div>
