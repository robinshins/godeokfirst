...
export default function SkillDifferenceSection() {
  const advantages = [
    {
      title: 'Choson universiteti tashqi professor tomonidan bevosita jarrohlik',
      description: 'Universitetda yosh shifokorlarni oʼqituvchi\ntasdiqlangan mutaxassis bevosita operatsiya qiladi',
      highlight: 'Oʼqituvchi mahorati',
      iconPath: 'M22 10v6M2 10v6M12 2L2 7l10 5 10-5-10-5zM12 22V12'
    },
    {
      title: 'Osstem·Point·Dentis tadqiqot maslahatchisi',
      description: 'Koreyadagi yetakchi implant kompaniyalarining tadqiqot maslahatchisi\nEng soʼnggi texnologiya va jihozlarni bevosita qoʼllaydi',
      highlight: 'Tasdiqlangan texnologiya',
      iconPath: 'M9 3H5a2 2 0 0 0-2 2v4m6-6h10a2 2 0 0 1 2 2v4M9 3v18m0 0h10a2 2 0 0 0 2-2V9M9 21H5a2 2 0 0 1-2-2V9m0 0h18'
    },
    {
      title: '3D raqamli yoʼnaltiruvchi jarrohlik',
      description: '0.1mm xatolik bilan aniq oʼrnatish\nNerv/qon tomir shikastlanish xavfini minimallashtirish',
      highlight: 'Aniq texnologiya',
      iconPath: 'M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z'
    },
    {
      title: 'Kesiksiz & bir kunda oʼrnatish',
      description: 'Qon ketish, ogʼriq, shishishni minimallashtirish\nKundalik hayotga tez qaytish mumkin',
      highlight: 'Qulay jarrohlik',
      ...
      <div className="box-border flex flex-col gap-12 items-center px-6 py-[80px] relative z-10 w-full max-w-[430px]">
        ...
        <FadeInSection className="text-center w-full">
          ...
          <h2 className="font-extrabold text-[32px] text-white leading-[1.3] tracking-tight mb-5" style={{ fontFamily: '"NanumSquare", sans-serif' }}>
            Mahorat farqli boʼlsa
            <br />
            <span className="text-[#008095]">Natija ham farqli boʼladi</span>
          </h2>
          <p className="font-medium leading-[1.6] text-white/70 text-[15px] tracking-[-0.3px]" style={{ fontFamily: '"NanumSquare", sans-serif' }}>
            Boshidan toʼgʼri qilish eng oqilona tanlovdir
            <br />
            Qayta operatsiyasiz mukammal davolash — bu haqiqiy mahorat
          </p>
        </FadeInSection>
            ...
            <div className="relative z-10">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 text-center border border-white/10">
                  ...
                  <p className="text-[12px] text-white/70 font-medium" style={{ fontFamily: '"NanumSquare", sans-serif' }}>Aql tishi sughʼurish tajribasi</p>
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 text-center border border-white/10">
                  <p className="text-[28px] font-black text-white mb-1" style={{ fontFamily: '"NanumSquare", sans-serif' }}>4.9</p>
                  <p className="text-[12px] text-white/70 font-medium" style={{ fontFamily: '"NanumSquare", sans-serif' }}>Bemor qoniqishi / 5.0</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <FadeInSection delay={200} className="w-full space-y-4">
          <p className="text-center text-white/50 text-[13px] font-medium tracking-wide" style={{ fontFamily: '"NanumSquare", sans-serif' }}>
            Faqat Godeok First Dentalga xos farqli tizim
          </p>
        ...
        <FadeInSection delay={300} className="w-full">
          <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-5 text-center">
            <p className="text-white/80 text-[14px] leading-[1.6] mb-3" style={{ fontFamily: '"NanumSquare", sans-serif' }}>
              <span className="text-[#4DC8D8] font-bold">Umr boʼyi foydalaniladigan implant</span>, kimga ishonasiz?
            </p>
            <p className="text-white text-[15px] font-bold" style={{ fontFamily: '"NanumSquare", sans-serif' }}>
              Universitet kasalxonasi darajasidagi davolashni his qiling
            </p>
          </div>
        </FadeInSection>
      </div>
