  ...
  return (
    <div className="bg-gradient-to-b from-white to-[#d8eaf5]">
      <div className="max-w-[430px] mx-auto px-4 py-[60px]">
        ...
        {/* Interior Photos */}
        <div className="mb-10">
          <h3 className="text-2xl font-bold text-[#292a2f] mb-4">Our Facilities</h3>
        ...
        <div className="space-y-6">
          ...
          <div className="relative border-[5px] border-white rounded-2xl overflow-hidden h-[480px]">
            ...
            <div className="absolute bottom-4 left-4 right-4 space-y-3">
              <div className="text-black font-semibold text-[15px] leading-[1.6]">
                <p className="mb-0">4F 401, 402, Edu Sky, 250 Godeok-ro, Pyeongtaek-si, Gyeonggi-do</p>
              </div>
              <Link
          ...
          <div className="space-y-10">
            ...
            <div className="space-y-3">
              <p className="text-base font-semibold text-[#727582]">Office Hours</p>
              <div className="text-[15px] font-semibold text-black leading-[1.8] space-y-1">
                <div className="flex">
                  <span className="min-w-[140px]">Mon / Thu (Evening) :</span>
                  <span className="whitespace-nowrap">AM 10:00 – PM 09:00</span>
                </div>
                <div className="flex">
                  <span className="min-w-[140px]">Tue / Wed / Fri :</span>
            ...
            <div className="space-y-4">
              <div className="space-y-3">
                <p className="text-base font-semibold text-[#727582]">Reservations</p>
                <p className="text-[15px] text-[#727582] leading-[1.6]">
                  Book via AI reservation, phone, or Naver booking below.
                </p>
              </div>
              ...
              <div className="space-y-3">
                ...
                >
                  <div className="flex flex-col items-center">
                    <span className="text-lg font-bold text-[#008095]">Call Us</span>
