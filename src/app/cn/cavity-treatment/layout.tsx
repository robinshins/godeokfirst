...
export const metadata: Metadata = {
  title: '고덕동충치치료 평택충치치료 | 高德First牙科',
  description: '고덕동충치치료 평택충치치료 전문. 통합치의학과 전문의, 정밀 진단, 자연치아 보존 치료. 발치 대신 살리는 치료.',
  keywords: ['고덕동충치치료', '평택충치치료', '高德First牙科충치', '고덕동신경치료', '평택신경치료'],
  alternates: {
      ...
      mainEntity: [
        {
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text: '네, 가능성이 높습니다. 高德First牙科는 통합치의학과 전문의가 정밀 진단합니다. 일반 치과에서 보이지 않던 살릴 방법을 찾을 수 있으며, 자연치아를 살리는 것을 최우선으로 합니다.',
          },
        },
        {
          '@type': 'Question',
