...
const columns = [
  {
    ...
    num: '01',
    tag: 'керамик инлей',
 title:'цооронхой, керамик инлей эмчилгээ',
 desc:'цооронхой. байгалийн шүд өнгө дахин керамик сэргээн засвар тохиолдол.',
    href: BLOG_URL,
  },
  {
    id: 2,
    num: '02',
    tag: 'композит',
    title: 'араг шүд эхний цооронхой композит эмчилгээ',
 desc:'эхний цооронхой хамгийн бага. байгалийн шүд гоо сайхны вон композит эмчилгээ тохиолдол.',
    href: BLOG_URL,
  },
  {
    id: 3,
    num: '03',
    tag: 'инлей дахинэмчилгээ',
 title:'2зөрүү инлей эмчилгээ',
 desc:'дахинцооронхой. одоогийн арилгах Trios5 дижитал нарийвчилсан дахинүйлдвэрлэл тохиолдол.',
    href: BLOG_URL,
  },
  {
    id: 4,
    num: '04',
    tag: 'инлей',
 title:'инлей эмчилгээ',
 desc:'хиймэл шүд явуулах 2зөрүү шалгалт, дижитал зөрүү инлей сэргээн засвар.',
    href: BLOG_URL,
  },
  {
    id: 5,
    num: '05',
    tag: 'керамик инлей',
 title:'шүд керамик инлей эмчилгээ',
 desc:'шүд гэмтэл төрөл. шатлал нарийвчилсан анхны шүд вон.',
    href: BLOG_URL,
  },
];
