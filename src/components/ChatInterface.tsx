...
export default function ChatInterface({ initialMessage, language = 'ko' }: ChatInterfaceProps) {
  ...
  const handleNaverReservation = async () => {
    ...
    // 네이버 예약 페이지 새 탭에서 열기
    window.open('https://m.booking.naver.com/booking/13/bizes/981541/items/7265917?area=ple&lang=ko', '_blank');
  };
                ...
                <div className="w-[30px] h-[30px] flex-shrink-0">
                  <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30" fill="none">
                    ...
                    <g mask="url(#mask0_1_5578)">
                      <path d="M9.43949 6.84286C9.70916 5.71905 11.2908 5.71904 11.5605 6.84286L12.3025 9.93512C12.3988 10.3364 12.7088 10.6496 13.1059 10.7469L16.1659 11.4967C17.278 11.7693 17.278 13.3676 16.1659 13.6401L13.1059 14.3899C12.7088 14.4872 12.3988 14.8005 12.3025 15.2017L11.5605 18.294C11.2908 19.4178 9.70916 19.4178 9.43949 18.294L8.69748 15.2017C8.6012 14.8005 8.29118 14.4872 7.89413 14.3899L4.83408 13.6401C3.72197 13.3676 3.72197 11.7693 4.83408 11.4967L7.89413 10.7469C8.29118 10.6496 8.6012 10.3364 8.69748 9.93512L9.43949 6.84286Z" fill="#008095"/>
                      <path d="M18.3474 17.6345C18.5133 16.9429 19.4867 16.9429 19.6526 17.6345L20.1092 19.5374C20.1685 19.7843 20.3593 19.9771 20.6036 20.037L22.4867 20.4984C23.1711 20.6661 23.1711 21.6497 22.4867 21.8174L20.6036 22.2788C20.3593 22.3387 20.1685 22.5315 20.1092 22.7784L19.6526 24.6813C19.4867 25.3729 18.5133 25.3729 18.3474 24.6813L17.8908 22.7784C17.8315 22.5315 17.6407 22.3387 17.3964 22.2788L15.5133 21.8174C14.8289 21.6497 14.8289 20.6661 15.5133 20.4984L17.3964 20.037C17.6407 19.9771 17.8315 19.7843 17.8908 19.5374L18.3474 17.6345Z" fill="#008095"/>
                      ...
                      <path fillRule="evenodd" clipRule="evenodd" d="M22 6.94089L21.7554 7.96013C21.6577 8.36754 21.3429 8.68564 20.9397 8.78443L19.9311 9.03158L20.9397 9.27873C21.3429 9.37752 21.6577 9.69562 21.7554 10.103L22 11.1223L22.2446 10.103C22.3423 9.69562 22.6571 9.37752 23.0603 9.27873L24.0689 9.03158L23.0603 8.78443C22.6571 8.68564 22.3423 8.36754 22.2446 7.96013L22 6.94089ZM22.4895 6.38901C22.365 5.87033 21.635 5.87033 21.5105 6.38901L21.1681 7.81621C21.1236 8.00139 20.9805 8.14598 20.7973 8.19089L19.385 8.53696C18.8717 8.66274 18.8717 9.40042 19.385 9.5262L20.7973 9.87227C20.9805 9.91718 21.1236 10.0618 21.1681 10.2469L21.5105 11.6741C21.635 12.1928 22.365 12.1928 22.4895 11.6741L22.8319 10.2469C22.8764 10.0618 23.0195 9.91718 23.2027 9.87227L24.615 9.5262C25.1283 9.40042 25.1283 8.66274 24.615 8.53696L23.2027 8.19089C23.0195 8.14598 22.8764 8.00139 22.8319 7.81621L22.4895 6.38901Z" fill="#008095"/>
                    </g>
                  </svg>
                </div>
