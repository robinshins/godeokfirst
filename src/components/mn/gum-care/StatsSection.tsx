...
export default function StatsSection() {
  const stats = [
 { number:'80', unit:'%', label:'буйл', source:'буйлны удаа 2024'},
 { number:'14', unit:'%', label:'цэвэрлэгээ', source:'минут эмнэлэг 2024'},
 { number:'6', unit:'дахин', label:'буйлны', source:'2023'},
  ];
