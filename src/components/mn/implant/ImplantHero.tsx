...
export default function ImplantHero() {
 ...
 Их сургуулийн эмнэлэг мэс засал <br />
              чанарыг мэдрээрэй.
            </h1>
            <p className="font-semibold leading-[1.5] relative shrink-0 text-[18px] tracking-[-0.36px] w-full text-[#3e3a3a]">
 магистрантура Имплант төгссөн,<br />Чосоны их сургуулийн шүдний эмнэлэгэмнэлэг Зочин профессор байсан <br />Эмч Ли Донхён мэс засал.
            </p>
          </div>
        </FadeInSection>
