    ...
    <div className="bg-[#f8fbfd] w-full flex justify-center">
      <div className="box-border flex flex-col gap-10 items-start px-4 py-[60px] relative w-full max-w-[430px]">
        ...
        <div className="flex flex-col gap-4 items-start relative shrink-0 w-full">
          ...
          {/* Reason 1: Kompleks stomatologiya mutaxassisi + Universitet tashqi professori */}
          <FadeInSection delay={100} className="group bg-white rounded-3xl p-6 shadow-sm border border-[#edf2f7] hover:border-[#008095] hover:shadow-lg hover:-translate-y-1 transition-all duration-300 overflow-hidden relative w-full">
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-[24px] font-bold text-[#3e3a3a] leading-[1.3] mb-3" style={{ fontFamily: '"NanumSquare", sans-serif' }}>
                Tish shifokorlarini oʼqituvchi
                <br />
                <span className="text-[#008095]">Kompleks stomatologiya mutaxassisi</span>
              </h3>
              <p className="text-[15px] text-[#666] leading-[1.6] mb-6" style={{ fontFamily: '"NanumSquare", sans-serif' }}>
                ...
                Seul milliy universiteti stomatologiya magistraturasi implant mukofoti bilan tamomlagan.<br />
                <span className="font-bold text-[#333]">Kompleks stomatologiya mutaxassisi</span> shaxsan davolaydi.
              </p>
              ...
              <div className="flex gap-3">
                <div className="relative flex-1 h-[160px] rounded-xl overflow-hidden">
                  <Image
                    ...
                    alt="Bosh shifokor sertifikatlari"
                    fill
                  ...
                  <div className="absolute bottom-2 left-2 z-10">
                    <div className="bg-black/60 px-2 py-1 rounded-md">
                      <span className="text-white text-[10px] font-medium">Sertifikatlar</span>
                    </div>
                  </div>
                </div>
                <div className="relative flex-1 h-[160px] rounded-xl overflow-hidden">
                  ...
                  <div className="absolute bottom-2 left-2 z-10">
                    <div className="bg-black/60 px-2 py-1 rounded-md">
                      <span className="text-white text-[10px] font-medium">Bosh shifokor tajribasi</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          {/* Reason 2: Boy operatsiya tajribasi */}
          <FadeInSection delay={200} className="group bg-white rounded-3xl p-6 shadow-sm border border-[#edf2f7] hover:border-[#008095] hover:shadow-lg hover:-translate-y-1 transition-all duration-300 overflow-hidden relative w-full">
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-[24px] font-bold text-[#3e3a3a] leading-[1.3] mb-3" style={{ fontFamily: '"NanumSquare", sans-serif' }}>
                1,200marta+ implant
                <br />
                <span className="text-[#008095]">qayta operatsiya 0 ta</span>
              </h3>
              <p className="text-[15px] text-[#666] leading-[1.6] mb-6" style={{ fontFamily: '"NanumSquare", sans-serif' }}>
                Godeok Edutown ochilganidan beri hozirga qadar<br />
                implant qayta operatsiya birorta ham yoʼq.<br />
                <span className="font-bold text-[#333]">Natija isbotlaydigan mahorat</span>dir.
              </p>

              <div className="relative w-full aspect-[4/3] rounded-xl overflow-hidden mb-4">
                <Image
                  src="/images/goduk_images/수술하는모습.jpeg"
                  alt="implant operatsiya koʼrinishi"
                  fill
                  className="object-cover"
                  sizes="400px"
                />
              ...
              <div className="bg-[#f8fbfd] rounded-xl p-4 border border-[#eef4f8] space-y-3">
                {[
                  { label: 'Implant oʼrnatish', value: '1,200 marta+' },
                  { label: 'Godeok Edutown ochilganidan beri qayta operatsiya', value: '0 ta' },
                  { label: 'Bemor mamnuniyati', value: '4.9 / 5.0' },
                ].map((item, i) => (
          ...
          {/* Reason 3: raqamli aniq operatsiya */}
          <FadeInSection delay={300} className="group bg-white rounded-3xl p-6 shadow-sm border border-[#edf2f7] hover:border-[#008095] hover:shadow-lg hover:-translate-y-1 transition-all duration-300 overflow-hidden relative w-full">
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-[24px] font-bold text-[#3e3a3a] leading-[1.3] mb-3" style={{ fontFamily: '"NanumSquare", sans-serif' }}>
                3D raqamli diagnostika bilan
                <br />
                <span className="text-[#008095]">aniq shaxsiy operatsiya</span>
              </h3>
              <p className="text-[15px] text-[#666] leading-[1.6] mb-6" style={{ fontFamily: '"NanumSquare", sans-serif' }}>
                3D CT tahlili va raqamli navigatsiya orqali<br />
                Suyak holatiga optimal joylashtirib oʼrnatish.<br />
                <span className="font-bold text-[#333]">Minimal kesim, minimal suyak koʼchirish</span> bilan tiklanish tez.
              </p>

              <div className="relative w-full aspect-[4/3] rounded-xl overflow-hidden mb-4">
                <Image
                  src="/images/goduk_images/3d.webp"
                  alt="3D raqamli implant operatsiya navigatsiyasi"
                  fill
                  className="object-cover"
                  sizes="400px"
                />
              ...
              <div className="grid grid-cols-1 gap-3">
                {[
                  { title: '3D CT aniq tahlil', desc: 'Suyak zichligi va qalinligini 3D aniq aniqlash' },
                  { title: 'Raqamli operatsiya navigatsiyasi', desc: 'Loyihaga muvofiq aniq oʼrnatish' },
                  { title: 'Eng yangi jihozlar toʼliq', desc: 'Skaner, raqamli laboratoriya tizimi mavjud' },
                ].map((item, i) => (
          ...
          <FadeInSection delay={400} className="group bg-white rounded-3xl p-6 shadow-sm border border-[#edf2f7] hover:border-[#008095] hover:shadow-lg hover:-translate-y-1 transition-all duration-300 overflow-hidden relative w-full">
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-[24px] font-bold text-[#3e3a3a] leading-[1.3] mb-3" style={{ fontFamily: '"NanumSquare", sans-serif' }}>
                Operatsiyadan keyin
                <br />
                <span className="text-[#008095]">oxirigacha javobgar davolash</span>
              </h3>
              <p className="text-[15px] text-[#666] leading-[1.6] mb-6" style={{ fontFamily: '"NanumSquare", sans-serif' }}>
                Bosh shifokor maslahatdan operatsiya, parvarishgacha<br />
                shaxsan javob beradi. Oʼrtada oʼzgaradigan shifokor yoʼq<br />
                <span className="font-bold text-[#333]">Boshidan oxirigacha bitta bosh shifokor</span> davolaydi.
              </p>

              <div className="bg-[#f8fbfd] rounded-xl p-5 border border-[#eef4f8] space-y-4">
                {[
                  { icon: '🔍', title: 'Muntazam tekshiruv', desc: '6 oy oraligʼida muntazam tekshiruv bilan holatni tekshirish' },
                  { icon: '🦷', title: 'Mutaxassis tozalash', desc: 'Implant atrofidagi yalligʼlanish oldini olish tozalashi' },
                  { icon: '📋', title: 'Shaxsiy parvarish rejasi', desc: 'Bemor holatiga mos shaxsiy parvarish' },
                ].map((item, i) => (
