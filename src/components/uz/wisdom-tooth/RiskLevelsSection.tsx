  ...
  const riskLevels = [
    {
      ...
      title: 'Oddiy donolik tishi',
      description: 'To\'g\'ri o\'sgan donolik tishini ham parvarish qilish qiyin,\nshuning uchun chuqurlash xavfi yuqori',
    ...
    },
    {
      ...
      title: 'Qisman ko\'milgan donolik tishi',
      description: 'Oziq-ovqat qoldiqlari oson yig\'iladi va\nyallig\'lanish tez-tez paydo bo\'ladi',
    ...
    },
    {
      ...
      title: 'To\'liq ko\'milgan donolik tishi',
      description: 'Kista hosil bo\'lish ehtimoli bor,\nerta olish kerak',
    ...
    },
    {
      ...
      levelBg: 'bg-[#fef1e5]',
      levelColor: 'text-[#f57400]',
      title: 'Ildizi egri donolik tishi',
      description: 'Ildizi egri bo\'lgani uchun\nolish qiyinligi yuqori',
    ...
    {
      level: 'Darhol davolash kerak',
      levelBg: 'bg-[#ffebed]',
      levelColor: 'text-[#ff1616]',
      title: 'Gorizontal ko\'milgan donolik tishi',
      description: 'Yonidagi tishni itarib, tish qatorini buzadi va\nchuqurlikka olib keladi',
          ...
          <div className="flex flex-col gap-4 items-center justify-center w-full">
            <div className="flex flex-col gap-3 items-center justify-center w-full">
              <h2 className="font-bold text-[32px] leading-[1.35] tracking-[-0.64px] text-[#292a2f] text-center">
                Donolik tishi holati bo'yicha xavf darajasi
              </h2>
            </div>
          </div>
