...
export default function StatsSection() {
  const stats = [
    { number: '1,200', unit: '次+', label: '种植牙 植入 次数' },
    { number: '0', unit: '例', label: '种植牙 再手术', subtitle: '高德Edu Town 开业以来 再手术 0例' },
    { number: '6', unit: '年+', label: '大学医院 客座教授 曾任' },
    { number: '4.9', unit: '/ 5.0', label: '患者满意度', subtitle: 'Kakao、Google、Naver地图标准' },
  ];
