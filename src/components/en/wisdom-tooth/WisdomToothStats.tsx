...
export default function WisdomToothStats() {
  const stats = [
    { number: '2,700+', unit: 'cases', label: 'Cumulative Wisdom Tooth Extractions' },
    { number: '0', unit: 'cases', label: 'Retreatments Due to Complications', subtitle: 'Zero retreatments since opening at Godeok Edu Town' },
    { number: '0', unit: '%', label: 'Referral Rate to Higher-Level Hospitals', subtitle: 'In fact, other clinics send their difficult cases to us' },
  ];
      ...
      <FadeInSection className="flex flex-col gap-4 items-center justify-center relative shrink-0 w-full z-10">
        <div className="flex flex-col gap-3 items-center justify-center relative shrink-0 w-full">
          ...
          <p className="font-semibold leading-[1.4] not-italic text-[#e9ebf1] text-base text-center tracking-[-0.32px] w-full" style={{ fontFamily: '"NanumSquare", sans-serif' }}>
            Former University Hospital Visiting Professor<br />
            safely extracts even the most difficult cases
          </p>
        </div>
      </FadeInSection>
