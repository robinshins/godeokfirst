...
export const metadata: Metadata = {
  ...
  description: 'Pyeongtaek Godeok 턱관절 치료 전문 치과. 턱관절 통증, 개구장애, 턱소리 정밀 진단. Comprehensive Dentistry Specialist treats directly.',
  ...
  openGraph: {
    title: '고덕턱관절치료 | Godeok First Dental',
    description: 'Pyeongtaek Godeok 턱관절 치료 전문 치과. Comprehensive Dentistry Specialist treats directly.',
