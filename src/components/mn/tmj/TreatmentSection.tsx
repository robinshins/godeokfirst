...
export default function TmjTreatmentSection() {
      ...
      <div className="max-w-[430px] mx-auto flex flex-col gap-12">
        ...
        <div className="flex flex-col gap-4 text-center">
          ...
          >
            ...
            <span className="text-[#008095]">Эрүүний үений эмчилгээ систем</span>
          </h2>
          <p
            className="font-medium text-[#727582] text-[16px] leading-[1.6] tracking-[-0.02em]"
            style={{ fontFamily: 'Pretendard, sans-serif' }}
          >
 шалтгаан <br />шатлал эмчилгээ явуулах.
          </p>
        </div>
 ...
 нарийвчилсан 
            ...
            <p
              ...
              style={{ fontFamily: 'Pretendard, sans-serif' }}
            >
 X-ray,, зуун минут эрүүний үе байршил,, зуун нарийвчилсан.
            </p>
            <div className="bg-[#f3f6fb] rounded-[16px] p-4 flex flex-col gap-2">
 {['X-ray','эрүүний үе болон','зуун минут ·'].map((item, i) => (
 ...
 эмчилгээ
            ...
            <p
              ...
              style={{ fontFamily: 'Pretendard, sans-serif' }}
            >
 өвдөлт эмчилгээ эмчилгээ өвдөлт үрэвсэл.
            </p>
            <div className="bg-[#f3f6fb] rounded-[16px] p-4 flex flex-col gap-2">
 {['·','·',''].map((item, i) => (
                <div key={i} className="flex items-center gap-2">
          ...
          <div className="bg-[#008095] rounded-[24px] p-6 flex flex-col gap-5 shadow-xl shadow-[#008095]/20">
            <div className="flex items-center gap-3">
              ...
              <h3
                ...
                style={{ fontFamily: 'Pretendard, sans-serif' }}
              >
 сплинт(зуун төхөөрөмж) эмчилгээ
              </h3>
            </div>
            <p
              ...
              style={{ fontFamily: 'Pretendard, sans-serif' }}
            >
 өвчтөн төрөл сплинт үйлдвэрлэл эрүүний үе минут, байршил.
            </p>
            <div className="bg-white/10 rounded-[16px] p-4 flex flex-col gap-2">
 {['дижитал зуун минут үйлдвэрлэл','·','байршил жигдрүүлэг','зуун тохируулга'].map((item, i) => (
                <div key={i} className="flex items-center gap-2">
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" className="shrink-0">
 ...
 шалтгаан шийдвэрлэх · дахин 
            ...
            <p
              ...
              style={{ fontFamily: 'Pretendard, sans-serif' }}
            >
 өвдөлт шалтгаан шийдвэрлэх. буруузуун жигдрүүлэг, гэмтэл шүд хиймэл шүд, гэх мэт дахин.
            </p>
            <div className="bg-[#f3f6fb] rounded-[16px] p-4 flex flex-col gap-2">
 {['зуун тохируулга · хиймэл шүд эмчилгээ','','шалгалт'].map((item, i) => (
                <div key={i} className="flex items-center gap-2">
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" className="shrink-0">
                    <circle cx="8" cy="8" r="7" stroke="#008095" strokeWidth="1.5" />
                    <path d="M5 8L7 10L11 6" stroke="#008095" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
