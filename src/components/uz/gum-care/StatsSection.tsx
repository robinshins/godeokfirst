...
export default function StatsSection() {
  const stats = [
    { number: '80', unit: '%', label: 'Kattalar milk kasalligi darajasi', source: 'Koreya Parodontologiya jamiyati 2024' },
    { number: '14', unit: '% kamayish', label: 'Tozalashda yurak-qon tomir kasalligi kamayishi', source: 'Bundang Seul universiteti shifoxonasi 2024' },
    { number: '6', unit: 'marta', label: 'Parodontitda qon shakar nazorati buzilishi', source: 'Katolik universiteti 2023' },
  ];
