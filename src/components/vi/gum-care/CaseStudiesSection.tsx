...
export default function CaseStudiesSection() {
  const cases = [
    {
      quote: [
        '"Xương đã bị tiêu biến nghiêm trọng"',
        '"nhờ điều trị nướu mà xương đã đầy lại"'
      ],
      ...
      title: 'Tình trạng xương bị tiêu nhiều do bệnh nướu nghiêm trọng',
      result: 'Cấy ghép implant sau khi tái tạo xương bằng cách điều trị nướu và ghép xương'
    },
    {
      quote: [
        '"Nhờ chăm sóc định kỳ, dù ở độ tuổi 50"',
        '"tất cả các răng của tôi vẫn khỏe mạnh"'
      ],
      ...
      title: 'Tình trạng cao răng và viêm nướu nghiêm trọng',
      result: 'Duy trì sức khỏe bằng cách lấy cao răng và chăm sóc định kỳ'
    }
  ];
