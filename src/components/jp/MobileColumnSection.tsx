  ...
  implant: [
    {
      ...
      description: '複数のインプラントを埋入する際に必ず守るべき原則と考慮事項を院長が直接説明します。',
    },
    {
      title: 'インプラント生存率についての話',
      url: 'https://blog.naver.com/gdfst111/224184908972',
      description: 'インプラント生存率に影響する要因と長期的に成功するインプラントのための核心条件を扱います。',
    },
    {
      title: 'インプラントの咬合、なぜ重要か？',
      url: 'https://blog.naver.com/gdfst111/224184928593',
      description: 'インプラント治療で咬合（噛む力のバランス）がなぜ重要なのか、誤った咬合がどんな問題を引き起こすか説明します。',
    },
  ],
  home: [],
};
