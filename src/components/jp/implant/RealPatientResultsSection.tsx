      ...
      <div className="box-border flex flex-col gap-[60px] items-center px-4 py-[60px] relative w-full max-w-[430px]">
        ...
        <div className="flex flex-col gap-4 items-center justify-center relative shrink-0 w-full">
          <div className="flex flex-col gap-3 items-center justify-center leading-[0] not-italic relative shrink-0 text-center w-full">
            <h2 className="font-bold leading-[1.35] text-[32px] text-white tracking-[-0.64px] w-full" style={{ fontFamily: 'Pretendard_JP, sans-serif' }}>
              デジタルガイド<br />全体インプラント前後症例
            </h2>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-6 items-start relative shrink-0 w-full">
              ...
              <div className="flex flex-col items-center justify-center overflow-hidden rounded-[inherit] w-full">
                <div className="box-border flex flex-col gap-5 items-center justify-center px-4 py-6 relative shrink-0 w-full">
                      ...
                      <div className="bg-[#f3f6fb] h-[192px] overflow-hidden relative rounded-[20px] shrink-0 w-full">
                        ...
                        {!user && (
                          <Link href="/jp/login" className="absolute inset-0 cursor-pointer">
                            ...
                            <div className="absolute bottom-4 left-1/2 -translate-x-1/2 bg-black/60 px-4 py-2 rounded-full">
                              <p className="text-white text-xs font-medium whitespace-nowrap">ログインして前の写真を見る</p>
                            </div>
                          </Link>
                        )}
                        {/* Before Badge */}
                        <div className="absolute box-border flex flex-col gap-2.5 items-start left-0 p-3 top-0 z-10">
                          <div className="bg-[#292a2f] box-border flex flex-col gap-2.5 items-center justify-center px-2.5 py-[5px] relative rounded-[10px] shrink-0">
                            <p className="font-semibold leading-[1.4] not-italic text-[13px] text-nowrap text-white tracking-[-0.26px]" style={{ fontFamily: 'Pretendard_JP, sans-serif' }}>
                              顔 Before
                            </p>
                          </div>
                        </div>
                  ...
                  <div className="flex flex-col gap-1 items-start relative shrink-0 w-full">
                    <p className="font-semibold leading-[1.4] not-italic text-[#9298a6] text-[15px] text-center tracking-[-0.3px] w-full" style={{ fontFamily: 'Pretendard_JP, sans-serif' }}>
          ...
          {!showMore && (
            ...
            >
              <span className="font-bold leading-[1.5] not-italic text-[#006aff] text-xl text-nowrap tracking-[-0.4px]" style={{ fontFamily: 'Pretendard_JP, sans-serif' }}>
                もっと見る
              </span>
            </button>
          )}
