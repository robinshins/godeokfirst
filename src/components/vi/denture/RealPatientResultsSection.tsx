  ...
  const cases = [
    {
      name: 'Park●●',
      gender: 'Nam',
      type: 'Implant toàn hàm · X-ray',
      beforeImage: '/임상사진/박균조_trước악임플란트/박균조_toàn bộ임플란트_엑스레_before.jpg',
      afterImage: '/임상사진/박균조_trước악임플란트/박균조_toàn bộ임플란트_엑스레_after.jpg'
    },
    {
      name: 'Park●●',
      gender: 'Nam',
      type: 'Implant toàn hàm · Ảnh thực tế',
      beforeImage: '/임상사진/박균조_trước악임플란트/박균조_toàn bộ임플란트_실제사진_before.jpg',
      afterImage: '/임상사진/박균조_trước악임플란트/박균조_toàn bộ임플란트_실제사진_after.jpg'
    }
  ];
        ...
        <FadeInSection className="flex flex-col gap-4 items-center justify-center relative shrink-0 w-full">
          <div className="flex flex-col gap-3 items-center justify-center relative shrink-0 text-center w-full">
            ...
            <h2 className="font-bold leading-[1.35] text-[32px] text-white tracking-[-0.64px] w-full" style={{ fontFamily: '"NanumSquare", sans-serif' }}>
              toàn bộTrường hợp Implant trước sau
            </h2>
            <p className="font-medium leading-[1.6] text-[#a0c4d4] text-[15px] text-center tracking-[-0.32px] w-full" style={{ fontFamily: '"NanumSquare", sans-serif' }}>
              Hãy xem sự thay đổi đáng kinh ngạc của bệnh nhân thực tế
            </p>
          </div>
        </FadeInSection>
