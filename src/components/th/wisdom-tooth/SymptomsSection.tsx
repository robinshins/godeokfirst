...
export default function SymptomsSection() {
  const symptoms = [
    { icon: '/icons/tooth.svg', title: 'ฟันคุดตะแคง', description: 'งอกตะแคง\nอาจกดทับฟันข้างเคียง' },
    { icon: '/icons/tooth-loosen.svg', title: 'เกิดการอักเสบ', description: 'ฟันคุดที่ปล่อยทิ้งไว้\nอาจทำให้เหงือกบวมและอักเสบ' }
  ];
        ...
        <div className="flex flex-col gap-[60px] items-start w-full">
          <div className="flex flex-col gap-4 items-center justify-center w-full">
            <div className="flex flex-col gap-3 items-center justify-center text-center w-full">
              ...
              <h2 className="font-bold text-[32px] leading-[1.35] tracking-[-0.64px] text-[#292a2f]">อาการที่อาจเกิดขึ้น<br /><span className="text-[#008095]">จากฟันคุด</span></h2>
              <p className="font-semibold text-base leading-[1.4] tracking-[-0.32px] text-[#727582]">อาจเกิดอาการต่างๆ ขึ้นอยู่กับ<br />รูปร่างและตำแหน่งของฟันคุด</p>
            </div>
          </div>
