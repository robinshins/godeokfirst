  ...
  const riskLevels = [
    {
      ...
      description: 'Even normally grown wisdom teeth are difficult to manage\nand have high cavity risk',
    ...
    },
    {
      ...
      title: 'Partially Impacted Wisdom Tooth',
      description: 'Food easily gets trapped\ncausing frequent inflammation',
    ...
    },
    {
      ...
      title: 'Fully Impacted Wisdom Tooth',
      description: 'Potential for cyst formation\nearly extraction is necessary',
    ...
    },
    {
      ...
      levelBg: 'bg-[#fef1e5]',
      levelColor: 'text-[#f57400]',
      title: 'Curved Root Wisdom Tooth',
      description: 'Roots are curved\nmaking extraction more difficult',
    ...
    {
      level: 'Immediate Treatment Required',
      levelBg: 'bg-[#ffebed]',
      levelColor: 'text-[#ff1616]',
      title: 'Horizontally Impacted Wisdom Tooth',
      description: 'Pushes against front teeth causing misalignment\nand cavities',
          ...
          <div className="flex flex-col gap-4 items-center justify-center w-full">
            <div className="flex flex-col gap-3 items-center justify-center w-full">
              <h2 className="font-bold text-[32px] leading-[1.35] tracking-[-0.64px] text-[#292a2f] text-center">
                Risk Levels by Wisdom Tooth Condition
              </h2>
            </div>
          </div>
