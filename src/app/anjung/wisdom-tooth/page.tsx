...
const articleData: RegionArticleData = {
  ...
  sections: [
    {
      ...
      content: [
        ...
        '사랑니가 비스듬하게 나거나, 잇몸 속에 묻혀 있거나(매복), 앞 어금니를 밀어서 통증이나 충치를 유발하는 경우 발치가 필요합니다. 지치주위염(사랑니 주변 잇몸 염증)도 발치의 주요 적응증입니다.',
        '안중읍에 거주하시면서 사랑니 때문에 불편을 겪고 계시다면, 정확한 진단을 통해 발치 여부를 판단하는 것이 중요합니다.',
      ],
    },
    {
    ...
    },
    {
      ...
      content: [
        ...
        '사랑니가 앞 어금니에 충치를 유발하거나, 교정 치료를 계획 중이라면 미리 발치하는 것이 좋습니다. 안중읍에 거주하는 20~30대 분들이라면 한 번쯤 사랑니 상태를 확인받아보시기를 권장합니다.',
      ],
    },
  ],
  tips: [
    '사랑니 발치 전날에는 충분히 수면을 취하고, 당일 아침에 가벼운 식사를 하고 오시면 좋습니다.',
    '발치 당일에는 가급적 자가용을 이용해주세요. 안중읍에서 약 25분 거리이므로 보호자 동반을 권장합니다.',
  ...
  conclusion:
    '안중읍에서 사랑니 발치를 고민하고 계시다면, 대학병원 외래교수 출신 이동현 원장이 직접 시술하는 고덕퍼스트치과를 방문해보세요. CT 기반 정밀 진단과 최소 침습 발치 테크닉으로 안전하고 빠른 회복을 약속드립니다.',
  faqs: [
    {
    ...
    },
    {
      ...
      answer:
        '네, 발치 후 5~7일 뒤에 경과 확인과 실밥 제거를 위해 내원이 필요합니다. 안중읍에서 오시는 점을 고려하여 일정을 효율적으로 잡아드립니다.',
    },
  ],
};

export const metadata: Metadata = {
  title: '안중 사랑니 발치 | 매복 사랑니 전문 - 고덕퍼스트치과',
  description:
    '안중 사랑니발치는 대학병원 외래교수 출신 원장이 직접 시술하는 고덕퍼스트치과에서. CT 정밀 진단, 최소 침습 발치, 매복 사랑니 전문. 안중읍에서 차로 25분.',
  keywords: [
    '안중 사랑니',
    '안중 사랑니발치',
    '안중읍 사랑니',
  ...
  alternates: {
    canonical: 'https://gdfirstdent.co.kr/anjung/wisdom-tooth',
  },
  openGraph: {
    title: '안중 사랑니 발치 | 고덕퍼스트치과',
    description: '대학병원 외래교수 출신 원장의 안전한 사랑니 발치. CT 정밀 진단, 최소 침습 테크닉.',
    url: 'https://gdfirstdent.co.kr/anjung/wisdom-tooth',
    siteName: '고덕퍼스트치과',
    type: 'article',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: '고덕퍼스트치과 - 안중 사랑니 발치',
      },
    ],
  },
};

export default function AnjungWisdomToothPage() {
  const faqJsonLd = {
  ...
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: '사랑니 발치', item: 'https://gdfirstdent.co.kr/anjung/wisdom-tooth' },
    ],
  };
