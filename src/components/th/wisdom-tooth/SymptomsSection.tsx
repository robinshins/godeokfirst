  ...
  const symptoms = [
    {
      ...
      title: 'ฟันคุดนอนตะแคง',
      description: 'งอกตะแคงและ\nอาจกดทับฟันซี่ข้างๆ ได้'
    },
    {
      icon: '/icons/tooth-loosen.svg',
      title: 'เกิดการอักเสบ',
      description: 'ฟันคุดที่ปล่อยทิ้งไว้\nอาจทำให้เหงือกบวมและอักเสบได้'
    }
  ];
          ...
          <div className="flex flex-col gap-4 items-center justify-center w-full">
            <div className="flex flex-col gap-3 items-center justify-center text-center w-full">
              ...
              <p className="font-semibold text-base leading-[1.4] tracking-[-0.32px] text-[#e9ebf1] whitespace-pre-line">
                {'ขึ้นอยู่กับรูปแบบการงอก\nหรืออุปกรณ์ อาจเกิดอาการต่างๆ ได้'}
              </p>
            </div>
          </div>
