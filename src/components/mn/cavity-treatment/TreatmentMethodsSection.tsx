...
export default function TreatmentMethodsSection() {
 ...
 нарийвчилсан цооронхой 
                      ...
                      <div className="flex items-start gap-0 w-full">
                        ...
                        <div className="flex flex-col gap-1 items-start justify-center">
                          ...
                          <p className="font-['Pretendard_JP'] font-semibold text-[15px] leading-[1.4] tracking-[-0.3px] text-[#727582] whitespace-nowrap">
 байгалийн шүд өнгө гоо сайхны вон
                          </p>
                        </div>
                      </div>
 ...
 инлей · 
                          ...
                          <p className="font-['Pretendard_JP'] font-semibold text-[15px] leading-[1.4] tracking-[-0.3px] text-[#727582] whitespace-nowrap">
 цооронхой шүд авах нарийвчилсан эмчилгээ
                          </p>
                        </div>
                      </div>
                    </div>
 ...
 шүд 
                          ...
                          <p className="font-['Pretendard_JP'] font-semibold text-[15px] leading-[1.4] tracking-[-0.3px] text-[#727582] whitespace-nowrap">
 шүд авах байгалийн шүд 
                          </p>
                        </div>
                      </div>

                      {/* нарийвчилсан мэдрэл эмчилгээ */}
                      <div className="flex items-start gap-0 w-full">
                        <div className="shrink-0 w-6 h-6">
                          <Image
                            src="/icons/check-gray.svg"
                        ...
                        <div className="flex flex-col gap-1 items-start justify-center flex-1">
                          ...
                          <p className="font-['Pretendard_JP'] font-semibold text-[15px] leading-[1.4] tracking-[-0.3px] text-[#727582] whitespace-nowrap">
 Нийлмэл шүдний мэргэжилтэн мэс засал хийх
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="flex gap-[22px] items-center w-full">
                      <div className="bg-white border border-[#e9ebf1] rounded-2xl shrink-0 w-[110px] h-[110px] overflow-hidden relative">
                        <Image
                          ...
                          alt="Trios5 амны хөндий сканнер"
                          fill
 ...
 дахин 3D 
                        ...
                        <div className="flex items-start gap-2 w-full">
                          ...
                          <p className="font-['Pretendard_JP'] font-medium text-[15px] leading-[1.5] tracking-[-0.3px] text-[#2d3643]">
 дижитал нарийвчилсан хиймэл шүд үйлдвэрлэл
                          </p>
                        </div>
                        <div className="flex items-start gap-2 w-full">
                          <div className="shrink-0 w-5 h-5 mt-0.5">
                          ...
                          <p className="font-['Pretendard_JP'] font-medium text-[15px] leading-[1.5] tracking-[-0.3px] text-[#2d3643]">
 цооронхой арилгах дараа шууд үйлдвэрлэл
                          </p>
                        </div>
                        <div className="flex items-start gap-2 w-full">
                          <div className="shrink-0 w-5 h-5 mt-0.5">
                          ...
                          <p className="font-['Pretendard_JP'] font-medium text-[15px] leading-[1.5] tracking-[-0.3px] text-[#2d3643]">
 тухтай эмчилгээ, зөрүү хамгийн бага 
                          </p>
                        </div>
                      </div>
                    </div>
 ...
 Trios5 3Shape төрөл амны хөндий сканнер, минут нарийвчилсан шүд төрөл. инлей· ·титэм эмчилгээ тухтай эмчилгээ боломжтой.
                      </p>
                    </div>
                  </div>
                </div>
