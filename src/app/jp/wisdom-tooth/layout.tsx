...
export const metadata: Metadata = {
  title: '고덕동사랑니 평택사랑니발치 | コドクファースト歯科',
  description: '고덕동사랑니 평택사랑니발치 전문. 3D CT精密診断, 대학병원급 난이도 발치 가능. 통증 완화 마취 시스템.',
  keywords: ['고덕동사랑니', '평택사랑니발치', 'コドクファースト歯科사랑니', '평택사랑니', '사랑니발치'],
  alternates: {
    canonical: 'https://gdfirstdent.co.kr/wisdom-tooth',
  },
  openGraph: {
    title: '고덕동사랑니 평택사랑니발치 | コドクファースト歯科',
    description: '고덕동사랑니 평택사랑니발치 전문. 3D CT精密診断, 대학병원급 난이도 발치 가능.',
  ...
  '@graph': [
    {
      ...
      name: '고덕동사랑니 평택사랑니발치',
      description: '고덕동사랑니 평택사랑니발치 전문. 3D CT精密診断으로 신경 손상없이 안전하게 발치. 대학병원급 난이도 발치.',
    ...
    },
    {
      ...
      mainEntity: [
        ...
        },
        {
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text: '네, 가능합니다. コドクファースト歯科는 대학병원급 난이도 발치가 가능한 시스템을 갖추고 있습니다. 수평매복, 완전매복 등 일반 치과에서 큰 병원을 권유하는 어려운 케이스도 안전하게 발치합니다.',
          },
        },
        {
          '@type': 'Question',
