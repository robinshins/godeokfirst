  ...
  const steps = [
    {
      ...
      label: 'ชั่วคราวครั้งที่ 1',
      title: 'ฟื้นตัวทันที',
      description: 'ทันทีหลังผ่าตัด, ใส่ทันที\nใช้ชีวิตประจำวันได้ทันที'
    },
    {
      icon: '/icons/crown.svg',
      label: 'ปรับการสบฟันครั้งที่ 2',
      title: 'แม่นยำ การสบฟัน ปรับแต่ง',
      description: '2 สัปดาห์หลังปรับแต่ง\nสภาพการสบฟันอย่างละเอียดค่ะ'
    },
    {
      icon: '/icons/implant-group.svg',
      label: 'ขั้นสุดท้ายครั้งที่ 3 ชั่วคราว',
      title: 'สมบูรณ์แบบ การสบฟัน ตรวจสอบ',
      description: 'ก่อนผลิตครอบฟันสุดท้าย\nตรวจสอบการสบฟันอีกครั้งอบค่ะ'
    },
    {
      icon: '/icons/tooth-shine.svg',
      label: 'สุดท้าย ครอบฟัน',
      title: 'ฟันของฉันตลอดชีวิต',
      description: 'ครอบฟันสุดท้ายที่ผ่านการปรับแต่ง\nทั้งหมดอย่างสมบูรณ์แบบ ใส่ค่ะ'
    }
  ];
