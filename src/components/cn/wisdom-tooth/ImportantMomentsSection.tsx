...
export default function ImportantMomentsSection() {
  const moments = [
    { icon: '/images/military.png', label: '服兵役', description: '在军队突然\n牙痛很难处理' },
    { icon: '/images/exam.png', label: '考试期间', description: '重要考试前一天\n突然疼痛' },
    { icon: '/images/wedding.png', label: '婚礼·面试', description: '人生重要的日子\n脸肿了...' },
    { icon: '/images/travel.png', label: '旅行·出差', description: '国外急诊室\n昂贵的治疗费' }
  ];
        ...
        <div className="flex flex-col gap-[26px] items-center justify-center w-full">
          <div className="flex flex-col gap-3 items-center justify-center w-full">
            <div className="flex flex-col gap-3 items-center justify-center text-center w-full">
              ...
              <h2 className="font-bold text-[32px] leading-[1.35] tracking-[-0.64px] text-[#292a2f]">毫无预兆地来袭<br /><span className="text-[#008095]">智齿疼痛...</span></h2>
            </div>
            <p className="font-semibold text-[14px] leading-[1.4] tracking-[-0.32px] text-[#727582] text-center w-full">在平静时提前解决，就能保护重要时刻</p>
          </div>
