  ...
  const reasons = [
    {
      ...
      title: 'Butun mamlakat tish shifokorlari uchun',
      subtitle: 'Ilmiy maʼruza'
    },
    {
    ...
    },
    {
      ...
      title: 'Choson universiteti',
      subtitle: 'Tashqi professor'
    },
    {
      image: '/images/implant-reason-seminar-4.png',
      title: '10 yil davomida',
      subtitle: 'qaytaoperatsiya 0ta'
    }
  ];
    ...
    <section className="bg-white px-4 py-16">
      <div className="flex flex-col gap-10">
        ...
        <h2 className="text-[28px] font-extrabold text-center leading-[1.4] tracking-[-0.03em]">
          Godeokda <span className="text-[#008095]">eng yuqori daraja</span><br />
          Implant qilish sababi
        </h2>
