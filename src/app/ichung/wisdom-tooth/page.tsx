...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://gdfirstdent.co.kr/ichung/wisdom-tooth',
  },
  openGraph: {
    title: '이충동 사랑니 발치 | 고덕퍼스트치과',
    description: '이충동 주민을 위한 대학병원급 사랑니 발치. 통합치의학과 전문의 직접 시술.',
    url: 'https://gdfirstdent.co.kr/ichung/wisdom-tooth',
    siteName: '고덕퍼스트치과',
    locale: 'ko_KR',
    type: 'article',
    images: [
  ...
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 3,
        name: '이충동 사랑니 발치',
        item: 'https://gdfirstdent.co.kr/ichung/wisdom-tooth',
      },
    ],
  };
