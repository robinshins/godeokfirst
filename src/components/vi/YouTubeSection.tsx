...
const LONG_FORM_VIDEOS = [
  {
    id: '9kP02X04THc',
    title: 'Quy trinh dieu tri Implant',
  },
  {
    id: 'GyzFVUfRqmk',
    title: 'Phan hoi cua benh nhan',
  },
  {
    id: '4hJI8OteG3Q',
    title: 'Giai thich dieu tri',
  },
];
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4">
            Xem video giai thich<br />ve cac phuong phap dieu tri
          </h2>
          <p className="text-gray-600 text-lg">
            Truong hop dieu tri thuc te va phan hoi cua benh nhan tu Bac si Kim Dong Seok
          </p>
        </div>
