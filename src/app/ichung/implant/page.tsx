...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://gdfirstdent.co.kr/ichung/implant',
  },
  openGraph: {
    title: '이충동 임플란트 | 고덕퍼스트치과',
    description: '이충동 주민을 위한 디지털 가이드 임플란트. 통합치의학과 전문의 직접 진료.',
    url: 'https://gdfirstdent.co.kr/ichung/implant',
    siteName: '고덕퍼스트치과',
    locale: 'ko_KR',
    type: 'article',
    images: [
  ...
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 3,
        name: '이충동 임플란트',
        item: 'https://gdfirstdent.co.kr/ichung/implant',
      },
    ],
  };
