...
export default function SymptomsSection() {
  const symptoms = [
    { icon: '/icons/tooth.svg', title: 'Răng khôn mọc ngang', description: 'Mọc nghiêng\ncó thể đè ép răng bên cạnh' },
    { icon: '/icons/tooth-loosen.svg', title: 'Viêm nhiễm', description: 'Răng khôn bị bỏ qua\ncó thể gây sưng nướu và viêm' }
  ];
        ...
        <div className="flex flex-col gap-[60px] items-start w-full">
          <div className="flex flex-col gap-4 items-center justify-center w-full">
            <div className="flex flex-col gap-3 items-center justify-center text-center w-full">
              ...
              <h2 className="font-bold text-[32px] leading-[1.35] tracking-[-0.64px] text-[#292a2f]">Triệu chứng<br /><span className="text-[#008095]">do răng khôn gây ra</span></h2>
              <p className="font-semibold text-base leading-[1.4] tracking-[-0.32px] text-[#727582]">Tùy theo hình dạng và vị trí mọc<br />có thể xuất hiện nhiều triệu chứng khác nhau</p>
            </div>
          </div>
