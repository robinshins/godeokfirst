...
export default function CaseStudiesSection() {
  const cases = [
    {
      quote: [
        '"Яс их хайлсан байсан ч',
        'буйлны эмчилгээгээр яс сэргэсэн"'
      ],
      ...
      title: 'Буйлны хүнд өвчнөөр яс их хайлсан байдал',
      result: 'Буйлны эмчилгээ болон яс шилжүүлгээр яс сэргээж имплант суулгасан'
    },
    {
      quote: [
        '"Тогтмол арчилгаа хийлгэсний ачаар',
        '50 насандаа ч бүх шүд эрүүл"'
      ],
      ...
      title: 'Шүдний чулуу болон буйлны үрэвсэл ихтэй байсан байдал',
      result: 'Тогтмол скейлинг болон арчилгаагаар эрүүл байдлыг хадгалсан'
    }
  ];
