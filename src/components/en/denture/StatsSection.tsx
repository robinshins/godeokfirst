...
export default function StatsSection() {
  const stats = [
    { number: '1,200', unit: 'cases+', label: 'Implant Placements' },
    { number: '0', unit: 'cases', label: 'Implant re-surgery', subtitle: 'Zero re-surgery since Godeok Edu Town opening' },
    { number: '6', unit: 'years+', label: 'Former University Hospital Visiting Professor' },
    { number: '4.9', unit: '/ 5.0', label: 'Patient Satisfaction', subtitle: 'Based on Kakao, Google, Naver Maps' },
  ];
          ...
          <FadeInSection className="flex flex-col gap-4 items-center justify-center relative shrink-0 w-full z-10">
            <div className="flex flex-col gap-3 items-center justify-center relative shrink-0 w-full">
              ...
              <p className="font-semibold leading-[1.4] not-italic text-[#e9ebf1] text-base text-center tracking-[-0.32px] w-full" style={{ fontFamily: '"NanumSquare", sans-serif' }}>
                ...
                The Head Doctor operates directly for lifetime results
              </p>
            </div>
          </FadeInSection>
