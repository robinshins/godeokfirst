            ...
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                ...
                <p className="text-white text-[14px] font-semibold" style={{ fontFamily: '"NanumSquare", sans-serif' }}>
                  Phòng lab chuyên nghiệp được chọn lọc qua mạng lưới bệnh viện đại học·đồng nghiệp
                </p>
              </div>
              <div className="flex items-center gap-2">
                <span className="text-[#6eb7bc]">✓</span>
                <p className="text-white text-[14px] font-semibold" style={{ fontFamily: '"NanumSquare", sans-serif' }}>
                  Đầy đủ thiết bị CAD/CAM mới nhất và nhân sự chuyên nghiệp
                </p>
              </div>
              <div className="flex items-center gap-2">
                <span className="text-[#6eb7bc]">✓</span>
                <p className="text-white text-[14px] font-semibold" style={{ fontFamily: '"NanumSquare", sans-serif' }}>
                  Giao tiếp chặt chẽ với Bác sĩ trưởng để tạo khớp cắn chính xác
                </p>
              </div>
              <div className="flex items-center gap-2">
                <span className="text-[#6eb7bc]">✓</span>
                <p className="text-white text-[14px] font-semibold" style={{ fontFamily: '"NanumSquare", sans-serif' }}>
                  Ứng phó tái chế tạo ngay khi không hài lòng chất lượng phục hình
                </p>
              </div>
            </div>
          </div>
        ...
        <FadeInSection delay={200} className="w-full z-10">
          <div className="bg-[#008095]/10 border border-[#008095]/20 rounded-xl p-5">
            ...
            <p className="text-white/90 text-[14px] leading-[1.7]" style={{ fontFamily: '"NanumSquare", sans-serif' }}>
              Giáo sư thỉnh giảng bệnh viện đại họcNhờ mạng lưới đồng nghiệp giáo sư·bác sĩ trưởng tích lũy khi hoạt động, <span className="text-[#6eb7bc] font-bold">chọn lọc phòng lab chuyên nghiệp đã được kiểm chứng</span>. Đảm bảo chất lượng phục hình cao hơn phòng lab nội bộ nhỏ.
            </p>
          </div>
        </FadeInSection>
      </div>
