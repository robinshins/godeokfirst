...
export default function WhyBestNewSection() {
 ...
 {/* Reason 1: Нийлмэл шүдний мэргэжилтэн + Их сургуулийн эмнэлэг */}
          <FadeInSection delay={100} className="group bg-white rounded-3xl p-6 shadow-sm border border-[#edf2f7] hover:border-[#008095] hover:shadow-lg hover:-translate-y-1 transition-all duration-300 overflow-hidden relative w-full">
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-[24px] font-bold text-[#3e3a3a] leading-[1.3] mb-3" style={{ fontFamily: '"NanumSquare", sans-serif' }}>
                Шүдний эмч нарыг заадаг
                <br />
                <span className="text-[#008095]">Нийлмэл шүдний мэргэжилтэн</span>
              </h3>
              <p className="text-[15px] text-[#666] leading-[1.6] mb-6" style={{ fontFamily: '"NanumSquare", sans-serif' }}>
                Чосоны их сургуулийн шүдний эмнэлэгэмнэлэг Зочин профессор байсан,<br />
 Сөүлийн их сургуулийн шүдний эмчилгээниймагистрантура Имплант төгссөн.<br />
 <span className="font-bold text-[#333]">Нийлмэл шүдний мэргэжилтэн</span>.
              </p>
 ...
 <span className="text-white text-[10px] font-medium"> · баталгаажуулалт </span>
                    </div>
                  </div>
                </div>
                <div className="relative flex-1 h-[160px] rounded-xl overflow-hidden">
                  ...
                  <div className="absolute bottom-2 left-2 z-10">
                    <div className="bg-black/60 px-2 py-1 rounded-md">
                      <span className="text-white text-[10px] font-medium">эмч ажлын туршлага</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <FadeInSection delay={200} className="group bg-white rounded-3xl p-6 shadow-sm border border-[#edf2f7] hover:border-[#008095] hover:shadow-lg hover:-translate-y-1 transition-all duration-300 overflow-hidden relative w-full">
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-[24px] font-bold text-[#3e3a3a] leading-[1.3] mb-3" style={{ fontFamily: '"NanumSquare", sans-serif' }}>
                1,200удаа+ Имплант
                <br />
                <span className="text-[#008095]">дахинмэс засал 0тохиолдол</span>
              </h3>
              <p className="text-[15px] text-[#666] leading-[1.6] mb-6" style={{ fontFamily: '"NanumSquare", sans-serif' }}>
 вон <br />
 Имплант дахинмэс засал тохиолдол тохиолдол.<br />
 <span className="font-bold text-[#333]"> ур чадвар</span>.
              </p>

              <div className="relative w-full aspect-[4/3] rounded-xl overflow-hidden mb-4">
                <Image
                  src="/images/goduk_images/수술하는모습.jpeg"
                  alt="Имплант мэс засал "
                  fill
                  className="object-cover"
                  sizes="400px"
                />
              ...
              <div className="bg-[#f8fbfd] rounded-xl p-4 border border-[#eef4f8] space-y-3">
                {[
                  { label: 'Имплант суулгалт', value: '1,200удаа+' },
 { label:'вон дахинмэс засал', value:'0тохиолдол'},
 { label:'өвчтөн', value:'4.9 / 5.0'},
                ].map((item, i) => (
          ...
          {/* Reason 3: дижитал нарийвчилсан мэс засал */}
 ...
 3D дижитал 
                <br />
 <span className="text-[#008095]">нарийвчилсан мэс засал</span>
              </h3>
              <p className="text-[15px] text-[#666] leading-[1.6] mb-6" style={{ fontFamily: '"NanumSquare", sans-serif' }}>
 3D CT минут дижитал навигаци <br />
 байршил суулгалт.<br />
 <span className="font-bold text-[#333]">хамгийн бага зүслэг, хамгийн бага </span> удаа.
              </p>

              <div className="relative w-full aspect-[4/3] rounded-xl overflow-hidden mb-4">
                <Image
                  src="/images/goduk_images/3d.webp"
 alt="3D дижитал Имплант мэс засал"
                  fill
                  className="object-cover"
                  sizes="400px"
                />
              ...
              <div className="grid grid-cols-1 gap-3">
                {[
 { title:'3D CT нарийвчилсан минут', desc:'· 3D'},
 { title:'дижитал мэс засал', desc:'зураг төсөл суулгалт'},
 { title:'', desc:'сканнер, дижитал систем'},
                ].map((item, i) => (
 ...
 <span className="text-[#008095]"> </span>
              ...
              <p className="text-[15px] text-[#666] leading-[1.6] mb-6" style={{ fontFamily: '"NanumSquare", sans-serif' }}>
 Ерөнхий эмч мэс засал, хадгалахарчилгаа <br />
. <br />
 <span className="font-bold text-[#333]">анх удаа эмч</span>.
              </p>

              <div className="bg-[#f8fbfd] rounded-xl p-5 border border-[#eef4f8] space-y-4">
                {[
 { icon:'🔍', title:'тогтмол үзлэг', desc:'6сар шалгалт'},
 { icon:'🦷', title:'мэргэжилтэн', desc:'Имплант орчим үрэвсэл цэвэрлэгээ'},
 { icon:'📋', title:'арчилгаа', desc:'өвчтөн төрөл хадгалахарчилгаа'},
                ].map((item, i) => (
