  ...
  const steps = [
    {
      ...
      description: 'Precise diagnosis using\na 3D oral scanning system'
    },
    {
      number: 2,
      image: '/images/goduk_images/digital-guide-2.png',
      description: 'Planning flapless implant placement based on the oral structure modeled on computer'
    },
    {
      number: 3,
      image: '/images/goduk_images/digital-guide-3.png',
      description: 'Placement guide device attached to the surgical site to minimize error to within 1mm'
    },
    {
      number: 4,
      image: '/images/goduk_images/4.png',
      description: 'Flapless surgery reduces procedure time, pain, and swelling compared to other methods'
    },
    {
      number: 5,
      image: '/images/goduk_images/digital-guide-5.png',
      description: 'Simulated surgery based on conditions minimizes error and increases patient satisfaction'
    }
  ];
      ...
      <div className="box-border flex flex-col gap-10 items-start px-4 py-[60px] relative w-full max-w-[430px]">
        ...
        <div className="flex flex-col gap-4 items-center justify-center relative shrink-0 w-full">
          <div className="flex flex-col gap-3 items-center justify-center leading-[0] not-italic relative shrink-0 text-center w-full">
            ...
            Godeok First Dental always<br />operates twice
            </h2>
            <div className="font-semibold leading-[1.4] text-[#727582] text-base tracking-[-0.32px] w-full" style={{ fontFamily: 'Pretendard, sans-serif' }}>
              The Head Doctor personally designs<br />
              the optimal placement through virtual implant surgery,<br />
              then performs the actual surgery<br />
              <br />
              <span className="font-bold text-[#008095]">Fast and comfortable surgery</span> that<br />
              minimizes swelling and pain,<br />
              and also minimizes bone grafting
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col gap-4 w-full">
            {caseStudies.map((image, index) => (
              <div key={index} className="relative w-full aspect-[343/200] rounded-2xl overflow-hidden shadow-lg">
                <Image
                  src={image}
                  alt={`Full-Arch Implant case ${index + 1}`}
                  fill
