        ...
        <div className="flex flex-col gap-[60px] items-start w-full">
          ...
          <div className="flex flex-col gap-4 items-center justify-center w-full">
            <div className="flex flex-col gap-3 items-center justify-center text-center w-full">
              <h2 className="font-['Pretendard'] font-bold text-[32px] leading-[1.35] tracking-[-0.64px] text-white w-full">
                We saved teeth of patients<br />
                recommended for extraction
              </h2>
              <p className="font-['Pretendard'] font-semibold text-base leading-[1.4] tracking-[-0.32px] text-[#e9ebf1] w-full">
                Extraction was recommended elsewhere<br />
                but preservation was successful through root canal
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-6 items-start w-full">
            {/* Case 1: Periapical Lesion Healing */}
            <div className="bg-white border border-[#f3f6fb] rounded-[24px] w-full overflow-hidden">
              <div className="flex flex-col gap-4 items-center justify-center px-4 py-6 w-full">
                  ...
                  <div className="relative w-full">
                    <div className="h-[192px] w-full rounded-[20px] overflow-hidden relative bg-[#f3f6fb]">
                      <Image
                        ...
                        alt="1 year 2 months after treatment"
                        fill
                        className="object-contain"
                      />
                    </div>
                ...
                <p className="font-semibold text-[15px] leading-[1.4] tracking-[-0.3px] text-[#5d5f6d] text-center">
                  Complete healing of periapical lesion 1 year 2 months after root canal
                </p>
              </div>
            </div>

            {/* Case 2: Severe Inflammation */}
            <div className="bg-white border border-[#f3f6fb] rounded-[24px] w-full overflow-hidden">
              <div className="flex flex-col gap-4 items-center justify-center px-4 py-6 w-full">
                <div className="flex flex-col gap-3 items-center justify-center w-full">
                  <div className="bg-[#fff9ec] px-3 py-1.5 rounded-lg">
                  ...
                  <p className="font-bold text-[20px] leading-[1.35] tracking-[-0.4px] text-black text-center w-full">
                    Molar with severe inflammation and pus
                  </p>
                </div>
                ...
                <p className="font-semibold text-[15px] leading-[1.4] tracking-[-0.3px] text-[#5d5f6d] text-center">
                  Complete healing of periapical lesion 6 months after treatment
                </p>
              </div>
            </div>

            {/* Case 3: Re-treatment - Additional Canal Found */}
            <div className="bg-white border border-[#f3f6fb] rounded-[24px] w-full overflow-hidden">
              <div className="flex flex-col gap-4 items-center justify-center px-4 py-6 w-full">
                <div className="flex flex-col gap-3 items-center justify-center w-full">
                  ...
                  <p className="font-bold text-[20px] leading-[1.35] tracking-[-0.4px] text-black text-center w-full">
                    Molar recurrence after treatment elsewhere
                  </p>
                </div>
                  ...
                  <div className="relative w-full">
                    <div className="h-[192px] w-full rounded-[20px] overflow-hidden relative bg-[#f3f6fb]">
                      <Image
                        ...
                        alt="1 year 9 months after treatment"
                        fill
                        className="object-contain"
                      />
                    </div>
                ...
                <p className="font-semibold text-[15px] leading-[1.4] tracking-[-0.3px] text-[#5d5f6d] text-center">
                  Complete healing 1 year 9 months after finding additional canal through re-treatment
                </p>
              </div>
            </div>
            ...
            <div className="bg-white border border-[#f3f6fb] rounded-[24px] w-full overflow-hidden">
              <div className="flex flex-col gap-4 items-center justify-center px-4 py-6 w-full">
                <div className="flex flex-col gap-3 items-center justify-center w-full">
                  ...
                  <p className="font-bold text-[20px] leading-[1.35] tracking-[-0.4px] text-black text-center w-full">
                    Front tooth with inflammation spreading to root tip
                  </p>
                </div>
                ...
                <p className="font-semibold text-[15px] leading-[1.4] tracking-[-0.3px] text-[#5d5f6d] text-center">
                  Complete healing of lesion after root canal re-treatment and apicoectomy
                </p>
              </div>
            </div>
          </div>
