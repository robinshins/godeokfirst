...
export default function StatsSection() {
  const stats = [
 { number:'1,200', unit:'удаа+', label:'Имплант суулгалт'},
 { number:'0', unit:'тохиолдол', label:'Имплант дахинмэс засал', subtitle:'вон дахинмэс засал 0тохиолдол'},
    { number: '6', unit: 'жил+', label: 'Их сургуулийн эмнэлэг Зочин профессор байсан' },
 { number:'4.9', unit:'/ 5.0', label:'өвчтөн', subtitle:',,'},
  ];
