...
export default function SpecialTechSection() {
  const features = [
    'スウェーデンのカロリンスカ医科大学が開発した技術',
    '歯と歯茎に直接付着するプロバイオティクス',
    '歯磨き粉やマウスウォッシュでも生存する強力な菌株',
    '砂糖や虫歯酸を生成しない安全な菌株'
  ];
        ...
        <div className="flex flex-col gap-10 items-start relative shrink-0 w-full">
          <div className="flex flex-col gap-6 items-start relative shrink-0 w-full">
                ...
                {features.map((feature, index) => (
                  <div key={index} className="flex items-center relative shrink-0 w-full">
                    ...
                    <div className="flex-1 flex flex-col gap-1 items-start justify-center">
                      <p className="font-bold leading-[1.5] not-italic text-[17px] text-black tracking-[-0.34px] w-full" style={{ fontFamily: 'Pretendard_JP, sans-serif' }}>
                        {feature}
                      </p>
                    </div>
                  </div>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 box-border flex flex-col gap-4 items-start justify-center p-6 relative rounded-[24px] shrink-0 w-full border border-blue-200">
              <h3 className="font-bold leading-[1.35] not-italic text-xl text-black tracking-[-0.4px] w-full" style={{ fontFamily: 'Pretendard_JP, sans-serif' }}>
                生涯口腔ケア
              </h3>
              ...
              <div className="flex flex-col gap-3 items-start w-full">
                <p className="font-bold leading-[1.4] not-italic text-lg text-black tracking-[-0.36px]" style={{ fontFamily: 'Pretendard_JP, sans-serif' }}>
                  口腔細菌セラピー
                </p>
                <p className="font-medium leading-[1.5] not-italic text-[15px] text-[#5d5f6d] tracking-[-0.3px]" style={{ fontFamily: 'Pretendard_JP, sans-serif' }}>
                  スウェーデンのカロリンスカ医科大学が開発したプロバイオティクスでインプラントを長期間健康に維持
                </p>
              </div>
            </div>
            ...
            <div className="bg-[#006aff] box-border flex flex-col gap-6 items-start justify-center p-6 relative rounded-[24px] shrink-0 w-full">
              ...
              <div className="flex flex-col gap-6 items-start relative shrink-0 w-full">
                <div className="flex flex-col gap-2 items-start leading-[1.35] not-italic relative shrink-0 text-center text-white w-full" style={{ fontFamily: 'Pretendard_JP, sans-serif' }}>
                ...
                <div className="bg-[rgba(255,255,255,0.2)] box-border flex flex-col gap-6 items-start p-6 relative rounded-[20px] shrink-0 w-full">
                  <p className="font-bold leading-[1.5] not-italic text-[17px] text-center text-white tracking-[-0.34px] w-full" style={{ fontFamily: 'Pretendard_JP, sans-serif' }}>
                    全体インプラントレビューイベント参加時！
                  </p>
                  ...
                  <div className="font-bold leading-[1.5] not-italic text-lg text-center text-white tracking-[-0.36px] w-full" style={{ fontFamily: 'Pretendard_JP, sans-serif' }}>
                    インプラント周囲の食べ物除去と<br />
                    歯茎マッサージに効果的！<br />
                    口腔ケアに欠かせない<br />
                    ウォーターピックをプレゼント
