...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://gdfirstdent.co.kr/seojeong/wisdom-tooth' },
  openGraph: {
    title: '서정동 사랑니 발치 | 고덕퍼스트치과',
    description: '서정동 주민을 위한 대학병원급 사랑니 발치. 통합치의학과 전문의 직접 시술.',
    url: 'https://gdfirstdent.co.kr/seojeong/wisdom-tooth',
    siteName: '고덕퍼스트치과',
    locale: 'ko_KR',
    type: 'article',
    images: [
...
export default function SeojeongWisdomToothPage() {
  ...
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: '서정동 사랑니 발치', item: 'https://gdfirstdent.co.kr/seojeong/wisdom-tooth' },
    ],
  };
