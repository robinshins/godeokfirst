...
export default function SymptomsSection() {
  const symptoms = [
    { icon: '/icons/tooth.svg', title: 'Лежачий зуб мудрости', description: 'Растёт набок и может\nдавить на соседние зубы' },
    { icon: '/icons/tooth-loosen.svg', title: 'Воспаление', description: 'Запущенный зуб мудрости может\nвызвать отёк дёсен и воспаление' }
  ];
        ...
        <div className="flex flex-col gap-[60px] items-start w-full">
          <div className="flex flex-col gap-4 items-center justify-center w-full">
            <div className="flex flex-col gap-3 items-center justify-center text-center w-full">
              ...
              <h2 className="font-bold text-[32px] leading-[1.35] tracking-[-0.64px] text-[#292a2f]">Симптомы, которые<br /><span className="text-[#008095]">вызывает зуб мудрости</span></h2>
              <p className="font-semibold text-base leading-[1.4] tracking-[-0.32px] text-[#727582]">В зависимости от формы и положения<br />зуба мудрости могут проявляться разные симптомы</p>
            </div>
          </div>
