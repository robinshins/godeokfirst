...
const treatments = [
  {
    id: 'denture',
    num: '01',
    tag: 'здоровстраховое покрытие',
    tagColor: 'bg-emerald-50 text-emerald-600 border-emerald-100',
 title:'до протез',
 subtitle:'самый линия',
    stats: [
      { label: 'стоимость нагрузка', value: 1, icon: Wallet },
      { label: 'комфорт', value: 2, icon: Shield },
      { label: 'жевательная сила', value: 2, icon: TrendingUp },
      { label: 'лечение скорость', value: 5, icon: Clock },
    ],
    color: '#10b981',
    pros: [
'здоровстраховое покрытие самый один стоимость',
'65лет и более собственныйнагрузка',
'процедура период стоимость',
    ],
    cons: [
'должен',
'материал',
      'натуральныйзуб жевательная сила 20~30% уровень',
    ],
 desc:'здоровстраховка применение стоимость нагрузка самый. только должен и жевательная сила натуральныйзуб 20~30% уровень еда ограничение может.',
  },
  {
    id: 'implant-denture',
    num: '02',
    tag: '65лет и более страховка',
    tagColor: 'bg-blue-50 text-blue-600 border-blue-100',
    title: 'Имплант протез',
    subtitle: 'Имплант 2 + страховка протез',
    stats: [
      { label: 'стоимость нагрузка', value: 2, icon: Wallet },
      { label: 'комфорт', value: 3, icon: Shield },
      { label: 'жевательная сила', value: 3, icon: TrendingUp },
      { label: 'лечение скорость', value: 4, icon: Clock },
    ],
    color: '#3b82f6',
    pros: [
      '65лет и более Имплант 2 до страховое покрытие',
'обычный протез снижение',
'Имплант установка область жевательная сила',
    ],
    cons: [
'до необходимый',
'мясо, и и т.д. до',
      '2 начальный и Имплант страховка применение',
    ],
 desc:'Имплант 2 установка протез и годрезультат. 65лет и более Имплант 2 до здоровстраховка применение. обычный протез примерно высокий только еда ограничение до.',
  },
  {
    id: 'overdenture',
    num: '03',
 ...
 title:'',
 subtitle:'Имплант 2~4 + протез',
    stats: [
      { label: 'стоимость нагрузка', value: 3, icon: Wallet },
      { label: 'комфорт', value: 4, icon: Shield },
      { label: 'жевательная сила', value: 4, icon: TrendingUp },
      { label: 'лечение скорость', value: 3, icon: Clock },
    ],
    color: '#8b5cf6',
    pros: [
'протез примерно снижение',
'жевательная сила обычный протез определенно',
'один еда тоже нет возможно',
    ],
    cons: [
'здоровстраховка нестраховой',
'Имплант стоимость нагрузка увеличение',
'обычный протез лечение период',
    ],
 desc:'Имплант 2~4 установка протез годрезультат. здоровстраховка нестраховой, полный лечениестоимость лично нагрузкадолжен. Имплант протез Имплант много примерно и жевательная сила.',
  },
  {
    id: 'full-implant',
    num: '04',
 tag:'',
    ...
    title: 'полный Имплант',
 subtitle:'один 8~12 установка',
    stats: [
      { label: 'стоимость нагрузка', value: 5, icon: Wallet },
      { label: 'комфорт', value: 5, icon: Shield },
      { label: 'жевательная сила', value: 5, icon: TrendingUp },
      { label: 'лечение скорость', value: 2, icon: Clock },
    ],
    color: '#f59e0b',
    pros: [
      'натуральныйзуб жевательная сила 80~90% восстановление',
'самый натуральный комфортный',
'период',
    ],
    cons: [
'стоимость самый высокий операция нагрузка',
'кость состояние хороший и костная пластика возможно высокий',
'лечение период самый долго',
    ],
 desc:'один 8~12 Имплант установка полный зуб. лечение хорошо если жизнь бесплатный ограничение нет внутри зуб комфортный может.',
  },
  {
    id: 'all-on-x',
    num: '05',
 tag:'лечение',
    ...
    stats: [
      { label: 'стоимость нагрузка', value: 4, icon: Wallet },
      { label: 'комфорт', value: 5, icon: Shield },
      { label: 'жевательная сила', value: 5, icon: TrendingUp },
      { label: 'лечение скорость', value: 4, icon: Clock },
    ],
    color: '#008095',
    pros: [
'полный Имплант стоимость стоимость эффект и',
      'кость состояние плохой минут тоже костная пластика минимальный возможно',
'лечение период (3~6месяцев)',
    ],
    cons: [
'обычный протез высокий стоимость нагрузка',
'тоже операция опытный медперсонал',
    ],
 desc:'один 4~6 Имплант полный зуб завершение. кость хороший только установка потому что костная пластика минимальный и период тоже полный Имплант может.',
  },
];
...
export default function TreatmentOptionsSection() {
 ...
 стоимость, период, комфорт до <br />
 самый лечение метод предоставляем.
          </p>
        </FadeInSection>
 ...
 подходящий лечениеметод,<br />
 <span className="text-[#008095]">Главный врач лично материал лет </span>
                </h4>
                <p className="text-[14px] text-slate-400 leading-[1.6]" style={{ fontFamily: '"NanumSquare", sans-serif' }}>
 кость состояние и подходящий бесплатныйслучаев стоимость лечение,<br />
 внутри может самый примерно один метод.
                </p>
              </div>
              ...
              >
                <div className="bg-[#008095] hover:bg-[#009bb3] active:scale-[0.98] transition-all duration-300 rounded-2xl py-4 px-6 flex items-center justify-center gap-2 shadow-[0_10px_20px_-5px_rgba(0,128,149,0.3)]">
                  <span className="font-bold text-white text-[16px]" style={{ fontFamily: '"NanumSquare", sans-serif' }}>
                    1:1 индивидуально консультация запись
                  </span>
