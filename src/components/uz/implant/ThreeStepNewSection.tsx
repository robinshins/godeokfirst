  ...
  const steps = [
    {
      ...
      label: '1-bosqich vaqtinchalik',
      title: 'Darhol tiklanish',
      description: 'Operatsiyadan soʼng darhol oʼrnatiladi\nva kundalik hayotga qaytish mumkin'
    },
    {
      icon: '/icons/crown.svg',
      label: '2-bosqich tishlov barqarorligi',
      title: 'Aniq tishlov sozlash',
      description: '2 haftadan soʼng shaxsiy moslashtirilgan\ntishlov holatini nozik sozlash'
    },
    {
      icon: '/icons/implant-group.svg',
      label: '3-bosqich yakuniy vaqtinchalik',
    ...
    },
    {
      ...
      title: 'Umrbod oʼz tishim',
      description: 'Barcha sozlashlar tugallangan mukammal shaxsiylashtirilgan\nyakuniy protez oʼrnatiladi'
    }
  ];
      ...
      <div className="flex flex-col gap-4 items-center justify-center relative shrink-0 w-full z-10">
        ...
        <div className="flex flex-col gap-3 items-center justify-center leading-[0] not-italic relative shrink-0 text-center w-full">
          ...
          <p className="font-semibold leading-[1.4] text-[#727582] text-base tracking-[-0.32px] w-full" style={{ fontFamily: 'Pretendard, sans-serif' }}>
            Bir martalik vaqtinchalik tish bilan tugamasdan<br />
            3 bosqichli aniq sozlash orqali<br />
            oʼz tishingiz kabi qulaylikni yaratamiz
          </p>
        </div>
      </div>
