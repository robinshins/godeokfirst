...
const columnData: Record<string, Column[]> = {
  implant: [
    {
      title: 'Koʼp sonli implant tiklanish tamoyillari',
      url: 'https://blog.naver.com/gdfst111/224181674200',
      description: 'Bir nechta implant oʼrnatishda albatta rioya qilinishi kerak boʼlgan tamoyillar va eʼtiborli jihatlarni bosh shifokor shaxsan tushuntiradi.',
    },
    {
      title: 'Implant yashash muddati haqida',
      url: 'https://blog.naver.com/gdfst111/224184908972',
      description: 'Implant yashash muddatiga taʼsir qiluvchi omillar va uzoq muddatli muvaffaqiyatli implant uchun asosiy shartlarni oʼz ichiga oladi.',
    },
    {
      title: 'Implant tishlov, nima uchun muhim?',
      url: 'https://blog.naver.com/gdfst111/224184928593',
      description: 'Implant davolashda tishlov (chaynash kuchi muvozanati) nima uchun muhimligi, notoʼgʼri tishlov qanday muammolarga olib kelishini tushuntiradi.',
    },
  ],
  home: [],
};
      ...
      <div className="px-4 py-[60px] w-full max-w-[430px]">
        ...
        <div className="flex flex-col gap-2 mb-8">
          ...
          <h2 className="text-[26px] font-bold text-[#21314E] leading-[1.35] tracking-[-0.52px]">
            Bosh shifokor shaxsan yozgan<br />
            tibbiy maqolalar
          </h2>
        </div>
        ...
        <div className="mt-6 text-center">
          ...
          >
            Godeok First Dental blogini toʼliq koʼrish →
          </Link>
        </div>
      </div>
    </div>
