      ...
      <div className="flex flex-col gap-8 items-center">
        ...
        <div className="flex flex-col gap-4">
          <p className="text-base text-[#475569] text-center leading-[1.6] tracking-[-0.01em]">
            Before implant surgery, we conduct <span className="font-bold text-[#0b1727]">periodontal bacteria testing</span><br />
            to identify and treat inflammation-causing bacteria in advance.
          </p>
          <p className="text-sm text-[#64748b] text-center leading-[1.5] tracking-[-0.01em]">
            By minimizing inflammation risk,<br />
