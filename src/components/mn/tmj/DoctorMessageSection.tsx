          ...
          <div className="bg-[#f8f9fb] rounded-[24px] p-6 flex flex-col gap-5">
            <div className="flex flex-col gap-4">
              <p
                ...
                style={{ fontFamily: 'Pretendard, sans-serif' }}
              >
 &ldquo; &rdquo; минут олон.<br /><br />
 Гэхдээ эрүүний үе эмгэг <span className="text-[#008095] font-bold">эхний эмчилгээ Гэхдээ, </span> эмчилгээ.
              </p>
              <p
                className="font-semibold text-[16px] leading-[1.75] tracking-[-0.02em] text-[#2d3340]"
                style={{ fontFamily: 'Pretendard, sans-serif' }}
              >
 эрүүний үе өвдөлт,, гэх мэт ерөнхий. <span className="text-[#008095] font-bold"> эмчилгээ </span>.
              </p>
            </div>
          ...
          <div className="flex flex-col gap-3">
            {[
 { num:'70%', desc:'эрүүний үе эмгэг'},
 { num:'3дахин', desc:'— эмчилгээ'},
 { num:'85%', desc:'эмчилгээ(мэс засал)'},
            ].map((item, i) => (
              <div
                key={i}
