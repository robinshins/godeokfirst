...
export default function WhyBestSection() {
 ...
 Имплант до 1и т.д. 
        ...
        <div className="flex flex-col gap-4">
          {/* Reason 1: специалист, у которого учатся другие стоматологи */}
              ...
              <div className="flex gap-3" style={{ width: 'max-content' }}>
                ...
                <div className="w-[243px] flex-shrink-0 flex flex-col gap-[6px]">
                  <Image
                    ...
                    alt="Имплант мастер-класс"
                    width={243}
                    height={280}
                    className="rounded-[9px]"
                  />
                  <p className="text-[13px] font-bold leading-[1.5] tracking-[-0.02em] text-[#727582]">
                    Имплант мастер-класс
                  </p>
                </div>
                <div className="w-[243px] flex-shrink-0 flex flex-col gap-[6px]">
                  <Image
                    src="/images/implant-reason-seminar-4.png"
                    alt="Курс специалиста по цифровой имплантации"
                    width={243}
                    height={280}
                    className="rounded-[9px]"
                  />
                  <p className="text-[13px] font-bold leading-[1.5] tracking-[-0.02em] text-[#727582]">
                    Курс специалиста по цифровой имплантации
                  </p>
                </div>
              </div>
            </div>
          ...
          {/* Reason 2: 3этап временный зуб протокол */}
          <div className="bg-white rounded-[24px] border border-[#f3f6fb] overflow-hidden">
            <div className="px-4 py-6">
              <div className="flex flex-col gap-[14px] items-center mb-4">
                <p className="text-[32px] font-bold leading-[1.35] tracking-[-0.02em] text-[#008095]">2</p>
                <h3 className="text-2xl font-bold leading-[1.35] tracking-[-0.02em] text-black text-center">
                  3этап временный зуб<br />
                  протокол
                </h3>
              </div>
              <p className="text-base font-semibold leading-[1.4] tracking-[-0.02em] text-[#727582] text-center">
                В других клиниках: 1 этап — временный зуб и разница другой<br />
                3 этап — система точной корректировки для идеального результата
              </p>
            </div>
            ...
            <div className="px-6 py-6 relative min-h-[280px]">
              ...
              <div className="absolute left-6 top-[17px] flex flex-col gap-[10px] w-[133px]">
                ...
                <div className="flex flex-col">
                  <div className="py-3 border-b border-[#e9ebf1]">
                    <p className="text-[15px] font-bold leading-[1.4] tracking-[-0.02em] text-[#5d5f6d]">1этап завершение</p>
                  </div>
                  <div className="py-3 border-b border-[#e9ebf1]">
                    <p className="text-[15px] font-bold leading-[1.4] tracking-[-0.02em] text-[#5d5f6d]">2этап процесс нет</p>
                  </div>
                  <div className="py-3 border-b border-[#e9ebf1]">
                    <p className="text-[15px] font-bold leading-[1.4] tracking-[-0.02em] text-[#5d5f6d]">3этап процесс нет</p>
                  </div>
                  <div className="py-3">
                    <p className="text-[15px] font-bold leading-[1.4] tracking-[-0.02em] text-[#5d5f6d]">4этап процесс нет</p>
                  </div>
                </div>
              </div>
              ...
              <div className="absolute right-6 top-[1px] bg-white border-2 border-[#008095] rounded-[11px] px-[15px] py-[13px] flex flex-col gap-[10px] w-[182px]">
                ...
                <div className="flex flex-col">
                  <div className="py-3 border-b border-[#e9ebf1]">
                    <p className="text-[15px] font-bold leading-[1.4] tracking-[-0.02em] text-[#5d5f6d]">1этап : Мгновенное восстановление</p>
                  </div>
                  <div className="py-3 border-b border-[#e9ebf1]">
                    <p className="text-[15px] font-bold leading-[1.4] tracking-[-0.02em] text-[#5d5f6d]">2этап : Точная настройка прикуса</p>
                  </div>
                  <div className="py-3 border-b border-[#e9ebf1]">
                    <p className="text-[15px] font-bold leading-[1.4] tracking-[-0.02em] text-[#5d5f6d]">3этап : Проверка идеального прикуса</p>
                  </div>
                  <div className="py-3">
                    <p className="text-[15px] font-bold leading-[1.4] tracking-[-0.02em] text-[#5d5f6d]">4этап : идеальный финальный протез</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          {/* Reason 3: Операция, завершающаяся в течение 24 часов */}
          <div className="bg-white rounded-[24px] border border-[#f3f6fb] overflow-hidden">
            <div className="px-4 py-6">
              <div className="flex flex-col gap-[14px] items-center mb-4">
                <p className="text-[32px] font-bold leading-[1.35] tracking-[-0.02em] text-[#008095]">3</p>
                <h3 className="text-2xl font-bold leading-[1.35] tracking-[-0.02em] text-black text-center">
                  Операция, завершающаяся в течение 24 часов
                </h3>
              </div>
              <p className="text-base font-semibold leading-[1.4] tracking-[-0.02em] text-[#727582] text-center">
                внутренняя зуботехническая лаборатория быстрый изготовление  потому что<br />
                ни одного дня без зубов
              </p>
            </div>
            ...
            <div className="px-6 py-6 flex flex-col gap-[26px]">
              <div className="flex gap-5 items-center">
                ...
                <div className="flex flex-col gap-[5px]">
                  ...
                  <p className="text-lg font-bold leading-[1.5] tracking-[-0.02em] text-[#008095]">утро операция</p>
                  <p className="text-[15px] font-semibold leading-[1.4] tracking-[-0.02em] text-[#727582]">
 <span className="text-[#0b1727]">С помощью 3D цифрового анализа</span> примерно <br />
                    быстрый Имплантустановка
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-5 items-center">
                <div className="w-[70px] h-[70px] bg-[#fff9ec] rounded-full flex items-center justify-center flex-shrink-0">
                  <Image
                    ...
                    alt="временный зуб изготовление"
                    width={70}
                    height={70}
                  />
                </div>
                <div className="flex flex-col gap-[5px]">
                  ...
                  <p className="text-lg font-bold leading-[1.5] tracking-[-0.02em] text-[#008095]">временный зуб изготовление</p>
                  <p className="text-[15px] font-semibold leading-[1.4] tracking-[-0.02em] text-[#0b1727]">
                    Немедленное индивидуальное изготовление
                  </p>
                  <p className="text-[13px] font-semibold leading-[1.4] tracking-[-0.02em] text-[#008095]">
                    внутренняя зуботехническая лаборатория немедленно изготовление  Завершение в течение 24 часов
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-5 items-center">
                ...
                <div className="flex flex-col gap-[5px]">
                  ...
                  <p className="text-lg font-bold leading-[1.5] tracking-[-0.02em] text-[#008095]">вечер прием пищи</p>
                  <p className="text-[15px] font-semibold leading-[1.4] tracking-[-0.02em] text-[#727582]">
                    Наслаждайтесь комфортом новых зубов<br />
                    вечер время
                  </p>
                </div>
              </div>
          ...
          <div className="bg-white rounded-[24px] border border-[#f3f6fb] overflow-hidden">
            <div className="px-4 py-6">
              ...
              <p className="text-base font-semibold leading-[1.4] tracking-[-0.02em] text-[#727582] text-center">
                операция сразу после от финальный протез установкадо,<br />
                ни одного дня без зубов
              </p>
            </div>
