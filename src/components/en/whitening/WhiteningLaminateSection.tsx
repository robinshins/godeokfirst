        ...
        <div className="flex flex-col gap-10 w-full">
          ...
          <div className="flex flex-col gap-3 items-center justify-center w-full text-center">
            ...
            <h2 className="font-bold text-[32px] leading-[1.35] tracking-[-0.64px] text-black w-full" style={{ fontFamily: 'Pretendard, sans-serif' }}>
              ...
              <span className="text-[#008095]">No-prep · Minimal-prep Laminate</span>
            </h2>
            <p className="font-semibold text-base leading-[1.4] tracking-[-0.32px] text-[#727582]" style={{ fontFamily: 'Pretendard, sans-serif' }}>
              Creating a natural smile<br />
              with digital precision fabrication
            </p>
          </div>
          ...
          <div className="bg-white rounded-[24px] shadow-[0px_24px_50px_-12px_rgba(45,54,67,0.12)] p-6 flex flex-col gap-5 w-full">
            ...
            <div className="bg-[#f3f6fb] rounded-[16px] p-5 flex flex-col gap-[14px] w-full">
              ...
              <p className="font-semibold text-[15px] leading-[1.6] tracking-[-0.3px] text-[#727582]" style={{ fontFamily: 'Pretendard, sans-serif' }}>
                A procedure that bonds thin ceramic (porcelain) pieces, 0.3~0.7mm thick, to the front surface of your teeth.
                Think of it like applying a &apos;permanent whitening coating&apos; to your teeth, similar to nail art on fingernails.
              </p>
            </div>
            ...
            <div className="bg-[#008095] rounded-[16px] p-5 flex flex-col gap-[14px] w-full">
              {[
                { title: 'No tooth reduction', desc: 'No-prep or minimal-prep (0.3mm) preserves natural teeth' },
                { title: 'Natural color', desc: 'VITA MARK II ceramic — closest strength and translucency to natural teeth' },
                { title: 'Precision custom fabrication', desc: 'Error-free fit based on digital scan data' },
              ].map((item, i) => (
          ...
          <div className="bg-white rounded-[24px] border-2 border-[#008095] p-6 flex flex-col gap-5 w-full">
            <h3 className="font-bold text-[20px] leading-[1.4] tracking-[-0.4px] text-[#008095] text-center" style={{ fontFamily: 'Pretendard, sans-serif' }}>
              Godeok First Dental&apos;s Expertise
            </h3>
            ...
            <div className="bg-[#008095] rounded-[16px] p-5 flex flex-col gap-3">
              ...
              <div className="bg-white/10 rounded-[10px] p-3 flex flex-col gap-1.5">
                {[
                  'Aesthetic results confirmed via digital simulation before proceeding',
                  'Natural smile design matching your face shape and skin tone',
                  'Post-treatment discomfort minimized, immediate adjustments possible',
                ].map((t, i) => (
            ...
            <div className="flex flex-col gap-3">
              {[
                { title: 'Digital 3D Scan', desc: 'Precise data acquisition without uncomfortable impressions' },
                { title: 'VITA MARK II Ceramic', desc: 'Closest strength and color to natural teeth' },
                { title: 'Minimal/No-prep procedure', desc: 'Minimizing tooth damage to preserve natural teeth' },
              ].map((item, i) => (
