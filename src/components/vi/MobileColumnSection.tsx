...
const columnData: Record<string, Column[]> = {
  implant: [
    {
      title: 'Nguyên tắc phục hồi nhiều Implant',
      url: 'https://blog.naver.com/gdfst111/224181674200',
      description: 'Bác sĩ trực tiếp giải thích các nguyên tắc và lưu ý cần tuân thủ khi cấy nhiều Implant.',
    },
    {
      title: 'Câu chuyện về tỷ lệ sống sót của Implant',
      url: 'https://blog.naver.com/gdfst111/224184908972',
      description: 'Các yếu tố ảnh hưởng đến tỷ lệ sống sót của Implant và điều kiện cốt lõi để Implant thành công lâu dài.',
    },
    {
      title: 'Khớp cắn Implant, tại sao quan trọng?',
      url: 'https://blog.naver.com/gdfst111/224184928593',
      description: 'Giải thích tại sao khớp cắn (cân bằng lực nhai) quan trọng trong điều trị Implant, và những vấn đề do khớp cắn sai gây ra.',
    },
  ],
  home: [],
};
    ...
    <div className="bg-white w-full flex justify-center">
      <div className="px-4 py-[60px] w-full max-w-[430px]">
        ...
        <div className="mt-6 text-center">
          ...
          >
            Xem tất cả blog Godeok First Dental →
          </Link>
        </div>
      </div>
    </div>
