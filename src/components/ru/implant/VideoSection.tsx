export default function VideoSection() {
          ...
          <div className="flex flex-col gap-3">
            <div className="relative w-full aspect-video rounded-[20px] overflow-hidden bg-[#e9ebf1] flex items-center justify-center">
              <div className="flex flex-col items-center gap-3 text-center px-6">
                ...
                <p className="text-[#008095] font-bold text-[15px]">Видео готовится</p>
 <p className="text-[#727582] text-[13px] leading-[1.5]">Godeok First Dental Имплант <br /> примерно</p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            {['Имплант операция процесс', 'Имплант уходметод'].map((title, i) => (
 ...
 <p className="text-[#727582] text-[11px]"> стоимость во время</p>
                  </div>
                </div>
