...
export default function CheckupSection() {
  ...
  const symptoms = [
    ...
    { id: '4', label: 'บริเวณกรามรู้สึกตึง' }
  ];
    ...
    <div className="w-full px-4 py-[60px] bg-gradient-to-b from-[#008095] to-[#006d80]">
      <div className="max-w-[375px] mx-auto">
        <div className="flex flex-col gap-10 items-start w-full">
          <h2 className="font-bold text-[32px] leading-[1.35] tracking-[-0.64px] text-white text-center w-full">ฟันคุดของคุณ<br />สบายดีไหม?</h2>
          <div className="bg-white border border-[#f3f6fb] rounded-[24px] p-6 flex flex-col gap-6 items-center justify-center w-full">
            <h3 className="font-bold text-[24px] leading-[1.35] tracking-[-0.48px] text-black text-center w-full">หากมีอาการแม้แต่อย่างเดียว<br />ต้องตรวจฟันคุด</h3>
          ...
          <Link href="/th/consultation" className="w-full">
            <button className="bg-white h-16 rounded-[18px] px-6 py-4 flex items-center justify-center w-full hover:bg-gray-50 transition-colors">
              <p className="font-bold text-[20px] leading-[1.5] tracking-[-0.4px] text-[#008095]">ปรึกษา AI</p>
            </button>
          </Link>
        </div>
      </div>
