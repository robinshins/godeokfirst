          ...
          <div className="flex flex-col gap-3 items-start w-full">
            <div className="flex flex-col gap-4 items-center justify-center w-full">
              <div className="flex flex-col gap-3 items-center justify-center w-full">
                <h2 className="font-['Pretendard,sans-serif'] font-bold text-[32px] leading-[1.35] tracking-[-0.64px] text-black text-center w-full">
                  坚守保留理念的牙科
                </h2>
              </div>
            </div>
            <p className="font-['Pretendard,sans-serif'] font-semibold text-base leading-[1.4] tracking-[-0.32px] text-[#727582] text-center w-full">
              牙齿一旦失去就再也回不来<br />
              多保留一颗是真正专科医生的使命
            </p>
          </div>
          ...
          <div className="relative w-full h-[263px]">
            ...
            <div className="absolute left-[10px] top-[20.21px] w-[133px]">
              <div className="flex flex-col gap-[10px] items-start w-full">
                <div className="flex gap-[10.671px] items-start w-full">
                  <h3 className="font-['Pretendard,sans-serif'] font-bold text-[22px] leading-[1.4] tracking-[-0.44px] text-[#37373e] flex-1">
                    普通牙科
                  </h3>
                </div>
                <div className="flex flex-col items-start w-full">
                  <div className="border-b border-[#e9ebf1] py-3 w-full">
                    <p className="font-['Pretendard,sans-serif'] font-bold text-[15px] leading-[1.4] tracking-[-0.3px] text-[#5d5f6d] w-full">
                      以盈利为中心
                    </p>
                    <p className="font-['Pretendard,sans-serif'] font-semibold text-[13px] leading-[1.4] tracking-[-0.26px] text-[#727582] w-full">
                      建议拔牙/种植牙
                    </p>
                  </div>
                  <div className="border-b border-[#e9ebf1] py-3 w-full">
                    <p className="font-['Pretendard,sans-serif'] font-bold text-[15px] leading-[1.4] tracking-[-0.3px] text-[#5d5f6d]">
                      快速结束治疗
                    </p>
                  </div>
                  <div className="border-b border-[#e9ebf1] py-3 w-full">
            ...
            <div className="absolute left-[157px] top-[-13px] w-[186px] bg-white border-2 border-[#006aff] rounded-2xl p-5">
              <div className="flex flex-col gap-[10px] items-center justify-center w-full">
                <div className="flex gap-[10.671px] items-start w-full">
                  <h3 className="font-['Pretendard,sans-serif'] font-bold text-[22px] leading-[1.4] tracking-[-0.44px] text-black flex-1">
                    Medis牙科
                  </h3>
                </div>
                <div className="flex flex-col items-start w-full">
                  <div className="border-b border-[#e9ebf1] py-3 w-full">
                    <p className="font-['Pretendard,sans-serif'] font-bold text-[15px] leading-[1.4] tracking-[-0.3px] text-[#37373e] w-full">
                      以保留为中心
                    </p>
                    <p className="font-['Pretendard,sans-serif'] font-semibold text-[13px] leading-[1.4] tracking-[-0.26px] text-[#006aff] w-full">
                      优先保留自然牙齿
                    </p>
                  </div>
                  <div className="border-b border-[#e9ebf1] py-3 w-full">
                    <p className="font-['Pretendard,sans-serif'] font-bold text-[15px] leading-[1.4] tracking-[-0.3px] text-[#37373e]">
                      精密诊断 分阶段治疗
                    </p>
                  </div>
                  <div className="border-b border-[#e9ebf1] py-3 w-full">
            ...
            <div className="bg-white border border-[#f3f6fb] rounded-[24px] w-full overflow-hidden">
              <div className="flex flex-col items-center justify-center w-full">
                <div className="flex flex-col gap-5 items-center justify-center px-4 py-6 w-full">
                  <h3 className="font-['Pretendard,sans-serif'] font-bold text-[22px] leading-[1.4] tracking-[-0.44px] text-black text-center w-full">
                    &ldquo;保留了被建议拔除的牙齿<br />
                    真的很感谢&rdquo;
                  </h3>
                      ...
                      <div className="bg-[#f3f6fb] h-48 overflow-hidden relative rounded-[20px] w-full">
                        ...
                        <div className="absolute left-0 top-0 p-3 z-10">
                          <div className="bg-[#292a2f] px-2.5 py-1.5 rounded-[10px]">
                            <p className="font-['Pretendard,sans-serif'] font-semibold text-[13px] leading-[1.4] tracking-[-0.26px] text-white">
                              Before
                            </p>
                          </div>
                        </div>
                  ...
                  <div className="flex flex-col gap-1 items-start text-center w-full">
                    <p className="font-['Pretendard,sans-serif'] font-bold text-base leading-[1.4] tracking-[-0.32px] text-black w-full">
                      通过根管治疗保持自然牙齿5年
                    </p>
                    <p className="font-['Pretendard,sans-serif'] font-semibold text-[15px] leading-[1.4] tracking-[-0.3px] text-[#9298a6] w-full">
                      金●● · 60多岁女性
                    </p>
                  </div>
                </div>
