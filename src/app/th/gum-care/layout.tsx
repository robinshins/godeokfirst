...
export const metadata: Metadata = {
  title: '고덕동잇몸치료 평택잇몸치료 | Godeok First Dental',
  description: '고덕동잇몸치료 평택잇몸치료 전문. NSK varios 970 특수장비, 페리오클린 관리, 4단계 통증완화 시스템. 연 1회 스케일링 보험 적용.',
  keywords: ['고덕동잇몸치료', '평택잇몸치료', '고덕동스케일링', '평택스케일링', 'Godeok First Dental잇몸치료'],
  alternates: {
    canonical: 'https://gdfirstdent.co.kr/gum-care',
  },
  openGraph: {
    title: '고덕동잇몸치료 평택잇몸치료 | Godeok First Dental',
  ...
  '@graph': [
    {
      ...
      '@id': 'https://gdfirstdent.co.kr/gum-care#service',
      name: '고덕동잇몸치료 평택잇몸치료',
    ...
    {
      '@type': 'FAQPage',
      '@id': 'https://gdfirstdent.co.kr/gum-care#faq',
      mainEntity: [
        {
          '@type': 'Question',
