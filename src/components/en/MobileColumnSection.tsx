...
const columnData: Record<string, Column[]> = {
  implant: [
    {
      title: 'Principles of Multiple Implant Restoration',
      url: 'https://blog.naver.com/gdfst111/224181674200',
      description: 'The head doctor explains principles and considerations for placing multiple implants.',
    },
    {
      title: 'Implant Survival Rate',
      url: 'https://blog.naver.com/gdfst111/224184908972',
      description: 'Factors affecting implant survival rates and key conditions for long-term success.',
    },
    {
      title: 'Why Implant Occlusion Matters',
      url: 'https://blog.naver.com/gdfst111/224184928593',
      description: 'Why occlusion (bite balance) matters in implant treatment and problems caused by improper occlusion.',
    },
  ],
  home: [],
};
