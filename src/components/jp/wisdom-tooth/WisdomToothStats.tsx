...
export default function WisdomToothStats() {
  const stats = [
    { number: '2,700+', unit: '件', label: '累計親知らず抜歯' },
    { number: '0', unit: '件', label: '副作用による再治療', subtitle: '高徳エデュタウン開院以来、再治療0件' },
    { number: '0', unit: '%', label: '上級病院への転院率', subtitle: 'むしろ他の病院から難しいケースを依頼されています' },
  ];
