...
const LONG_FORM_VIDEOS = [
  {
    id: '9kP02X04THc',
    title: 'Implantatsiya davolash jarayoni',
  },
  {
    id: 'GyzFVUfRqmk',
    title: 'Bemor sharhlari',
  },
  {
    id: '4hJI8OteG3Q',
    title: 'Davolash tushuntirishi',
  },
];
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 px-5 py-2 bg-gradient-to-r from-red-500 to-pink-500 text-white rounded-full text-sm font-bold mb-5 shadow-lg">
            ...
            <span>KimplantTV</span>
          </div>
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4">
            Turli davolashlar haqida tushuntirishlarni<br />
            video orqali ko'ring
          </h2>
          <p className="text-gray-600 text-lg">
            Kim Dong-seok shifokorning haqiqiy davolash holatlari va bemor sharhlari
          </p>
        </div>
        ...
        <div>
          <div className="flex items-center justify-between mb-6">
            ...
            >
              <span>To'liq kanalni ko'rish</span>
