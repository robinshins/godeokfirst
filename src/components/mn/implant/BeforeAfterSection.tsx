...
export default function BeforeAfterSection() {
 ...
 // амны хөндийдахинтохиолдол ()
  const reconstructionCases = [
    {
 name:'●●',
      gender: 'Эрэгтэй',
      type: 'олон Имплант · рентген',
 ...
 name:'●●',
      gender: 'Эрэгтэй',
      type: 'Имплант хиймэл шүд · рентген',
      beforeImage: '/임상사진/지종환_임플란트/지종환_어금니임플란트_엑스레이_before.jpg',
      afterImage: '/임상사진/지종환_임플란트/지종환_어금니임플란트_엑스레이_after.jpg'
    },
    {
 ...
 эмчилгээ
              ...
              <div className="flex flex-col gap-3 items-center justify-center relative shrink-0 w-full">
                <h2 className="font-bold leading-[1.35] not-italic text-[28px] text-black text-center tracking-[-0.56px] w-full" style={{ fontFamily: 'Pretendard, sans-serif' }}>
                  бүх шүд амны хөндийдахинтохиолдол<br />
                  Өмнө ба дараах
                </h2>
 ...
 Нийлмэл шүдний мэргэжилтэн эмчилгээ
                </p>
              </div>
              <p className="text-[#4b5563] text-[14px] leading-[1.7]" style={{ fontFamily: 'Pretendard, sans-serif' }}>
 Нийлмэл шүдний мэргэжилтэн <span className="font-semibold text-black">Имплант, титэм, </span> гэх мэт эмчилгээ өвчтөн, <span className="font-semibold text-black"> </span> <span className="font-semibold text-black"> </span>.
              </p>
            </div>
          </div>
          </FadeInSection>

          {/* амны хөндийдахинтохиолдол Cases */}
 ...
 амны хөндийдахинтохиолдол тохиолдол үзэх
                </span>
              </button>
            )}
          </FadeInSection>
