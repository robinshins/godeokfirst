      ...
      <div className="w-full flex justify-center">
        <div className="px-5 py-[60px] w-full max-w-[430px] flex flex-col gap-10">
          ...
          <div className="bg-[#f8f9fb] rounded-[24px] p-6 flex flex-col gap-5">
            <div className="flex flex-col gap-4">
              <p
                ...
                style={{ fontFamily: 'Pretendard, sans-serif' }}
              >
                &ldquo;My jaw clicks but it&apos;ll be fine&rdquo; — so many people leave it untreated.<br /><br />
                However, TMJ disorder is <span className="text-[#008095] font-bold">simple to treat early, but becomes chronic if neglected,</span> making treatment much more difficult.
              </p>
              <p
                className="font-semibold text-[16px] leading-[1.75] tracking-[-0.02em] text-[#2d3340]"
                style={{ fontFamily: 'Pretendard, sans-serif' }}
              >
                TMJ pain can lead to systemic symptoms such as headaches, shoulder stiffness, and tinnitus. <span className="text-[#008095] font-bold">An accurate diagnosis is the beginning of proper treatment.</span>
              </p>
            </div>
          ...
          <div className="flex flex-col gap-3">
            {[
              { num: '70%', desc: 'Percentage of adults who have experienced TMJ disorder' },
              { num: '3x', desc: 'Risk of becoming chronic if left untreated — early treatment is key' },
              { num: '85%', desc: 'Percentage improved with conservative (non-surgical) treatment' },
            ].map((item, i) => (
              <div
                key={i}
