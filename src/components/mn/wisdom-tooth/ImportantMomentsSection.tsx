...
export default function ImportantMomentsSection() {
  const moments = [
    { icon: '/images/military.png', label: 'Цэргийн алба', description: 'Цэрэгт байхад гэнэт\nөвдөхөд шийдвэрлэхэд хэцүү' },
    { icon: '/images/exam.png', label: 'Шалгалтын үе', description: 'Чухал шалгалтын өмнөх өдөр\nгэнэтийн өвдөлт' },
    { icon: '/images/wedding.png', label: 'Хурим · Ярилцлага', description: 'Амьдралын чухал өдөр\nнүүр хавдсан...' },
    { icon: '/images/travel.png', label: 'Аялал · Томилолт', description: 'Гадаадын яаралтай тусламж\nүнэтэй эмчилгээ' }
  ];
        ...
        <div className="flex flex-col gap-[26px] items-center justify-center w-full">
          <div className="flex flex-col gap-3 items-center justify-center w-full">
            <div className="flex flex-col gap-3 items-center justify-center text-center w-full">
              ...
              <h2 className="font-bold text-[32px] leading-[1.35] tracking-[-0.64px] text-[#292a2f]">Анхааруулгагүй ирдэг<br /><span className="text-[#008095]">Хүзүү шүдний өвдөлт...</span></h2>
            </div>
            <p className="font-semibold text-[14px] leading-[1.4] tracking-[-0.32px] text-[#727582] text-center w-full">Амар тайван байхад урьдчилж шийдвэл чухал мөчүүдээ хамгаалж чадна</p>
          </div>
