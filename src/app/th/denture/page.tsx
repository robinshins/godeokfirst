...
import ImplantHero from '@/components/th/denture/ImplantHero';
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://gdfirstdent.com/th/denture',
  },
  openGraph: {
    title: 'Full-Arch Implants & Dentures | Godeok First Dental',
    description: '대학 치과병원 외래교수 역임 원장이 직접 진료하는 전체임플란트, 틀니 전문. 임플란트 1,200회+, 재수술 0건.',
    url: 'https://gdfirstdent.com/th/denture',
...
const breadcrumbSchema = generateBreadcrumbSchema([
  { name: '홈', url: 'https://gdfirstdent.com/th' },
  { name: '전체임플란트·틀니', url: 'https://gdfirstdent.com/th/denture' }
]);
...
import StatsSection from '@/components/th/denture/StatsSection';
import TreatmentOptionsSection from '@/components/th/denture/TreatmentOptionsSection';
import VideoSection from '@/components/th/denture/VideoSection';
import WhyBestNewSection from '@/components/th/denture/WhyBestNewSection';
import InHouseLabSection from '@/components/th/denture/InHouseLabSection';
import AfterCareSection from '@/components/th/denture/AfterCareSection';
import SpeedSection from '@/components/th/denture/SpeedSection';
import DigitalGuideSection from '@/components/th/implant/DigitalGuideSection';
import RealPatientResultsSection from '@/components/th/denture/RealPatientResultsSection';
