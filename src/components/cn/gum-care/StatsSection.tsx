...
export default function StatsSection() {
  const stats = [
    { number: '80', unit: '%', label: '成人牙龈疾病患病率', source: '韩国牙周学会 2024' },
    { number: '14', unit: '% 减少', label: '洁牙时心血管疾病减少', source: '分当首尔大学医院 2024' },
    { number: '6', unit: '倍', label: '牙周炎时血糖调节失败', source: '天主教大学医学院 2023' },
  ];
