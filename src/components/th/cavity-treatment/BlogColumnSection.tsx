...
const columns = [
  {
    ...
    num: '01',
    tag: 'เซรามิก อินเลย์',
    title: 'ฟันผุด้านข้าง รักษาด้วยเซรามิก อินเลย์',
    desc: 'ฟันผุด้านข้างที่มองไม่เห็นจากภายนอกจึงมักถูกปล่อยทิ้ง กรณีบูรณะด้วยเซรามิกที่จำลองสีและความโปร่งแสงของฟันธรรมชาติได้เหมือนจริง',
    href: BLOG_URL,
  },
  {
    id: 2,
    num: '02',
    tag: 'เรซิน',
    title: 'รักษาฟันผุระยะแรกที่ฟันกรามด้วยเรซิน',
    desc: 'ฟันผุระยะแรกหัวใจสำคัญคือการกรอฟันให้น้อยที่สุด กรณีอุดเรซินภายในวันเดียวที่รักษาฟันธรรมชาติไว้มากที่สุดพร้อมบูรณะอย่างสวยงาม',
    href: BLOG_URL,
  },
  {
    id: 3,
    num: '03',
    tag: 'อินเลย์ รักษาซ้ำ',
    title: 'รักษาฟันผุซ้ำใต้อมัลกัมด้วยอินเลย์',
    desc: 'ฟันผุซ้ำที่เกิดใต้อมัลกัมเก่า กรณีถอดวัสดุอุดเดิมออกแล้วสแกนดิจิทัล TRIOS 5 เพื่อผลิตชิ้นงานใหม่อย่างแม่นยำ',
    href: BLOG_URL,
  },
  {
    id: 4,
    num: '04',
    tag: 'อินเลย์',
    title: 'รักษาฟันผุด้านข้างหลังวัสดุอุดหลุดด้วยอินเลย์',
    desc: 'ตรวจพบฟันผุซ้ำที่ลุกลามหลังครอบฟันหลุด ขั้นตอนบูรณะอินเลย์ที่แนบสนิทไร้ช่องว่างโดยอาศัยข้อมูลดิจิทัล',
    href: BLOG_URL,
  },
  {
    id: 5,
    num: '05',
    tag: 'เซรามิก อินเลย์',
    title: 'รักษาฟันแตกด้วยเซรามิก อินเลย์',
    desc: 'การทำงานและรูปทรงที่เสียหายจากฟันแตกหัก คอลัมน์ทางคลินิกที่บูรณะกลับสู่รูปทรงฟันเดิมด้วยการวินิจฉัยอย่างละเอียดทีละขั้นตอน',
    href: BLOG_URL,
  },
];
      ...
      <div className="max-w-[430px] mx-auto flex flex-col gap-12">
        ...
        <div className="flex flex-col gap-4 text-center w-full">
          ...
          <h2 className="font-bold text-[32px] leading-[1.3] tracking-[-0.04em] text-white" style={{ fontFamily: 'Pretendard, sans-serif' }}>
            เรื่องราวการรักษาฟันผุ<br />ที่ทันตแพทย์บันทึกด้วยตนเอง
          </h2>
          <p className="font-medium text-white/70 text-[16px] leading-[1.6] tracking-[-0.02em]" style={{ fontFamily: 'Pretendard, sans-serif' }}>
            การรักษาที่ดีที่สุดเริ่มต้นจากการวินิจฉัยที่แม่นยำ<br />เปิดเผยขั้นตอนการรักษาอย่างโปร่งใสผ่านกรณีจริง
          </p>
        </div>
