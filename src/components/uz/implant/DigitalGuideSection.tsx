  ...
  const steps = [
    {
      ...
      description: 'Ogʼiz boʼshligʼini skanerlash uchun\n3D ogʼiz skanerlash tizimi bilan aniq tashxis'
    },
    {
      number: 2,
    ...
    },
    {
      ...
      description: 'Yoʼnaltiruvchi qurilmani operatsiya joyiga oʼrnatib, 1mm xatolikni minimallashtirish'
    },
    {
      number: 4,
      image: '/images/goduk_images/4.png',
      description: 'Minimal kesish bilan boshqa operatsiyalarga nisbatan vaqtni qisqartirish va ogʼriq hamda shishishni kamaytirish'
    },
    {
      number: 5,
      image: '/images/goduk_images/digital-guide-5.png',
      description: 'Vaziyatga qarab virtual operatsiya oʼtkazish orqali xatolikni kamaytirish va mamnuniyatni oshirish'
    }
  ];
      ...
      <div className="box-border flex flex-col gap-10 items-center px-6 py-[80px] relative w-full max-w-[430px]">
        ...
        <div className="text-center w-full">
          ...
          <p className="font-medium leading-[1.6] text-[#666] text-[15px] tracking-[-0.3px]" style={{ fontFamily: '"NanumSquare", sans-serif' }}>
            ...
            <br />
            eng optimal oʼrnatish joyini loyihalab,
            <br />
            keyin haqiqiy operatsiyani oʼtkazadi
          </p>
          <div className="mt-5 inline-block bg-gradient-to-r from-[#008095] to-[#006d80] px-6 py-4 rounded-2xl shadow-lg shadow-[#008095]/20">
            <p className="font-bold text-white text-[15px] leading-[1.5]" style={{ fontFamily: '"NanumSquare", sans-serif' }}>
              ...
              <br />
              shishish, ogʼriq va suyak koʼchirishni minimallashtirish
            </p>
          </div>
        </div>
