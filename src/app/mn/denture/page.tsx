...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://gdfirstdent.com/mn/denture',
  },
  openGraph: {
    title: 'Full-Arch Implants & Dentures | Godeok First Dental',
    description: '대학 치과병원 외래교수 역임 원장이 직접 진료하는 전체임플란트, 틀니 전문. 임플란트 1,200회+, 재수술 0건.',
    url: 'https://gdfirstdent.com/mn/denture',
...
const breadcrumbSchema = generateBreadcrumbSchema([
  { name: '홈', url: 'https://gdfirstdent.com/mn' },
  { name: '전체임플란트·틀니', url: 'https://gdfirstdent.com/mn/denture' }
]);
