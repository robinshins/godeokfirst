  ...
  const cases = [
    {
      name: 'ปาร์ก●●',
      gender: 'ชาย',
      type: 'ทั้งปาก รากฟันเทียม · เอกซเรย์',
      beforeImage: '/ทางคลินิกภาพถ่าย/ปาร์ก●●_ทั้งปากรากฟันเทียม/ปาร์ก●●_ก่อนร่างกายรากฟันเทียม_เอกซเรย์_before.jpg',
      afterImage: '/ทางคลินิกภาพถ่าย/ปาร์ก●●_ทั้งปากรากฟันเทียม/ปาร์ก●●_ก่อนร่างกายรากฟันเทียม_เอกซเรย์_after.jpg'
    },
    {
      name: 'ปาร์ก●●',
      gender: 'ชาย',
      type: 'ทั้งปาก รากฟันเทียม · จริงภาพถ่าย',
      beforeImage: '/ทางคลินิกภาพถ่าย/ปาร์ก●●_ทั้งปากรากฟันเทียม/ปาร์ก●●_ก่อนร่างกายรากฟันเทียม_จริงภาพถ่าย_before.jpg',
      afterImage: '/ทางคลินิกภาพถ่าย/ปาร์ก●●_ทั้งปากรากฟันเทียม/ปาร์ก●●_ก่อนร่างกายรากฟันเทียม_จริงภาพถ่าย_after.jpg'
    }
  ];
        ...
        <FadeInSection className="flex flex-col gap-4 items-center justify-center relative shrink-0 w-full">
          <div className="flex flex-col gap-3 items-center justify-center relative shrink-0 text-center w-full">
            ...
            <h2 className="font-bold leading-[1.35] text-[32px] text-white tracking-[-0.64px] w-full" style={{ fontFamily: '"NanumSquare", sans-serif' }}>
              ก่อนร่างกายรากฟันเทียม ก่อนและหลัง กรณีตัวอย่าง
            </h2>
            <p className="font-medium leading-[1.6] text-[#a0c4d4] text-[15px] text-center tracking-[-0.32px] w-full" style={{ fontFamily: '"NanumSquare", sans-serif' }}>
              ตรวจสอบการเปลี่ยนแปลงที่น่าประหลาดใจของผู้ป่วยจริงนะคะ
            </p>
          </div>
        </FadeInSection>
