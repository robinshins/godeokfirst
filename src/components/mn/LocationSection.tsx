...
export default function LocationSection() {
 ...
 тохиолдол шүд, 
          ...
          <Link href="/mn/consultation" className="block w-full">
        ...
        {/* Interior Photos */}
        <div className="mb-10">
          <h3 className="text-2xl font-bold text-[#292a2f] mb-4">Эмнэлгийн байр</h3>
          <div className="overflow-x-auto flex gap-3 pb-4">
            ...
            <div className="flex-none w-[320px] aspect-[4/3] rounded-xl overflow-hidden relative shadow-md">
              <Image
                ...
                alt="Godeok First Dental зөвлөгөөний өрөө"
                fill
                className="object-cover"
              />
            </div>
            <div className="flex-none w-[320px] aspect-[4/3] rounded-xl overflow-hidden relative shadow-md">
              <Image
                ...
                alt="Godeok First Dental эмчилгээний өрөө"
                fill
                className="object-cover"
              />
            </div>
            <div className="flex-none w-[320px] aspect-[4/3] rounded-xl overflow-hidden relative shadow-md">
              <Image
                ...
                alt="Godeok First Dental VIP өрөө"
                fill
                className="object-cover"
              />
            </div>
            <div className="flex-none w-[320px] aspect-[4/3] rounded-xl overflow-hidden relative shadow-md">
              <Image
                ...
                alt="Godeok First Dental ариутгалын өрөө"
                fill
                className="object-cover"
              />
            </div>
        ...
        <div className="space-y-6">
          ...
          <div className="relative border-[5px] border-white rounded-2xl overflow-hidden h-[480px]">
            <Image
              ...
              alt="Godeok First Dental байршил"
              fill
              className="object-cover"
            />
            ...
            <div className="absolute bottom-4 left-4 right-4 space-y-3">
              <div className="text-black font-semibold text-[15px] leading-[1.6]">
                <p className="mb-0">Кёнги, Пёнтэк, Годок-ро 250, Эдускай, 4 давхар, 401, 402</p>
              </div>
              <Link
          ...
          <div className="space-y-10">
            ...
            <div className="space-y-3">
              <p className="text-base font-semibold text-[#727582]">Эмчилгээний цаг</p>
              <div className="text-[15px] font-semibold text-black leading-[1.8] space-y-1">
                <div className="flex">
                  <span className="min-w-[140px]">Даваа / Пүрэв (шөнийн эмчилгээ) :</span>
                  <span className="whitespace-nowrap">AM 10:00 – PM 09:00</span>
                </div>
                <div className="flex">
                  <span className="min-w-[140px]">Мягмар / Лхагва / Баасан :</span>
                  <span className="whitespace-nowrap">AM 10:00 – PM 07:00</span>
                </div>
                <div className="flex">
                  <span className="min-w-[140px]">Бямба :</span>
                  <span className="whitespace-nowrap">AM 09:30 – PM 02:00</span>
                </div>
                <div className="flex">
                  <span className="min-w-[140px]"></span>
                  <span className="text-[13px] text-[#727582]">(Үдийн завсарлагагүй)</span>
                </div>
                <div className="flex">
                  <span className="min-w-[140px]">Үдийн завсарлага :</span>
                  <span className="whitespace-nowrap">PM 01:00 – PM 02:00</span>
                </div>
                <div className="flex">
                  <span className="min-w-[140px]"></span>
                  <span className="text-[13px] text-[#727582]">(Даваа-Баасан)</span>
                </div>
                <div className="flex">
                  <span className="min-w-[140px]">Амралт :</span>
                  <span>Ням болон баяр</span>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="space-y-3">
                <p className="text-base font-semibold text-[#727582]">Цаг захиалга</p>
                <p className="text-[15px] text-[#727582] leading-[1.6]">
 AI, Утасны зөвлөгөө, эсвэл Naver захиалга ашиглалт.
                </p>
              </div>
 ...
 {/* */}
                ...
                >
                  <div className="flex flex-col items-center">
                    <span className="text-lg font-bold text-[#008095]">Утасны зөвлөгөө</span>
 ...
 {/* Naver захиалга */}
                ...
                >
                  ...
                  <span className="text-lg font-bold text-white">Naver захиалга</span>
                </Link>
              </div>
            </div>
          </div>
