  ...
  const symptoms = [
    {
      ...
      title: 'Горизонтальный зуб',
      description: 'Растет боком и\nдавит на соседние зубы'
    },
    {
      icon: '/icons/tooth-loosen.svg',
      title: 'Воспаление',
      description: 'Запущенный зуб мудрости\nвызывает отек и воспаление десны'
    }
  ];
