...
export default function VideoSection() {
  const videos = [
    {
      id: 'P54GsqWvnkw',
      title: 'Protez haqida hammasi',
      description: 'Protez haqidagi barcha savollaringizga javob beramiz',
    },
    {
      id: 'zmvu-xPe0ik',
      title: 'Toʼliq implant batafsil tushuntirish',
      description: '2 million obunachi tibbiyot kanali "Biondi"da chiqish',
      badge: '2M obunachi kanalda chiqish',
    },
    {
      id: 'r7aeNpeP5vY',
      title: 'Toʼliq implant nima?',
      description: 'Toʼliq implant nima? Lekin protez arzon va yaxshi emasmi? Aniq tushuntiramiz',
    },
    {
      id: 'rRVF8hLE82E',
      title: 'Toʼliq implant bilan umr uzaytirish??',
      description: 'Tishlov bu qadar muhim ekan!!',
    },
  ];
                ...
                <div className="relative w-full aspect-video rounded-[20px] overflow-hidden shadow-lg bg-gradient-to-br from-[#008095]/10 to-[#008095]/20 flex items-center justify-center">
                  <div className="flex flex-col items-center gap-3 p-6 text-center">
                    ...
                    <p className="text-[13px] text-[#008095]/70" style={{ fontFamily: '"NanumSquare", sans-serif' }}>
                      Godeok First Dental video tez orada yuklanadi
                    </p>
                  </div>
                </div>
