...
const articleData: RegionArticleData = {
  ...
  sections: [
    {
      ...
      content: [
        ...
        '사랑니가 비스듬하게 나거나, 잇몸 속에 묻혀 있거나(매복), 앞 어금니를 밀어서 통증이나 충치를 유발하는 경우에는 발치가 필요합니다. 사랑니 주변 잇몸에 반복적으로 염증이 생기는 지치주위염도 발치의 주요 적응증입니다.',
        '포승읍에 거주하시면서 사랑니 때문에 불편을 겪고 계시다면, 정확한 진단을 통해 발치 여부를 판단하는 것이 중요합니다.',
      ],
    },
    {
    ...
    },
    {
      ...
      content: [
        ...
        '수술 후에는 상세한 주의사항과 함께 소염진통제, 항생제를 처방합니다.',
      ],
    },
    {
      title: '사랑니 발치 후 주의사항과 회복 과정',
      content: [
        '사랑니 발치 후 첫 24시간이 가장 중요합니다. 거즈를 1시간가량 꽉 물고 계시고, 당일에는 뜨거운 음식, 심한 운동, 음주, 흡연을 피해주셔야 합니다. 포승읍까지 돌아가시는 동안에도 거즈를 물고 계시는 것이 좋습니다.',
    ...
    },
    {
      ...
      content: [
        ...
        '사랑니가 앞 어금니에 충치를 유발하거나, 교정 치료를 계획 중이라면 미리 발치하는 것이 좋습니다. 포승읍에 거주하는 20~30대 분들이라면 한 번쯤 사랑니 상태를 확인받아보시기를 권장합니다.',
      ],
    },
  ],
  tips: [
    '사랑니 발치 전날에는 충분히 수면을 취하고, 당일 아침에 가벼운 식사를 하고 오시면 좋습니다.',
    '발치 당일에는 가급적 자가용을 이용해주세요. 포승읍에서 약 30분 거리이므로 보호자 동반을 권장합니다.',
  ...
  conclusion:
    '포승읍에서 사랑니 발치를 고민하고 계시다면, 대학병원 외래교수 출신 이동현 원장이 직접 시술하는 고덕퍼스트치과를 방문해보세요. CT 기반 정밀 진단과 최소 침습 발치 테크닉으로 안전하고 빠른 회복을 약속드립니다. 전화 031-611-3222로 예약 가능합니다.',
  faqs: [
    {
    ...
    },
    {
      ...
      answer:
        '수술 중에는 충분한 마취로 통증이 없습니다. 수술 후에는 매복 정도에 따라 일반 발치보다 붓기와 통증이 더 있을 수 있지만, 처방되는 진통제로 충분히 조절 가능합니다.',
    },
    {
    ...
    },
    {
      ...
      answer:
        '네, 발치 후 5~7일 뒤에 경과 확인과 실밥 제거를 위해 내원이 필요합니다. 포승읍에서 오시는 점을 고려하여 발치와 경과 확인 날짜를 효율적으로 잡아드립니다.',
    },
  ],
};

export const metadata: Metadata = {
  title: '포승 사랑니 발치 | 매복 사랑니 전문 - 고덕퍼스트치과',
  description:
    '포승 사랑니발치는 대학병원 외래교수 출신 원장이 직접 시술하는 고덕퍼스트치과에서. CT 정밀 진단, 최소 침습 발치, 매복 사랑니 전문. 포승읍에서 차로 30분.',
  keywords: [
    '포승 사랑니',
    '포승 사랑니발치',
    '포승읍 사랑니',
  ...
  alternates: {
    canonical: 'https://gdfirstdent.co.kr/poseung/wisdom-tooth',
  },
  openGraph: {
    title: '포승 사랑니 발치 | 고덕퍼스트치과',
    description: '대학병원 외래교수 출신 원장의 안전한 사랑니 발치. CT 정밀 진단, 최소 침습 테크닉.',
    url: 'https://gdfirstdent.co.kr/poseung/wisdom-tooth',
    siteName: '고덕퍼스트치과',
    type: 'article',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: '고덕퍼스트치과 - 포승 사랑니 발치',
      },
    ],
  },
};

export default function PoseungWisdomToothPage() {
  const faqJsonLd = {
  ...
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: '사랑니 발치', item: 'https://gdfirstdent.co.kr/poseung/wisdom-tooth' },
    ],
  };
