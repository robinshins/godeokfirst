      ...
      <div className="max-w-[375px] mx-auto">
        <div className="flex flex-col gap-[30px] items-center w-full">
          ...
          <div className="flex flex-col gap-3 items-start w-full">
            <div className="flex flex-col gap-4 items-center justify-center w-full">
              <div className="flex flex-col gap-3 items-center justify-center text-center text-white w-full">
                ...
                <p className="font-['Pretendard,sans-serif'] font-bold text-[32px] leading-[1.35] tracking-[-0.64px] w-full">
                  除了种植牙，没有保留牙齿的方法吗？
                </p>
              </div>
            </div>
            <p className="font-['Pretendard,sans-serif'] font-semibold text-base leading-[1.4] tracking-[-0.32px] text-[#d2d6e1] text-center w-full">
              其他地方都说必须拔牙...
            </p>
          </div>
          ...
          <div className="bg-white/[0.08] rounded-[20px] px-5 py-[30px] flex flex-col gap-6 items-center justify-end w-full">
            <p className="font-['Pretendard,sans-serif'] font-semibold text-[17px] leading-[1.5] tracking-[-0.34px] text-center text-white w-full">
              保留治疗耗时长且收益低<br />
              许多牙科诊所不愿做是现实
            </p>
          </div>
