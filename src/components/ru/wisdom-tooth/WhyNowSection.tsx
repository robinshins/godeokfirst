...
export default function WhyNowSection() {
  const problems = [
    {
      title: 'Острое воспаление',
      description: 'Сильная боль и отек лица'
    },
    {
      title: 'Кариес соседнего зуба',
      description: 'Повреждение соседних зубов'
    },
    {
      title: 'Проблемы с челюстью',
      description: 'Хроническая головная боль и боль в челюсти'
    },
    {
      title: 'Нарушение прикуса',
      description: 'Может потребоваться ортодонтия'
    }
  ];
  ...
  const benefits = [
    {
      ...
      description: 'Чем моложе, тем быстрее заживление'
    },
    {
      title: 'Профилактика осложнений',
      description: 'Безопаснее без воспаления'
    },
    {
      title: 'Экономия средств',
      description: 'Лечение до появления проблем'
    },
    {
      title: 'Комфортная процедура',
      description: 'Без воспаления анестезия эффективнее'
    }
  ];
          ...
          <div className="flex flex-col gap-6 items-start w-full">
            ...
            <div className="bg-[#006aff] rounded-[24px] p-6 flex flex-col gap-5 items-center justify-center text-center text-white w-full">
              <h3 className="font-bold text-[24px] leading-[1.35] tracking-[-0.48px] whitespace-pre-line">
                {'Многие терпят до последнего\nи попадают в скорую'}
              </h3>
              <p className="font-bold text-[15px] leading-[1.5] tracking-[-0.34px] opacity-80 whitespace-pre-line">
                {'Каждую неделю к нам обращаются пациенты,\nкоторые терпели до острого воспаления\nРаннее удаление предотвращает эти страдания'}
              </p>
            </div>
          </div>
        </div>
