...
export default function GNB() {
  ...
  const menuItems = [
    ...
    { name: 'Имплантация', href: '/ru/implant' },
    { name: 'Отбеливание · Виниры', href: '/ru/whitening' },
    { name: 'Удаление зуба мудрости', href: '/ru/wisdom-tooth' },
    { name: 'Лечение кариеса · Каналов', href: '/ru/cavity-treatment' },
    { name: 'Лечение дёсен · Чистка', href: '/ru/gum-care' }
  ];
                ...
                {languages.map((lang) => (
                  ...
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <p className="font-['Noto_Sans'] font-medium leading-[1.5] text-[#292a2f] text-[20px] tracking-[-0.4px] whitespace-nowrap">
                        {lang.name}
                      </p>
                    </div>
            ...
            <div className="max-w-[430px] mx-auto">
              ...
              <div className="flex flex-col gap-5 px-5 pb-[30px]">
                {menuItems.map((item, index) => (
                  <Link
                    ...
                    href={item.href}
                    onClick={() => setIsMenuOpen(false)}
                    className="font-['Noto_Sans'] font-medium leading-[1.5] text-[20px] text-black tracking-[-0.4px]"
                  >
                    {item.name}
                  </Link>
                ))}
              ...
              <div className="px-5 pb-3 border-b border-[#e9ebf1]">
                {user ? (
                  <button
                    ...
                    className="text-left font-['Noto_Sans'] font-medium text-[14px] leading-[1.5] tracking-[-0.28px] text-[#727582]"
                  >
                    Выйти
                  </button>
                ) : (
                  <Link href="/ru/login" onClick={() => setIsMenuOpen(false)}>
                    <span className="font-['Noto_Sans'] font-medium text-[14px] leading-[1.5] tracking-[-0.28px] text-[#727582]">
                      Войти
                    </span>
                  </Link>
                )}
              ...
              <div className="flex flex-col gap-4 px-5 pb-[30px] pt-4">
                <Link href="/ru/consultation" className="w-full">
                  <button className="w-full bg-[#006aff] text-white font-['Noto_Sans'] font-bold text-[20px] leading-[1.5] tracking-[-0.4px] rounded-[18px] h-16 flex items-center justify-center">
                    Запись на AI-консультацию
                  </button>
                </Link>
                <a href="tel:0507-1315-7475" className="w-full">
                  <button className="w-full bg-white border border-[#e9ebf1] text-[#006aff] font-['Noto_Sans'] font-bold text-[20px] leading-[1.5] tracking-[-0.4px] rounded-[18px] h-16 flex items-center justify-center">
                    Позвонить
                  </button>
                </a>
              </div>
