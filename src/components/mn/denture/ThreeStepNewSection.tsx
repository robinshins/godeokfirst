  ...
  const steps = [
    {
      ...
      label: '1-р түр',
      title: 'Шууд сэргэлт',
      description: 'Мэс заслын дараа шууд суулгаж\nөдөр тутмын амьдрал шууд боломжтой'
    },
    {
      icon: '/icons/crown.svg',
      label: '2-р зуурлын тогтворжилт',
      title: 'Нарийвчилсан зуурлын тохируулга',
      description: '2 долоо хоногийн дараа хувийн\nзуурлын төлөвийг нарийн тохируулна'
    },
    {
      icon: '/icons/implant-group.svg',
      label: '3-р эцсийн түр',
      title: 'Төгс зуурлын баталгаажуулалт',
      description: 'Эцсийн сэргээн засал хийхээс өмнө\nтөгс зуурлыг дахин нэг удаа шалгана'
    },
    {
      icon: '/icons/tooth-shine.svg',
      label: 'Эцсийн сэргээн засал',
      title: 'Насан туршийн миний шүд',
      description: 'Бүх тохируулга дууссан бүрэн хувийн\nэцсийн сэргээн засалыг суулгана'
    }
  ];
      ...
      <div className="flex flex-col gap-4 items-center justify-center relative shrink-0 w-full z-10">
        ...
        <div className="flex flex-col gap-3 items-center justify-center leading-[0] not-italic relative shrink-0 text-center w-full">
          ...
          <p className="font-semibold leading-[1.4] text-[#727582] text-base tracking-[-0.32px] w-full" style={{ fontFamily: 'Pretendard, sans-serif' }}>
            Ганц нэг удаагийн түр шүдээр дуусгахгүй<br />
            3 шатлалын нарийвчилсан тохируулгаар<br />
