...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://gdfirstdent.co.kr/ru/implant',
  },
  openGraph: {
    title: 'Dental Implant Pyeongtaek | Godeok First Dental',
    description: '대학병원 외래교수 출신 원장이 직접 수술하는 대학병원급 임플란트. 1,200회 이상 식립 경험.',
    url: 'https://gdfirstdent.co.kr/ru/implant',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Godeok First Dental - Dental Implant',
      },
    ],
  },
};
...
const breadcrumbSchema = generateBreadcrumbSchema([
  ...
  { name: '임플란트', url: 'https://gdfirstdent.co.kr/ru/implant' }
]);
