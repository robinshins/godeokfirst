  ...
  const videos = [
    {
      id: 'P54GsqWvnkw',
      title: '入れ歯の全て',
      description: '入れ歯に関する全ての疑問を解決します',
    },
    {
      id: 'zmvu-xPe0ik',
      title: '全顎インプラント詳細説明',
      description: '登録者200万の医学専門チャンネル「ビオンドゥィ」出演',
      badge: '200万登録チャンネル出演',
    },
    {
      id: 'r7aeNpeP5vY',
      title: '全顎インプラントとは？',
      description: '全顎インプラントとは？でも入れ歯の方が安くて良いんじゃ？正確にお伝えします',
    },
    {
      id: 'rRVF8hLE82E',
      title: '全顎インプラントで寿命延長？？',
      description: '咬合がこんなに重要です！！',
    },
  ];
