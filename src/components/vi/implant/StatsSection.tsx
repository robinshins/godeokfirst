...
export default function StatsSection() {
  const stats = [
    { number: '1,500 +', unit: 'ca', label: 'Phẫu thuật hướng dẫn kỹ thuật số' },
    { number: '0', unit: 'ca', label: 'Phẫu thuật lại trong 10 năm' },
    { number: '4.9', unit: '/ 5.0', label: 'Mức độ hài lòng của bệnh nhân', subtitle: 'Dựa trên bản đồ Kakao, Google, Naver' },
  ];
      ...
      <div className="flex flex-col gap-4 items-center justify-center relative shrink-0 w-full z-10">
        <div className="flex flex-col gap-3 items-center justify-center relative shrink-0 w-full">
          ...
          <h2 className="font-bold leading-[1.35] not-italic text-[31px] text-center text-white tracking-[-0.64px] w-full" style={{ fontFamily: 'Pretendard, sans-serif' }}>
            Tìm lại hương vị cuộc sống <br />
            và nụ cười với cấy ghép implant toàn hàm
          </h2>
          ...
          Niềm vui ăn nhai và nụ cười rạng rỡ đã lãng quên<br />
          bắt đầu cuộc đời thứ hai của bạn
          </p>
        </div>
      </div>
