      ...
      <div className="w-full flex justify-center">
        <div className="px-5 py-[60px] w-full max-w-[430px] flex flex-col gap-10">
          ...
          <div className="bg-[#f8f9fb] rounded-[24px] p-6 flex flex-col gap-5">
            <div className="flex flex-col gap-4">
              <p
                ...
                style={{ fontFamily: 'Pretendard, sans-serif' }}
              >
                &ldquo;下颌有响声应该没事吧&rdquo;这样放置不管的人真的很多。<br /><br />
                但颞下颌关节障碍<span className="text-[#008095] font-bold">初期治疗很简单，放置不管则会慢性化</span>，治疗变得困难。
              </p>
              <p
                className="font-semibold text-[16px] leading-[1.75] tracking-[-0.02em] text-[#2d3340]"
                style={{ fontFamily: 'Pretendard, sans-serif' }}
              >
                颞下颌关节疼痛可能导致头痛、肩膀僵硬、耳鸣等全身症状。<span className="text-[#008095] font-bold">准确的诊断是正确治疗的开始</span>。
              </p>
            </div>
          ...
          <div className="flex flex-col gap-3">
            {[
              { num: '70%', desc: '成人中有颞下颌关节障碍经历的比例' },
              { num: '3倍', desc: '放置不管时慢性化风险 — 早期治疗是关键' },
              { num: '85%', desc: '通过保守治疗（非手术）好转的比例' },
            ].map((item, i) => (
              <div
                key={i}
