...
const consultationSchema = z.object({
  name: z.string().min(1, 'Пожалуйста, введите имя'),
  contactType: z.enum(['phone', 'email', 'instagram'], {
    required_error: 'Пожалуйста, выберите способ связи'
  }),
  contact: z.string().min(1, 'Пожалуйста, введите контактные данные'),
  age: z.number().min(1, 'Пожалуйста, введите ваш возраст').max(120, 'Пожалуйста, введите корректный возраст'),
  consultationContent: z.string().min(1, 'Пожалуйста, выберите тему консультации')
});

type ConsultationFormData = z.infer<typeof consultationSchema>;

const presetOptions = [
  { main: 'Имплантация', sub: '' },
  { main: 'Лечение каналов', sub: '' },
  { main: 'Протезирование', sub: 'Коронки' },
  { main: 'Отбеливание', sub: 'Виниры' },
  { main: 'Зуб мудрости', sub: '' },
  { main: 'Лечение дёсен', sub: '' },
  { main: 'Лечение кариеса', sub: 'Пломбы' },
  { main: 'ВНЧС', sub: '' }
];
    ...
    <div className="bg-white w-full px-4 py-[50px] mb-[50px]">
      <div className="max-w-[375px] mx-auto">
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-[30px]">
          ...
          <div className="flex flex-col gap-[30px]">
            ...
            <div className="flex flex-col gap-[6px]">
              <label className="font-['Noto_Sans'] font-semibold text-[13px] text-[#727582] tracking-[-0.26px] leading-[1.4]">
                Имя<span className="text-[#ff1616]">*</span>
              </label>
              <input
                {...register('name')}
                type="text"
            ...
            <div className="flex flex-col gap-[6px]">
              <label className="font-['Noto_Sans'] font-semibold text-[13px] text-[#727582] tracking-[-0.26px] leading-[1.4]">
                Способ связи<span className="text-[#ff1616]">*</span>
              </label>
            ...
            <div className="flex flex-col gap-[6px]">
              ...
              {contactType === 'instagram' && (
                <p className="text-xs text-[#727582] mt-1">
                  Пожалуйста, введите ваш Instagram ID (например, @username)
                </p>
              )}
            </div>
            ...
            <div className="flex flex-col gap-[6px]">
              <label className="font-['Noto_Sans'] font-semibold text-[13px] text-[#727582] tracking-[-0.26px] leading-[1.4]">
                Возраст<span className="text-[#ff1616]">*</span>
              </label>
              <input
            ...
            <div className="flex flex-col gap-[6px]">
              ...
              />
              <label className="font-['Noto_Sans'] font-semibold text-[13px] text-[#727582] tracking-[-0.26px] leading-[1.4]">
                О чём вы хотели бы проконсультироваться?<span className="text-[#ff1616]">*</span>
              </label>
              <div className="flex flex-col gap-[6px]">
                {/* Row 1 */}
          ...
          >
            {isSubmitting ? 'Отправка...' : 'Начать AI консультацию'}
          </button>
        </form>
      </div>
