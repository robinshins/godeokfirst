...
export default function SameDayTemporarySection() {
 ...
 мэс заслын дараа шууд <span className="text-[#008095]">түр шүд</span> <br />
 өдрийн хойд мэс засал, орой 
        </h2>
 ...
 мэс заслын дараа шууд <span className="font-bold text-[#0b1727]">түр шүд</span> суулгалт.<br />
 боломжтой бөгөөд, <span className="font-bold text-[#0b1727]"> </span>.
        </p>
      </div>
    </section>
  );
