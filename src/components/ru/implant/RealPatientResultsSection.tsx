        ...
        <div className="flex flex-col gap-4 items-center justify-center relative shrink-0 w-full">
          <div className="flex flex-col gap-3 items-center justify-center leading-[0] not-italic relative shrink-0 text-center w-full">
            <h2 className="font-bold leading-[1.35] text-[32px] text-white tracking-[-0.64px] w-full" style={{ fontFamily: 'Pretendard, sans-serif' }}>
              Цифровая навигация<br />Полная имплантация До и После
            </h2>
          </div>
        </div>
                        ...
                        {!user && (
                          <Link href="/ru/login" className="absolute inset-0 cursor-pointer">
                            ...
                            <div className="absolute bottom-4 left-1/2 -translate-x-1/2 bg-black/60 px-4 py-2 rounded-full">
                              <p className="text-white text-xs font-medium whitespace-nowrap">Войдите для просмотра фото До</p>
                            </div>
                          </Link>
                        )}
                        {/* Before Badge */}
