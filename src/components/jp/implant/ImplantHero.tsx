      ...
      <div className="w-full flex justify-center">
        ...
        <div className="flex flex-col gap-8 items-center justify-center relative shrink-0 w-full">
          ...
          <div className="flex flex-col gap-4 items-start leading-[0] not-italic relative shrink-0 text-center text-white w-full">
            ...
            <p className="font-semibold leading-[1.5] relative shrink-0 text-[18px] tracking-[-0.36px] w-full" style={{ fontFamily: 'Pretendard_JP, sans-serif' }}>
              10年間再手術0件、3段階仮歯による精密な咬合調整<br />
              最高のインプラント技術を持つ院長が直接施術
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-4 items-start justify-center relative shrink-0 w-full">
          <Link href="/jp/consultation" className="w-full">
            <button className="bg-[#006aff] box-border flex h-16 items-center justify-center px-6 py-4 relative rounded-[18px] shrink-0 w-full">
              <span className="font-bold leading-[1.5] not-italic relative shrink-0 text-white text-xl text-nowrap tracking-[-0.4px]" style={{ fontFamily: 'Pretendard_JP, sans-serif' }}>
                無料AI相談
              </span>
            </button>
          </Link>
          ...
          >
            <span className="font-bold leading-[1.5] not-italic relative shrink-0 text-[#006aff] text-xl text-nowrap tracking-[-0.4px]" style={{ fontFamily: 'Pretendard_JP, sans-serif' }}>
              医師紹介
            </span>
          </button>
        </div>
