...
export default function StatsSection() {
  const stats = [
    { number: '1,200', unit: 'раз+', label: 'Имплант установка количество раз' },
    { number: '0', unit: 'случаев', label: 'Повторная имплантация', subtitle: 'Годок Эдутаунвон после 0 случаев повторных операций' },
    { number: '6', unit: 'лет+', label: 'Университетская больница Бывший приглашенный профессор' },
    { number: '4.9', unit: '/ 5.0', label: 'Удовлетворенность пациентов', subtitle: 'По данным Kakao, Google, Naver Maps' },
  ];
          ...
          <FadeInSection className="flex flex-col gap-4 items-center justify-center relative shrink-0 w-full z-10">
            <div className="flex flex-col gap-3 items-center justify-center relative shrink-0 w-full">
              ...
              <p className="font-semibold leading-[1.4] not-italic text-[#e9ebf1] text-base text-center tracking-[-0.32px] w-full" style={{ fontFamily: '"NanumSquare", sans-serif' }}>
                ...
                Лично оперирует — импланты на всю жизнь
              </p>
            </div>
          </FadeInSection>
