      ...
      <div className="box-border flex flex-col gap-[60px] items-center px-4 py-[60px] relative w-full max-w-[430px]">
        ...
        <div className="flex flex-col gap-4 items-center justify-center relative shrink-0 w-full">
          ...
          <div className="flex flex-col gap-3 items-center justify-center w-full">
            ...
            <p className="font-semibold leading-[1.4] text-white text-base text-center tracking-[-0.32px] w-full" style={{ fontFamily: 'Pretendard_JP, sans-serif' }}>
              メディス歯科は責任ある医院になることを約束します。<br aria-hidden="true" />
              体系的な保証制度で生涯安心してご利用ください。
            </p>
          </div>
        </div>
