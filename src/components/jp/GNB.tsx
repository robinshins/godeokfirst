...
export default function GNB() {
  ...
  const menuItems = [
    { name: 'ホーム', href: '/' },
    { name: 'インプラント', href: '/implant' },
    { name: '入れ歯・全顎インプラント', href: '/denture' },
    { name: '虫歯・根管治療', href: '/cavity-treatment' },
    { name: '親知らず抜歯', href: '/wisdom-tooth' },
    { name: '歯周病治療・スケーリング', href: '/gum-care' },
    { name: '顎関節治療', href: '/tmj' },
    { name: 'ホワイトニング', href: '/whitening' },
  ];
  ...
  return (
    ...
    >
      ...
      >
        {/* Logo */}
        <Link href="/jp" className="flex items-center" style={{ height: '60px' }}>
          <Image
            ...
            <div className="max-w-[430px] mx-auto">
              ...
              <div className="px-5 pb-3 border-b border-[#e9ebf1]">
                {user ? (
                  ...
                  <Link href="/jp/login" onClick={() => setIsMenuOpen(false)}>
