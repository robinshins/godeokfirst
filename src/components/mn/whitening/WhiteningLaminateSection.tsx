...
export default function WhiteningLaminateSection() {
 ...
 дижитал нарийвчилсан үйлдвэрлэл байгалийн <br />
...
, шүд &apos; цайруулах &apos;.
 ...
 {/* давуу тал */}
            <div className="bg-[#008095] rounded-[16px] p-5 flex flex-col gap-[14px] w-full">
              {[
 { title:'шүд байхгүй', desc:'эсвэл хамгийн бага (0.3mm) байгалийн шүд'},
 { title:'байгалийн өнгө', desc:'VITA MARK II керамик — шүд'},
 { title:'нарийвчилсан үйлдвэрлэл', desc:'дижитал зөрүү'},
              ].map((item, i) => (
 ...
 Godeok First Dental мэргэжилтэн 
            </h3>
 ...
 Нийлмэл шүдний мэргэжилтэн 
              ...
              <div className="bg-white/10 rounded-[10px] p-3 flex flex-col gap-1.5">
                {[
'гоо сайхны дижитал шалгалт явуулах',
'төрөл· байгалийн',
'хамгийн бага, боломжтой',
                ].map((t, i) => (
            ...
            <div className="flex flex-col gap-3">
              {[
 { title:'дижитал 3D', desc:'нарийвчилсан'},
 { title:'VITA MARK II керамик', desc:'байгалийн шүд өнгө'},
 { title:'хамгийн бага', desc:'шүд гэмтэл хамгийн бага Байгалийн шүд хадгалах'},
              ].map((item, i) => (
