...
const consultationSchema = z.object({
  ...
  contact: z.string().min(1, 'Vui lòng nhập thông tin liên hệ'),
  age: z.number().min(1, 'Vui lòng nhập tuổi').max(120, 'Vui lòng nhập tuổi hợp lệ'),
  consultationContent: z.string().min(1, 'Vui lòng chọn nội dung tư vấn')
});

type ConsultationFormData = z.infer<typeof consultationSchema>;

const presetOptions = [
  { main: 'Cấy ghép implant', sub: '' },
  { main: 'Điều trị tủy răng', sub: '' },
  { main: 'Bọc răng sứ', sub: 'Crown' },
  { main: 'Tẩy trắng răng', sub: 'Laminate' },
  { main: 'Răng khôn', sub: '' },
  { main: 'Chăm sóc nướu', sub: '' },
  { main: 'Điều trị sâu răng', sub: 'Resin, Inlay' },
  { main: 'Khớp thái dương hàm', sub: '' }
];
    ...
    <div className="bg-white w-full px-4 py-[50px] mb-[50px]">
      <div className="max-w-[375px] mx-auto">
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-[30px]">
          ...
          <div className="flex flex-col gap-[30px]">
            ...
            <div className="flex flex-col gap-[6px]">
              <label className="font-['Pretendard'] font-semibold text-[13px] text-[#727582] tracking-[-0.26px] leading-[1.4]">
                Tên<span className="text-[#ff1616]">*</span>
              </label>
              <input
                {...register('name')}
                type="text"
            ...
            <div className="flex flex-col gap-[6px]">
              <label className="font-['Pretendard'] font-semibold text-[13px] text-[#727582] tracking-[-0.26px] leading-[1.4]">
                Phương thức liên hệ<span className="text-[#ff1616]">*</span>
              </label>
            ...
            <div className="flex flex-col gap-[6px]">
              ...
              {contactType === 'instagram' && (
                <p className="text-xs text-[#727582] mt-1">
                  Vui lòng nhập ID Instagram của bạn (ví dụ: @username)
                </p>
              )}
            </div>
            ...
            <div className="flex flex-col gap-[6px]">
              <label className="font-['Pretendard'] font-semibold text-[13px] text-[#727582] tracking-[-0.26px] leading-[1.4]">
                Tuổi<span className="text-[#ff1616]">*</span>
              </label>
              <input
            ...
            <div className="flex flex-col gap-[6px]">
              ...
              />
              <label className="font-['Pretendard'] font-semibold text-[13px] text-[#727582] tracking-[-0.26px] leading-[1.4]">
                Bạn muốn tư vấn về vấn đề gì?<span className="text-[#ff1616]">*</span>
              </label>
              <div className="flex flex-col gap-[6px]">
                {/* Row 1 */}
          ...
          >
            {isSubmitting ? 'Đang gửi...' : 'Bắt đầu tư vấn AI'}
          </button>
        </form>
      </div>
          ...
          <div className="bg-white rounded-[24px] p-6 max-w-[340px] w-full">
            <div className="text-center">
              ...
              <p className="font-['Pretendard'] font-medium text-[14px] text-[#5d5f6d] tracking-[-0.28px] leading-[1.6] mb-4">
                Để đảm bảo tin nhắn phản hồi của chúng tôi không bị thất lạc, vui lòng gửi DM tại:
              </p>
              <a
              ...
              <p className="font-['Pretendard'] font-normal text-[12px] text-[#727582] tracking-[-0.24px]">
                Đang chuyển đến trang tư vấn AI...
              </p>
            </div>
          </div>
        </div>
