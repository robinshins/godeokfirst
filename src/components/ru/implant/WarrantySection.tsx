...
export default function WarrantySection() {
  const warrantyFeatures = [
    {
      period: 'пожизненно',
 title:'Имплант',
 description:'бесплатный повторныйпроцедура',
      iconPath: 'M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z'
    },
    {
      period: '10лет',
 title:'протезматериал',
 description:'коронка бесплатный',
      iconPath: 'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z'
    },
    {
      period: '5лет',
 title:'',
 description:'годрезультат бесплатный',
      ...
      <div className="box-border flex flex-col gap-10 items-center px-6 py-[80px] relative w-full max-w-[430px]">
        ...
        <FadeInSection className="text-center w-full">
          ...
          <h2 className="font-extrabold text-[32px] text-white leading-[1.3] tracking-tight mb-4" style={{ fontFamily: '"NanumSquare", sans-serif' }}>
            пожизненноспокойствие
            <br />
            Имплант система гарантии
          </h2>

          <p className="font-medium leading-[1.6] text-white/80 text-[15px] tracking-[-0.3px]" style={{ fontFamily: '"NanumSquare", sans-serif' }}>
            Ответственное обещание Godeok First Dental.
            <br />
            Используйте с уверенностью благодаря системе гарантии.
          </p>
        </FadeInSection>
 ...
 Имплант уже или
                <br />
 связанный сертификация уже необходимый
              </p>
...
: 343 x 485px
 ...
 случаев информирование
                </p>
                <p className="text-white/70 text-[13px] leading-[1.5]" style={{ fontFamily: '"NanumSquare", sans-serif' }}>
 регулярный осмотр(6месяцев неделя) и чистка получить случай один применение.
                </p>
              </div>
            </div>
          </div>
